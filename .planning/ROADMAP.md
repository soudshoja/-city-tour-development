...
Plans:
- [x] 24-01-PLAN.md — Fix salutation ID mapping (value codes), add special request codes, fix rateBasis=0 leak (CERT-01, CERT-02, CERT-03)
- [x] 24-02-PLAN.md — Remove APR flow entirely, wire nationality/residence from user input (CERT-04, CERT-05)
- [x] 24-03-PLAN.md — Wire all mandatory display features into WhatsApp messages, add 2-room cancellation cert test (CERT-06, CERT-07)
