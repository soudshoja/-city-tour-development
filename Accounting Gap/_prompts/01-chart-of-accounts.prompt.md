# Prompt sent to Analyze-phase agent — Chart of Accounts

- **Model**: fable
- **Label**: analyze:01-chart-of-accounts
- **Reference file given as spec**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/01-chart-of-accounts.md`
...
- **Output file it was told to write**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/Accounting Gap/01-chart-of-accounts.md`
...
C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/01-chart-of-accounts.md
...
1. Read the reference file at [ref] in full first — that is your spec for "Chart of Accounts".
