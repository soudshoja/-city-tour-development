# Prompt sent to Analyze-phase agent — Double-Entry Posting Engine

- **Model**: fable
- **Label**: analyze:02-posting-engine
- **Reference file given as spec**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/02-posting-engine.md`
...
- **Output file it was told to write**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/Accounting Gap/02-posting-engine.md`
...
C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/02-posting-engine.md
...
1. Read the reference file at [ref] in full first — that is your spec for "Double-Entry Posting Engine".
