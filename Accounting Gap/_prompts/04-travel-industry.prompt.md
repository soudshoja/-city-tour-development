# Prompt sent to Analyze-phase agent — Travel Industry Specifics (IATA/BSP)

- **Model**: fable
- **Label**: analyze:04-travel-industry
- **Reference file given as spec**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/04-travel-industry.md`
...
- **Output file it was told to write**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/Accounting Gap/04-travel-industry.md`
...
C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/04-travel-industry.md
...
1. Read the reference file at [ref] in full first — that is your spec for "Travel Industry Specifics (IATA/BSP)".
