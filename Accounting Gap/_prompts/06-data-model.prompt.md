# Prompt sent to Analyze-phase agent — Data Model

- **Model**: fable
- **Label**: analyze:06-data-model
- **Reference file given as spec**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/06-data-model.md`
...
- **Output file it was told to write**: `C:/Users/User/OneDrive - City Travelers/soud-laravel/Accounting Gap/06-data-model.md`
...
C:/Users/User/OneDrive - City Travelers/soud-laravel/.claude/skills/travel-accounting-system/references/06-data-model.md
...
1. Read the reference file at [ref] in full first — that is your spec for "Data Model".
