            ...
            foreach ($payments as $payment) {
                try {
                    ...
                    $transaction = Transaction::create([
                        ...
                        'date'=> Carbon::now(),
                        'description'=> ''.$bankPaymentFee->name.' Settles to Bank (After 24h) (Assets):'.$bankAccountAccRecord->name.' for Invoice:'. $invoiceDetail->invoice_number,
                    ...
                    JournalEntry::create([
                        ...
                        'description' => ''.$bankPaymentFee->name.' Settles to Bank (After 24h) (Assets) for Invoice:'. $invoiceDetail->invoice_number . ' released to '.$bankAccountAccRecord->name,
