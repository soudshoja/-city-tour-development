            ...
            foreach ($payments as $payment) {
                try {
                    ...
                    JournalEntry::create([
                        ...
                        'description' => 'Payment Invoice:'. $invoiceDetail->invoice_number . ' ('.$payment->pay_to.') released to '.$bankAccountAccRecord->name,
                    ...
                    JournalEntry::create([
                        ...
                        'invoice_detail_id' => $invoiceDetail ? $invoiceDetail->id : null,
                        'transaction_date' => Carbon::now(),
                        'description' => 'Payment Invoice:'. $invoiceDetail->invoice_number . ' ('.$payment->from.') released from '.$bankPaymentFee->name,
                        'debit' => 0,
