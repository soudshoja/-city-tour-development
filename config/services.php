...
return [
    ...
    */
    ...
    'myfatoorah' => [
        'api_key'             => env('APP_ENV') == 'local' ? env('MYFATOORAH_LIVE_KEY') : env('MYFATOORAH_SANDBOX_KEY'),
        'base_url'            => env('APP_ENV') == 'local' ? env('MYFATOORAH_LIVE_URL') . '/v2' : env('MYFATOORAH_SANDBOX_URL') . '/v2',
