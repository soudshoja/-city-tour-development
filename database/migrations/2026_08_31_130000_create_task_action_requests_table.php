...
/**
 * P2.5.I prod-drift port (verbatim from /home/citycomm/tour.citycommerce.group, 2026-08-31; see
 * p2_5-brief.md §P2.5.I "port ... as-is" and routes/console.php's own P2.5.I prod-drift comment
 * block for why only the table/model/notifier/command are ported here, not the cross-agent
 * refund/void/reissue acknowledgment workflow that would populate it).
 *
 * Tracks owner-acknowledgment requests for refund/void/reissue tasks performed by an agent OTHER
 * than the original task's agent. Companion to the client_assignment_requests workflow but for
 * cross-agent ticket actions: Approve credits the new task's sale to the actor; Deny flips it back
 * to the owner. Additive-only; no existing table or row is touched.
 */
