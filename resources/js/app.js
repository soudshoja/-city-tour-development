    ...
    return (() => {
        ...
        function p(e, t) {
            (this.el = e),
                ...
                (this.placeholder =
                    d(this.el, "placeholder") || this.config.placeholder || ""),
                (this.dropdown = null),
            ...
            (p.prototype.renderDropdown = function () {
                var e = `<div class="${[
                    ...
                    this.config.searchable
                        ? '<div class="nice-select-search-box">\n<input type="text" class="focus:outline-none focus:ring-0 rounded-lg nice-select-search" placeholder="Search..."/>\n</div>'
                        : ""
                }\n  <ul class="list"></ul>\n  </div></div>\n`;
