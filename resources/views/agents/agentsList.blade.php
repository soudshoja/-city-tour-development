<x-app-layout>
    ...
    <div class="flex justify-between items-center gap-5 my-3 ">
        ...
        <div class="flex items-center gap-5 ">
            ...
            <!-- total client number -->
            <div data-tooltip="number of Agents" class="relative w-12 h-12 flex items-center justify-center DarkBCcolor rounded-full shadow-sm">
                        ...
                        <table id="myTable" class="table-hover whitespace-nowrap dataTable-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-3 text-sm font-semibold text-gray-500">{{ $agent->name }}</td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">{{ $agent->amadeus_id }}</td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">{{ $agent->email }}</td>

                                    <td class="p-3 text-sm font-semibold text-gray-500">{{ $agent->phone_number }}</td>
