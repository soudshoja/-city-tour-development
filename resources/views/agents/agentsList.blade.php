<x-app-layout>
            ...
            <div class="flex items-center gap-3 space-y-3 md:space-y-0 md:space-x-2">
                ...
                <div class="relative flex items-center h-12" x-data="{ open: false }">
                    <button type="button" @click="open = !open"
                        class="h-full px-4 border border-gray-300 dark:border-gray-600 rounded-lg text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none flex items-center">
                        Filters by type
                    </button>
    ...
    function closeModalIbgagent(event) {
