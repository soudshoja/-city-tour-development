<x-app-layout>
    <div class="flex justify-between items-center gap-5 my-3">
        <div class="flex items-center gap-5">
            ...
            <div data-tooltip="Number of branches"
                ...
                <span class="text-xl font-bold text-white">{{ $branches->total() }}</span>
            </div>
        </div>
        <div class="flex items-center gap-5">
    ...
    <div class="panel rounded-lg">
        <x-search
            ...
            searchParam="q"
            placeholder="Quick search for branches" />
                        ...
                        <tr class="transition-colors duration-150 p-3 text-sm font-semibold text-gray-600">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a data-tooltip-left="View branch" href="{{ route('branches.show', $branch->id) }}" class="text-sm font-medium">
                                    ...
                                    <a data-tooltip-left="Edit branch" href="{{ route('branches.edit', $branch->id) }}" class="text-sm font-medium">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
