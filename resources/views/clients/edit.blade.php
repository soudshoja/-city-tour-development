<x-app-layout>
    <div>
        ...
        <div class="flex flex-col gap-2 justify-start bg-white rounded-md shadow-md p-4 m-2">
            ...
            <div class="border border-dashes rounded-md w-full m-auto flex max-w-48">
