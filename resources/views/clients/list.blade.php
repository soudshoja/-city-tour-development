    ...
    <div class="tableCon">
                        ...
                        <table id="myTable" class="table-hover whitespace-nowrap dataTable-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="p-3 text-left text-md font-bold text-gray-500">client Email</th>
                                    <th class="p-3 text-left text-md font-bold text-gray-500">Client Contact</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="p-3 text-sm">
                                        <a href="javascript:void(0);" class="viewClient text-blue-500 hover:underline">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                    ...
                                    <td class="p-3 text-sm font-semibold text-gray-500">{{ $client->name }}</td>

                                    <td class="p-3 text-sm font-semibold text-gray-500">{{ $client->email }}</td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">{{ $client->phone }}</td>
        ...
        <div class="content-30">
            ...
            <div class="mt-5 ">
                ...
                <div id="ClientDetails" class="panel w-full xl:mt-0 rounded-lg h-auto hidden"></div> <!-- display Client details here-->
