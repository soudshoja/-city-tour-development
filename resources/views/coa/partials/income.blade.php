  ...
  <div
      class="IncomeToggleButton main-container cursor-pointer items-center justify-between bg-white p-4  flex w-full rounded-lg BoxShadow border border-gray-200">
              ...
              <ul class="space-y-2 w-full">
                  ...
                  <li class="relative w-full">
                      <a href="javascript:;"
                          ...
                          :class="{'border-l-4 incomeBorder incomeText': openLevels['{{ $income->id }}']}"
                          ...
                          <div x-show="openLevels['{{ $level3income->id }}']" class="ml-6 space-y-2 mt-2">
                              ...
                              <div
                                  ...
                                  <span class="text-gray-500 text-sm editable-cell" contenteditable="true">
                                      {{number_format($level4income->actual_balance, 2)}}</span>
