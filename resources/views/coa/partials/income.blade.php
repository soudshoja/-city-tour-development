  ...
  <div class="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm border border-gray-200 w-full">
      ...
      <div class="flex items-center space-x-3">
          ...
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M14.5 2.31494C18.014 3.21939 20.7805 5.98588 21.685 9.4999" stroke="#1C274C" stroke-width="1.5"
                  stroke-linecap="round" />
          </svg>
      ...
      <div class="flex items-center space-x-3 text-gray-500">
          <!-- Icon 1 -->
          <button class="hover:text-gray-700" id="IncomeToggleButton">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const IncomeToggleButton = document.getElementById('IncomeToggleButton');
...
IncomeToggleButton.addEventListener('click', function() {
