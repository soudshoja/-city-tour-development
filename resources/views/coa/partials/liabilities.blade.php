  ...
  <div class="flex items-center justify-between bg-white p-4 rounded-lg shadow-sm border border-gray-200 w-full">
      ...
      <div class="flex items-center space-x-3">
          ...
          <span class="text-gray-800 font-medium">Liabilities</span>
      </div>
      ...
      <div class="flex items-center space-x-3 text-gray-500">
          <!-- Icon 1 -->
          <button class="hover:text-gray-700" id="LiabilitiesToggleButton">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const LiabilitiesToggleButton = document.getElementById('LiabilitiesToggleButton');
...
LiabilitiesToggleButton.addEventListener('click', function() {
