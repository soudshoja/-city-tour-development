 <!-- Sub-Accounts for Liabilities -->
 <div id="liabilities-sub-accounts" class="sub-accounts-container hidden space-y-4">
     @foreach($accounts->where('name', 'Liabilities') as $account)
