            ...
            <table class="min-w-full bg-white rounded-lg shadow-md">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 border-b text-right">Credit</th>
                        <th class="px-4 py-2 border-b text-right">Debit</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-2 border-b text-center">
                            <div x-data="{ showMenu: null, showDeleteModal: false }" class="relative" @click.outside="showMenu = null">
                                <button @click="showMenu = (showMenu === {{ $transaction->id }} ? null : {{ $transaction->id }})" class="text-black hover:text-gray-700">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="4"
                                            d="M12 6h.01M12 12h.01M12 18h.01" />
                                ...
                                <div x-show="showMenu === {{ $transaction->id }}" x-transition
                                    ...
                                    @endunless
                                    @if(auth()->user()->role_id == \App\Models\Role::ADMIN)
                                    <button @click="showMenu = null; showDeleteModal = true"
                                        class="text-center block w-full px-4 py-2 text-gray-700 hover:bg-red-200">
                                        Delete Transaction
                                    </button>
                                    @endif
                                ...
                                <div x-show="showDeleteModal" x-cloak
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg w-full max-w-md p-6">
                                        ...
                                        <div class="flex justify-end space-x-4">
                                            ...
                                            <form action="{{ route('coa.deleteTransaction', $transaction->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700">
