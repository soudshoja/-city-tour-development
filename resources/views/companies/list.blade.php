    ...
    <div class="flex justify-between items-center gap-5 my-3">
        <div class="flex items-center gap-5">
            ...
            <div data-tooltip="Number of companies"
                ...
                <span class="text-xl font-bold text-white">{{ $companies->total() }}</span>
            </div>
        </div>
        <div class="flex items-center gap-5">
                        ...
                        <tr class="transition-colors duration-150 p-3 text-sm font-semibold text-gray-600">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center gap-2">
                                    @can('view', $company)
                                    <a data-tooltip-left="View company" href="{{ route('companies.show', $company->id) }}" class="text-sm font-medium">
                                    ...
                                    @endcan
                                    @can('update', $company)
                                    <a data-tooltip-left="Edit company" href="{{ route('companies.edit', $company->id) }}" class="text-sm font-medium">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
