...
<x-app-layout>
    <div class="flex grid grid-cols-3 gap-4">
        <!-- left side -->
        <div class="col-span-2 BoxShadow rounded-lg bg-white ">
            ...
            <div class="flex flex-wrap justify-between p-5">
                <div class="mb-6 w-full lg:w-1/2">
                    <div class="flex shrink-0 items-center text-black dark:text-white">
                        ...
                        <h1 class="text-2xl font-bold ml-2">{{ $company->name }}</h1>
                ...
                <div class="w-full lg:w-1/2 lg:max-w-fit">
                    <div class="flex items-center">
                        ...
                        <input id="number" type="text" name="inv-num" class="form-input w-2/3 lg:w-[250px]" placeholder="#8801" x-model="params.invoiceNo">
                    </div>

                    <div class="mt-4 flex items-center">
                        <label for="startDate" class="mb-0 flex-1  mr-2  ">Invoice Date</label>
                        <input id="startDate" type="date" name="inv-date" class="form-input w-2/3 lg:w-[250px]" x-model="params.invoiceDate">
                    </div>
                    <div class="mt-4 flex items-center">
            ...
            <h2 class="px-5 text-lg font-semibold">Add Company User detials here</h2>

            <div class="flex w-full p-5 justify-between gap-5">
                <!-- branch details -->
                <div class="mb-6 w-full ">
                    <form id="branch-search-form" class="mt-4 flex items-center">
                        <input
                            type="text"
                            name="query"
                            id="branch-search"
                    ...
                    <ul id="branch-results" class="mt-2 bg-white border rounded shadow hidden"></ul>
        ...
        <!-- right side -->
        <div class="BoxShadow rounded-lg bg-white p-10 h-96">
            <select id="currency" name="currency" class="form-select mb-5 ">
    ...
    <div class="mt-10">
        ...
        <div class="flex grid grid-cols-3 gap-4">
            <!-- left column -->
            <div class="col-span-2 BoxShadow rounded-lg bg-white flex-1 px-0 py-6 p-5">
                <!-- company details -->
            ...
            <!-- ./left column -->
            <!-- right column -->
            <div class="BoxShadow rounded-lg bg-white p-5">
