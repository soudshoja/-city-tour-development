                            ...
                            <tbody>
                                ...
                                <tr data-price="{{ $invoice->total }}"
                                    ...
                                    <td class="p-3 text-sm flex gap-2">
                                        ...
                                        @else
                                        <div x-data="{ viewVoucherModal_{{ $invoice->id }}: false }" class="group cursor-pointer" data-tooltip="View Voucher">
                                            ...
                                            <div x-cloak x-show="viewVoucherModal_{{  $invoice->id }}" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-20">
                                                <div @click.away="viewVoucherModal_{{ $invoice->id }}=false" class="bg-white rounded-md border-2 w-auto">
                                                    ...
                                                    <div class="p-4">
                                                        @foreach($invoice->invoiceDetails as $invoiceDetail)
                                                         <div class="p-2 bg-gray-500 rounded shadow">
                                                             {{ $invoiceDetail->task->type}} 
                                                         </div>
                                                        @endforeach
                                                    </div>
                                                </div>
