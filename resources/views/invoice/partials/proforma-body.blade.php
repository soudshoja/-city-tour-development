{{-- Shared content for resources/views/invoice/proforma.blade.php.
     Included from both the public-safe self-contained document path and the
     authenticated <x-app-layout> path so the two branches never drift. --}}
            ...
            <div class="card">
                <div class="card-header my-2 flex justify-between align-items-center">
                    ...
                    <div class="flex justify-end gap-2">
                        <a href="{{ ($isPublicInvoiceRequest ?? false) ? $invoice->publicUrl('proforma-pdf') : route('invoice.proforma.pdf', ['companyId' => optional($invoice->agent->branch->company)->id, 'invoiceNumber' => $invoice->invoice_number]) }}"
