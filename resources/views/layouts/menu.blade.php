<nav class="w-full">
    <menu class="flex flex-wrap gap-8 mx-4">
        ...
        <menuitem>
        <a class="bg-gray-200 dark:bg-gray-700 dark:text-white p-2 flex justify-center items-center w-full BoxShadow">
            <svg class="w-4 h-4" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
                    <path
                        d="M7.202 4.722a1.33 1.33 0 0 0-1.258-.889H4.912a1.19 1.19 0 0 0-.254 2.353l1.571.344a1.334 1.334 0 0 1-.285 2.637h-.888a1.33 1.33 0 0 1-1.258-.89M5.5 3.833V2.5m0 8V9.167" />
        ...
        <a class="bg-gray-200 dark:bg-gray-700 dark:text-white p-2 flex justify-center items-center w-full BoxShadow">
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path opacity="0.5" d="M11 12.8975L13.8978 13.6739" stroke="currentColor" stroke-width="1.5"
                    stroke-linecap="round" />
            </svg>
