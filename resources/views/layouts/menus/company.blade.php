<!-- Company Menu -->
<nav class="w-full">
    <menu class="flex justify-center gap-8">

        <!-- finance 01 -->
        <menuitem>
        <a class="bg-gray-200 p-1 flex justify-center items-center w-full BoxShadow  ">
        ...
        <menu>
            <menuitem><a href="{{ route('coa.index') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Chart Of Account</a></menuitem>
            <menuitem><a href="{{ route('charges.index') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Manage Charges</a></menuitem>
            <menuitem><a href="{{ route('accounting.transaction') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Transactions</a></menuitem>
            <menuitem><a href="{{ route('accounting.index') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Accounting</a></menuitem>
        </menu>
        </menuitem>
        <!-- ./finance -->
        ...
        <menu>
            <menuitem><a href="{{ route('invoices.company.agents') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Invoices List</a></menuitem>
            <menuitem><a href="{{ route('invoice.salelist') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Sale Invoices</a></menuitem>
        ...
        <menu>
            <menuitem><a href="{{ route('agents.index') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Agents List</a></menuitem>
            <menuitem><a href="{{ route('clients.list') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Clients List</a></menuitem>
        ...
        <menu>
            <menuitem><a href="{{ route('branches.index') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Branches List</a></menuitem>
        ...
        <a class="bg-gray-200 p-1 flex justify-center items-center w-full BoxShadow  ">
            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path opacity="0.5" d="M11 12.8975L13.8978 13.6739" stroke="#1C274C" stroke-width="1.5" stroke-linecap="round" />
            </svg>
        ...
        <menu>
            <menuitem><a href="{{ route('reports.summary') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Summary</a></menuitem>
            <menuitem><a href="{{ route('reports.accsummary') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Accounts</a></menuitem>
            <menuitem><a href="{{ route('reports.performance') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Performance</a></menuitem>
            <menuitem><a href="{{ route('reports.agent') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Agent Reports</a></menuitem>
            <menuitem><a href="{{ route('reports.client') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Client Reports</a></menuitem>
        ...
        <menu>
            <menuitem><a href="{{ route('agentsetting') }}" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Agent Settings</a></menuitem>
        </menu>
        </menuitem>
        <!-- ./Settings -->
