...
<nav class="w-full">
    <menu class="flex justify-center gap-8">
        ...
        <!-- finance 01 -->
        <menuitem>
        <a class="bg-gray-200 p-3 flex justify-center items-center w-full BoxShadow ">
        ...
        <menu>
            <menuitem><a href="{{ route('coa.index') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Chart Of Account</a></menuitem>
            <menuitem><a href="{{ route('charges.index') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Manage Charges</a></menuitem>
            <menuitem><a href="{{ route('accounting.transaction') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Transactions</a></menuitem>
            <menuitem><a href="{{ route('accounting.index') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Accounting</a></menuitem>
        </menu>
        </menuitem>
        <!-- ./finance -->
        ...
        <menu>
            <menuitem><a href="{{ route('invoices.company.agents') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Invoices List</a></menuitem>
            <menuitem><a href="{{ route('invoice.salelist') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Sale Invoices</a></menuitem>
        ...
        <menu>
            <menuitem><a href="{{ route('branches.index') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Branches List</a></menuitem>
        ...
        <menu>
            <menuitem><a href="{{ route('reports.summary') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Summary</a></menuitem>
            <menuitem><a href="{{ route('reports.accsummary') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Accounts</a></menuitem>
            <menuitem><a href="{{ route('reports.performance') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Performance</a></menuitem>
            <menuitem><a href="{{ route('reports.agent') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Agent Reports</a></menuitem>
            <menuitem><a href="{{ route('reports.client') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Client Reports</a></menuitem>
        ...
        <menu>
            <menuitem><a href="{{ route('agentsetting') }}" class="justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Agent Settings</a></menuitem>
        </menu>
        </menuitem>
        <!-- ./Settings -->
