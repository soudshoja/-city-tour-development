...
<nav class="w-full">
    <menu class="flex justify-center gap-8">
        ...
        <!-- finance 01 -->
        <menuitem>
        <a class="bg-gray-200 dark:bg-black dark:text-white p-2 flex justify-center items-center w-full BoxShadow">
        ...
        <menu>
            <menuitem><a href="#" class="text-xs justify-center text-center p-3 my-3 bg-white text-gray-600 BoxShadow">Settings</a></menuitem>
        </menu>
        </menuitem>
        <!-- ./Settings -->
