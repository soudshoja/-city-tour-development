<header>
    <div class="container mx-auto flex flex-wrap items-center justify-between px-6 py-4">
        ...
        <div x-data="{ 
            ...
            <div
                @click="chatBox = true"
                class="relative w-12 h-12 flex items-center justify-center bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-full shadow-sm cursor-pointer ">
                ...
                <div
                    ...
                    class="flex flex-col justify-end absolute bg-white dark:bg-gray-700 top-16 right-0 shadow-md w-120 h-160 rounded-lg z-20 ">
                    <livewire:chat />
                </div>
            </div>
