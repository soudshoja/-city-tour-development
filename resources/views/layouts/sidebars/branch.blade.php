<div class="flex flex-col justify-between items-center space-y-48">
    ...
    <div class="flex flex-col justify-between items-center space-y-4">
        <!-- quick actions icon -->
        <div class="flex flex-col items-center heartbeat-container">
            <!-- Menu item -->
            <div class="relative">
                <!-- Icon Button -->
                <div
