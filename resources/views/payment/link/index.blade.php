                        ...
                        <table class="min-w-full bg-white border border-gray-200 rounded shadow">
                            <thead class="bg-gray-100">
                                <tr>
                                    ...
                                    <th class="p-3 text-left font-medium whitespace-nowrap">Link</th>
                                        ...
                                        <td class="px-3 py-2 whitespace-nowrap text-sm">
                                            @if ($payment->status !== 'completed')
                                                <div class="flex flex-col space-y-2">
                                                    <form action="{{ route('resayil.share-payment-link') }}"
                                                        method="POST" target="" class="inline">
                                                        @csrf
                                                        ...
                                                        <button type="submit"
                                                            class="inline-flex items-center justify-center w-full px-2 py-1 bg-blue-100 text-blue-700 rounded-full text-sm shadow-md hover:bg-blue-200 transition font-medium transition-all duration-200 ease-in-out transform hover:scale-105">
                                                    ...
                                                    <button onclick="copyToClipboard('{{ $paymentUrl }}')"
                                                        class="inline-flex items-center justify-center w-full px-2 py-1 bg-yellow-100 text-gray-700 rounded-full text-sm shadow-md hover:bg-yellow-200 transition font-medium transition-all duration-200 ease-in-out transform hover:scale-105">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2"
                                            ...
                                            <td class="px-3 py-2 relative whitespace-nowrap">
                                                <div x-data="{ editPaymentLink: false }">
                                                    <button @click="editPaymentLink = true"
                                                        class="flex items-center gap-2 p-2 border-2 border-transparent rounded-full hover:border-blue-500 hover:bg-blue-50 transition-all duration-200 ease-in-out transform hover:scale-105"
                                                ...
                                                <form action="{{ route('payment.link.delete', $payment->id) }}"
                                                    method="POST" class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        class="flex items-center justify-center p-2 border-2 border-transparent rounded-full hover:border-red-500 hover:bg-red-50 transition-all duration-200 ease-in-out transform hover:scale-105"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                            ...
                                                            viewBox="0 0 24 24" stroke-width="2"
                                                            stroke-linecap="round" stroke-linejoin="round">
                                                            <path d="M19 7H5V4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v3z">
                                                            </path>
                                                            <path d="M10 11v6m4-6v6"></path>
                                                            <path d="M5 7v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7H5z">
                                                            </path>
                                                        </svg>
                                                    </button>
                                                </form>
