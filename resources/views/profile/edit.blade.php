<x-app-layout>
    <div class="grid grid-cols-1">
        ...
        <div class="panel h-full overflow-hidden border-0 p-0">
                        ...
                        <div>
                            <div data-tooltip="Reload" class="rotate refresh-icon relative w-12 h-12 flex items-center justify-center bg-[#b1c0db] dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 rounded-full shadow-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                                    <path d="M12.079 2.25c-4.794 0-8.734 3.663-9.118 8.333H2a.75.75 0 0 0-.528 1.283l1.68 1.666a.75.75 0 0 0 1.056 0l1.68-1.666a.75.75 0 0 0-.528-1.283h-.893c.38-3.831 3.638-6.833 7.612-6.833a7.66 7.66 0 0 1 6.537 3.643a.75.75 0 1 0 1.277-.786A9.16 9.16 0 0 0 12.08 2.25"></path>
                                    <path d="M20.841 10.467a.75.75 0 0 0-1.054 0L18.1 12.133a.75.75 0 0 0 .527 1.284h.899c-.381 3.83-3.651 6.833-7.644 6.833a7.7 7.7 0 0 1-6.565-3.644a.75.75 0 1 0-1.276.788a9.2 9.2 0 0 0 7.84 4.356c4.809 0 8.766-3.66 9.151-8.333H22a.75.75 0 0 0 .527-1.284z" opacity=".5"></path>
                                </svg>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white p-5 grid grid-cols-6 gap-3 flex">
                <div class="rounded-lg p-4">
                    <!-- Profile Section -->
                    <div class="flex items-center space-x-2 bg-gray-100 rounded-lg px-4 py-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                            <path fill="currentColor" d="M10 0c5.523 0 10 4.477 10 10s-4.477 10-10 10S0 15.523 0 10S4.477 0 10 0m-.145 7.21a.7.7 0 0 0-.698.697v7.558a.698.698 0 0 0 1.395 0V7.907a.7.7 0 0 0-.697-.698m.028-2.791a.93.93 0 1 0 0 1.86a.93.93 0 0 0 0-1.86" />
                        </svg>
                    ...
                    <ul class="mt-4 space-y-4">
                        <li class="flex items-center space-x-4 text-gray-700">
