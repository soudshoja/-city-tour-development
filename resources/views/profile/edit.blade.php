        ...
        <div class="panel h-full overflow-hidden border-0 p-0">
            <div class="bg-gradient-to-r from-[#4361ee] to-[#160f6b] p-6">
                <div class="mb-6 flex items-center">
                    <div class="w-full justify-between flex items-center rounded-full bg-black/50 p-1 font-semibold text-white pr-3">
                        <div class="flex items-center">
                            <x-application-logo class="block h-8 w-8 rounded-full border-2 border-white/50 object-cover mr-1" />
