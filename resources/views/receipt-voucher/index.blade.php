<x-app-layout>
    <div class="flex justify-between items-center gap-5 my-3 ">
        ...
        <div class="flex items-center gap-5">
            ...
            <a href="{{ route('receipt-voucher.create') }}">
    ...
    <div class="panel rounded-lg">
        <x-search
            ...
            searchParam="q"
            placeholder="Quick search for receipt voucher" />
                ...
                <table class="table-hover whitespace-nowrap dataTable-table">
                    ...
                    <tbody>
                        ...
                        <tr class="p-3 text-sm font-semibold text-gray-500">
                            <td>
                                <a data-tooltip="View receipt voucher" href="{{ route('receipt-voucher.edit', $receiptvoucher->id) }}"
                            ...
                            <td>
                                {{ $receiptvoucher->created_at }}
                            </td>
                            <td>
                                KWD {{ number_format($receiptvoucher->amount, 2) }}
                            </td>
                            <td>
