<div>
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 0.75rem; align-items: center; margin-bottom: 1rem;">
        ...
        @can('bulkManageNotifications', 'App\Models\Setting')
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">
                            <button @click="openEditModal(agent)" class="main-set-edit-link">
                                @can('manageNotifications', 'App\Models\Setting') Edit @else View @endcan
                            </button>
                        </td>
                    </tr>
                </template>
                ...
                <form @submit.prevent="saveAgentSetting">
                        ...
                        <div class="main-set-modal-header-top">
                            <div>
                                <h3 class="main-set-modal-title">
                                    @can('manageNotifications', 'App\Models\Setting') Edit @else View @endcan Notification Settings
                                </h3>
                                <p class="main-set-modal-subtitle">Configure notification preferences for <span x-text="editingAgent?.name"></span></p>
                            </div>
                    ...
                    <div class="main-set-modal-footer">
                        <button type="button" @click="showEditModal = false" class="main-set-btn main-set-btn-secondary">
                            @can('manageNotifications', 'App\Models\Setting') Cancel @else Close @endcan
                        </button>
