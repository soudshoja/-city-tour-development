    ...
    <div class="noti-form" @cannot('manageNotifications', 'App\Models\Setting') style="pointer-events: none; opacity: 0.7;" @endcannot>
        <div class="noti-panel">
            ...
            <div class="noti-channel-grid" style="grid-template-columns: repeat(2, 1fr);">
                <label class="noti-channel-card noti-channel-card-disabled" :class="{'noti-channel-card-active': settings['notification.autobill'].channel === 'none'}">
                    <input type="radio" value="none" x-model="settings['notification.autobill'].channel" class="noti-sr-only" @cannot('manageNotifications', 'App\Models\Setting') disabled @endcannot>
                ...
                <label class="noti-channel-card" :class="{'noti-channel-card-active': settings['notification.autobill'].channel === 'email'}">
                    <input type="radio" value="email" x-model="settings['notification.autobill'].channel" class="noti-sr-only" @cannot('manageNotifications', 'App\Models\Setting') disabled @endcannot>
                    <svg class="noti-channel-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <label class="noti-channel-card" :class="{'noti-channel-card-active': settings['notification.autobill'].channel === 'whatsapp'}">
                    <input type="radio" value="whatsapp" x-model="settings['notification.autobill'].channel" class="noti-sr-only" @cannot('manageNotifications', 'App\Models\Setting') disabled @endcannot>
                ...
                <label class="noti-channel-card" :class="{'noti-channel-card-active': settings['notification.autobill'].channel === 'both'}">
                    <input type="radio" value="both" x-model="settings['notification.autobill'].channel" class="noti-sr-only" @cannot('manageNotifications', 'App\Models\Setting') disabled @endcannot>
                    <svg class="noti-channel-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="noti-panel">
            ...
            <div x-show="['email', 'both'].includes(settings['notification.autobill'].channel)" x-transition class="noti-field">
                ...
                <input type="email" x-model="settings['notification.autobill'].email" placeholder="e.g. billing@company.com" class="noti-input" @cannot('manageNotifications', 'App\Models\Setting') disabled @endcannot>
            </div>
            ...
            <div x-show="['whatsapp', 'both'].includes(settings['notification.autobill'].channel)" x-transition class="noti-field">
                ...
                <input type="text" x-model="settings['notification.autobill'].phone"
                    placeholder="e.g. +96512345678" class="noti-input" @cannot('manageNotifications', 'App\Models\Setting') disabled @endcannot>
            </div>
