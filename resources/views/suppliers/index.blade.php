<x-app-layout>
    <div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-between p-3 bg-white dark:bg-gray-800 shadow rounded-lg space-y-3 md:space-y-0 text-gray-700 dark:text-gray-300">
            ...
            <div
                x-data="{ addSupplierModal: false }"
                class="flex items-center gap-3 space-y-3 md:space-y-0 md:space-x-2">
            ...
            <tbody class="bg-white dark:bg-dark rounded-md p-2" id="suppliersTable">
                ...
                <tr class=" hover:bg-gray-200 dark:hover:bg-gray-600">
                    ...
                    <td class="px-4 py-2 border dark:border-gray-600 text-center space-x-2">
                        <!-- <a class="bg-green-500 text-white px-2 py-1 rounded" href="{{ route('supplier-company.activate', [$supplier->id, auth()->user()->company->id]) }}">Activate</a>
                        <a class="bg-gray-300 text-gray-700 px-2 py-1 rounded" href="{{ route('supplier-company.deactivate', [$supplier->id, auth()->user()->company->id]) }}">Deactivate</a> -->
