...
<script>
    ...
    window.handleSupplierChange = function(id) {
        ...
        if (supplier.name === 'Magic Holiday') {
            ...
            input.className = 'input w-full mt-1 rounded-lg border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 p-3 mb-3';
    ...
    document.addEventListener('change', (e) => {
        if (e.target && e.target.name === 'supplier_id') {
            ...
            if (hidden) {
                ...
                hidden.dispatchEvent(new Event('change', { bubbles: true })); // optional
            }
        }
    });
