                        ...
                        <table id="myTable" class="table-hover whitespace-nowrap dataTable-table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="p-3 text-left text-md font-bold text-gray-900 dark:text-gray-300">Reference</th>
                                    <th class="p-3 text-left text-md font-bold text-gray-900 dark:text-gray-300">GDS Office Id</th>
                            ...
                            <tbody>
                                ...
                                <tr data-price="{{ $task->price }}"
                                    ...
                                    @endcan
                                    <td>
                                        <span class="badge badge-outline-success whitespace-nowrap px-2 py-1 rounded text-sm font-medium"
