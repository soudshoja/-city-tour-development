                        ...
                        <div class="dataTable-container h-max">
                            ...
                            <table id="myTable" class="table-hover whitespace-nowrap dataTable-table">
                                    ...
                                    <tbody>
                                        ...
                                        <td
                                            ...
                                            <p class="{{ $task->client ?? 'no-client' }}">
                                                <button @click="createClientModal = true; modalTaskId = {{ $task->id }}; modalClientName = '{{ $task->client_name ?? '' }}'; modalAgentName = '{{ $task->agent->name ?? 'Not Set'}}'; modalBranchName = '{{ $task->agent->branch->name ?? 'Not Set'}}'; ">
                                ...
                                <div x-show="createClientModal" x-cloak class="fixed inset-0 z-50 bg-gray-800 bg-opacity-30 flex items-center justify-center">
                                    <div @click.away="createClientModal = false"
                                        class="bg-white w-full max-w-md rounded-xl shadow-xl p-6 space-y-6 border"
                                        @click.stop>

                                        <!-- Modal Header -->
                                        <div class="flex justify-between items-center border-b pb-2">
                                            <h2 class="text-xl font-semibold text-gray-800">Create Client</h2>
                                            <button @click="createClientModal = false"
                                        ...
                                        <form action="{{ route('clients.store') }}" method="POST" class="space-y-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="name" id="nameChat" :value="modalClientName" placeholder="Enter client's name"
                                            ...
                                            <div class="flex gap-4">
                                                <div class="w-2/3">
                                                    ...
                                                    <input type="email" name="email" id="emailChat" placeholder="Enter client's email"
                                                        class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                </div>

                                                <div class="w-1/3">
                                                    <label class="block text-sm font-medium text-gray-700 mb-1">Date of Birth</label>
                                                    <input tid="date_of_birth_chat" type="date" name="date_of_birthChat"
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <div class="flex gap-2">
                                                    ...
                                                    <input type="text" name="phone"
                                                        ...
                                                        id="phoneChat" placeholder="Enter client's phone number" required>
                                                </div>
                                            </div>
                                            <div class="flex gap-4">
                                                <div class="w-1/2">
                                                    ...
                                                    <input type="text" name="passport"
                                                        id="passport_noChat" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                </div>
                                            ...
                                            <div class="">
                                                ...
                                                <input type="text" name="address" id="addressChat" placholder="Enter client's address" class="w-full border border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                            </div>

                                            <div class="">
                                                <label class="block text-sm font-medium text-gray-700 mb-1">Agent's Name</label>
                                                <input type="text" name="name" id="agent_idChat" :value="modalAgentName" class="w-full border border-gray-300 rounded-md px-3 py-2 focut:outline-none focus:ring-blue-500 focus:border-blue-500" required readonly>
                                            </div>

                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 mb-2">Upload Passport</label>
                                                <hr>
                                                <p class="text-gray-600 italic text-xs mt-2 mb-4">Please choose appropriate file to proceed</p>

                                                <div class="p-4">
                                                    <button id="upload-passport-btn"
                                                        @click="showFileInput = !showFileInput"
                                                        class="flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium py-2 px-3 rounded-full shadow-sm transition-all duration-150 w-full">
                                                ...
                                                <div class="flex justify-between pt-4 border-t">
                                                    <button type="button" @click="createClientModal = false"
                                                        class="px-4 py-2 text-gray-700 bg-gray-200 rounded hover:bg-gray-300 rounded-full">Cancel</button>
                                                    <button type="submit"
                                                        class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 rounded-full">Register Client</button>
                                                </div>
                                        </form>
                                    </div>
                                </div>
...
<script>
    // When "Fill Form" button is clicked
    document.querySelector('#fill-form-btn').addEventListener('click', function() {
        document.getElementById('chatClientForm').value = "new"; // Set hidden input
        document.getElementById('create-client').classList.remove('hidden'); // Show form
    });

    // Optional: Close button inside the form
    document.querySelector('#close-create-client').addEventListener('click', function() {
        document.getElementById('create-client').classList.add('hidden'); // Hide form
    });
</script>