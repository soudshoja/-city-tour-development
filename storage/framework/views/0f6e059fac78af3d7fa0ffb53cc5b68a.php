...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.modal','data' => ['id' => 'tbo-credentials','name' => 'tbo-credentials','maxWidth' => 'md','show' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tbo-credentials','name' => 'tbo-credentials','maxWidth' => 'md','show' => true]); ?>
    ...
    <hr>
    <form id="tbo-credentials-form" action="<?php echo e(route('suppliers.tbo.credentials')); ?>" method="POST">
        <div class="p-2 grid grid-cols-1 gap-2 w-full">
            <?php echo csrf_field(); ?>
            <?php if(env('TBO_URL') !== null): ?>
            <p>
                Live Credentials
            </p> 
            <div id="live" class="grid grid-cols-1 gap-2 p-2 border border-gray-500 rounded-lg cursor-pointer hover:bg-gray-100">
                <div class="flex justify-between">
                    <p class="overflow-hidden mr-4" data-url="<?php echo e(env('TBO_URL')); ?>">
                        <?php echo e(env('TBO_URL')); ?>
                ...
                <input type="text" value="<?php echo e(env('TBO_USERNAME')); ?>" class="w-full border border-gray-300 p-2 rounded-lg" disabled>
                <input type="password" value="<?php echo e(env('TBO_PASSWORD')); ?>" class="w-full border border-gray-300 p-2 rounded-lg" disabled>
            </div>
            <?php endif; ?>
            <?php if(env('TBO_URL') !== null): ?>
            <p>
            ...
            <div id="sandbox" class="grid grid-cols-1 gap-2 p-2 border border-gray-500 rounded-lg cursor-pointer hover:bg-gray-100">
                <div class="flex justify-between">
                    <p class="overflow-hidden mr-4" data-url="<?php echo e(env('TBO_SANDBOX_URL')); ?>">
                        <?php echo e(env('TBO_SANDBOX_URL')); ?>
                ...
                <input type="text" value="<?php echo e(env('TBO_SANDBOX_USERNAME')); ?>" class="w-full border border-gray-300 p-2 rounded-lg" disabled>
                <input type="password" value="<?php echo e(env('TBO_SANDBOX_PASSWORD')); ?>" class="w-full border border-gray-300 p-2 rounded-lg" disabled>
            </div>
            <?php endif; ?>
            <?php if(env('TBO_URL') === null && env('TBO_SANDBOX_URL') === null): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['id' => 'tbo-credentials-button']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'tbo-credentials-button']); ?>
            <?php echo e(__('Save')); ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        let supplierIndexUrl = "<?php echo route('suppliers.index'); ?>";
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/suppliers/credential-modal.blade.php ENDPATH**/ ?>