    ...
    <footer class="bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 mt-12">
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            <p class="text-center text-sm text-gray-500 dark:text-gray-400">
                &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. N8n Document Processing - Complete Documentation.
            </p>
        </div>
    </footer>
...
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/docs/n8n-complete-documentation.blade.php ENDPATH**/ ?>