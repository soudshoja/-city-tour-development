...
<?php $component->withAttributes([]); ?>
    <div class="container mx-auto p-6">
            ...
            <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-lg p-5 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e(number_format($clients->total())); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-rose-500 to-rose-300 rounded-xl shadow-lg p-5 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e(number_format($totals['totalOwed'], 3)); ?> <span class="text-base font-semibold">KWD</span></p>
                    </div>
                    <div class="bg-white/30 rounded-full p-3">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-emerald-300 rounded-xl shadow-lg p-5 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e(number_format($totals['totalPaid'], 3)); ?> <span class="text-base font-semibold">KWD</span></p>
                    </div>
                    <div class="bg-white/30 rounded-full p-3">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gradient-to-br from-amber-500 to-amber-300 rounded-xl shadow-lg p-5 text-white">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold mt-1"><?php echo e(number_format($totals['totalBalance'], 3)); ?> <span class="text-base font-semibold">KWD</span></p>
                    </div>
                    <div class="bg-white/30 rounded-full p-3">
                        <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-4 mb-6">
            <form method="POST" action="<?php echo e(route('reports.client')); ?>" id="filterForm">
                <?php echo csrf_field(); ?>
...
<?php $component = App\View\Components\MultiPicker::resolve(['label' => 'Select Clients','name' => 'client_ids','items' => $clientsList,'preselected' => collect(request('client_ids', []))->map(fn($v) => (int)$v)->all(),'allLabel' => 'All Clients','placeholder' => 'Search clients...'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'flex-1 min-w-[200px]']); ?>
...
<?php endif; ?>
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="<?php echo e(route('reports.client')); ?>" class="inline-flex items-center gap-2 h-10 px-4 rounded-md text-sm font-medium bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-200 transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                            </svg>
                            Reset
                        </a>
                        <button type="submit" formaction="<?php echo e(route('reports.client.pdf')); ?>" formmethod="POST" formtarget="_blank" 
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        <div class="flex-shrink-0 w-10 h-10 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-sm">
                                            <?php echo e(strtoupper(substr($item['client']->full_name ?: $item['client']->name, 0, 2))); ?>

                                        </div>
                                        <div>
                                            <div class="font-semibold text-gray-900 dark:text-gray-100"><?php echo e($item['client']->full_name ?: $item['client']->name); ?></div>
                                            <?php if($item['client']->phone): ?>
                                            <div class="text-xs text-gray-500 dark:text-gray-400">
                                                <?php echo e($item['client']->phone ? ($item['client']->country_code ?? '+965') . $item['client']->phone : 'N/A'); ?>
                                ...
                                <td class="px-4 py-3 text-center">
                                    <div class="flex flex-col items-center gap-1">
                                        <span class="text-xs text-gray-600 dark:text-gray-400">
                                            <?php echo e($item['paid_invoices_count']); ?>/<?php echo e($item['invoices_count']); ?> paid
                                        </span>
                                        <?php if($item['invoices_count'] > 0): ?>
                                        <div class="w-16 h-1.5 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden">
                                            <div class="h-full bg-emerald-500 rounded-full" style="width: <?php echo e(($item['paid_invoices_count'] / $item['invoices_count']) * 100); ?>%"></div>
                                        </div>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td class="px-4 py-3 text-right font-semibold text-rose-600 dark:text-rose-400">
                                    <?php echo e(number_format($item['total_owed'], 3)); ?>

                                </td>
                                <td class="px-4 py-3 text-right font-semibold text-emerald-600 dark:text-emerald-400">
                                    <?php echo e(number_format($item['total_paid'], 3)); ?>

                                </td>
                                <!-- <td class="px-4 py-3 text-right font-semibold <?php echo e($item['balance'] > 0 ? 'text-amber-600 dark:text-amber-400' : ($item['balance'] < 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-600 dark:text-gray-400')); ?>">
                                    <?php echo e(number_format($item['balance'], 3)); ?>

                                </td> -->
                                <td class="px-4 py-3 text-right font-semibold <?php echo e($item['balance'] > 0 ? 'text-rose-600 dark:text-rose-400' : ($item['balance'] < 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-600 dark:text-gray-400')); ?>">
                                    <?php echo e(number_format($item['balance'], 3)); ?>
                                    ...
                                    <div x-show="open" x-transition:enter="transition-all ease-out duration-300" x-transition:enter-start="opacity-0"
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-3 gap-3 mb-4">
                                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
                                                ...
                                                <div class="text-lg font-bold text-emerald-600 dark:text-emerald-400"><?php echo e($item['invoiced_tasks_count']); ?></div>
                                            </div>
                                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
                                                <div class="text-[11px] uppercase text-gray-500 dark:text-gray-400 tracking-wide">Uninvoiced Tasks</div>
                                                <div class="text-lg font-bold text-amber-600 dark:text-amber-400"><?php echo e($item['uninvoiced_tasks_count']); ?></div>
                                            </div>
                                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
                                                <div class="text-[11px] uppercase text-gray-500 dark:text-gray-400 tracking-wide">Refunded Tasks</div>
                                                <div class="text-lg font-bold text-purple-600 dark:text-purple-400"><?php echo e($item['refunded_tasks_count']); ?></div>
                                            </div>
                                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
                                                <div class="text-[11px] uppercase text-gray-500 dark:text-gray-400 tracking-wide">Due to Client</div>
                                                <div class="text-lg font-bold text-emerald-600 dark:text-emerald-400"><?php echo e(number_format($item['refund_credit'], 3)); ?></div>
                                            ...
                                            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
                                                ...
                                                <div class="text-lg font-bold text-rose-600 dark:text-rose-400"><?php echo e(number_format($item['refund_owed'], 3)); ?></div>
                                                <div class="text-[10px] text-gray-400">Money client owes us (refund charges)</div>
                                            </div>
                                            <a href="<?php echo e(route('clients.credits', $item['client']->id)); ?>" target="_blank"
                                                ...
                                                <div class="text-lg font-bold text-blue-600 dark:text-blue-400 flex items-center gap-1">
                                                    <?php echo e(number_format($item['client_credit'], 3)); ?>
                                        ...
                                        <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                                            <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50">
                                                <h4 class="font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                                    ...
                                                    Tasks (<?php echo e($item['tasks']->count()); ?>)
                                                </h4>
                                            </div>
                                            <div class="overflow-x-auto">
                                                <table class="min-w-full text-xs table-fixed">
                                                    ...
                                                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                                        <?php $__currentLoopData = $item['task_rows']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php $task = $row['task']; ?>
                                                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors text-center">
                                                            <td class="px-3 py-2.5 text-left">
                                                                <span class="font-medium text-gray-900 dark:text-gray-100"><?php echo e($task->reference); ?></span>
                                                                <?php if($task->passenger_name): ?>
                                                                    <div class="text-[10px] text-gray-500 mt-0.5"><?php echo e($task->passenger_name); ?></div>
                                                                <?php endif; ?>
                                                            </td>
                                                            ...
                                                            <td class="px-3 py-2.5">
                                                                ...
                                                                ?>
                                                                <span class="inline-flex items-center px-2 py-0.5 rounded-full font-medium <?php echo e($statusColor); ?>">
                                                                    <?php echo e(ucfirst($task->status ?? '—')); ?>

                                                                </span>
                                                            </td>
                                                            <!-- <td class="px-3 py-2.5 font-medium text-gray-900 dark:text-gray-100">
                                                                <?php if($task->refundDetail): ?>
                                                                    <?php echo e(number_format($task->refundDetail->total_refund_to_client ?? 0, 3)); ?>

                                                                <?php else: ?>
                                                                    <?php echo e(number_format($task->invoiceDetail->task_price ?? $task->total ?? 0, 3)); ?>

                                                                <?php endif; ?>
                                                            </td> -->
                                                            <td class="px-3 py-2.5 font-semibold <?php echo e($row['debit'] > 0 ? 'text-rose-600 dark:text-rose-400' : 'text-gray-400'); ?>">
                                                                <?php echo e($row['debit'] > 0 ? number_format($row['debit'], 3) : '—'); ?>

                                                            </td>
                                                            <td class="px-3 py-2.5 font-semibold <?php echo e($row['credit'] > 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-400'); ?>">
                                                                <?php echo e($row['credit'] > 0 ? number_format($row['credit'], 3) : '—'); ?>

                                                            </td>
                                                            <td class="px-3 py-2.5 font-semibold <?php echo e($row['running_balance'] > 0 ? 'text-rose-600 dark:text-rose-400' : ($row['running_balance'] < 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-600 dark:text-gray-400')); ?>">
                                                                <?php echo e(number_format($row['running_balance'], 3)); ?>

                                                            </td>
                                                            <td class="px-3 py-2.5">
                                                                <?php if($task->refundDetail && $task->refundDetail->refund): ?>
                                                                    <?php $refund = $task->refundDetail->refund; ?>
                                                                    <a href="<?php echo e(route('refunds.show',
                                                                        ...
                                                                        <?php echo e($refund->status === 'completed' ? 'bg-purple-100 text-purple-700 hover:bg-purple-200' : 
                                                                        'bg-amber-100 text-amber-700 hover:bg-amber-200'); ?> transition-colors"
                                                                        @click.stop data-tooltip-left="<?php echo e($refund->refund_number); ?>" target="_blank">
                                                                ...
                                                                <?php elseif(strtolower($task->status) === 'refund'): ?>
                                                                ...
                                                                <?php elseif($task->invoiceDetail && $task->invoiceDetail->invoice): ?>
                                                                    ...
                                                                    ?>
                                                                    <a href="<?php echo e(route('invoice.show', ['companyId' => $invoice->agent->branch->company_id ?? 1, 'invoiceNumber' => $invoice->invoice_number])); ?>" 
                                                                        class="inline-flex items-center gap-1 px-2 py-1 rounded font-medium <?php echo e($statusColor); ?> transition-colors"
                                                                        @click.stop data-tooltip-left="<?php echo e($invoice->invoice_number); ?>" target="_blank">
                                                                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pagination','data' => ['data' => $clients]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($clients)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/reports/client.blade.php ENDPATH**/ ?>