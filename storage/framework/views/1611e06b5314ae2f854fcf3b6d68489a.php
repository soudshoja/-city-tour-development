        ...
        <div class="flex justify-between items-center my-4">
            <div class="flex items-center gap-5">
                ...
                <div data-tooltip="Number of rules"
                    ...
                    <span class="text-xl font-bold text-white"><?php echo e($rules->count()); ?></span>
                </div>
            </div>
                ...
                <table class="table-hover whitespace-nowrap dataTable-table">
                    ...
                    <tbody>
                        ...
                        <tr class="text-sm font-semibold text-gray-600 text-center">
                            <td><?php echo e($rule->created_by ?? '-'); ?></td>
                            <td><?php echo e($rule->agent->name ?? '-'); ?></td>
                            <td><?php echo e($rule->issued_by ?? '-'); ?></td>
                            <td class="whitespace-normal break-words min-w-[250px]"><?php echo e($rule->client->full_name ?? '-'); ?></td>
                            <td><?php echo e(number_format($rule->add_amount, 3)); ?></td>
                            <td>
                                <?php echo e($rule->gateway?->name ?? '-'); ?>

                                <?php if($rule->method): ?>
                                    - <?php echo e($rule->method->english_name); ?>

                                <?php endif; ?>
                            </td>
                            <td>
                                <?php echo e(\Carbon\Carbon::parse($rule->invoice_time_company)->format('H:i A')); ?>

                            </td>
                            <td>
                                <?php if($rule->auto_send_whatsapp): ?>
                            ...
                            <td>
                                <div class="flex items-center justify-center gap-2">
                                    <div x-data="{ 
                                        ...
                                        <button type="button" @click='openEdit(<?php echo json_encode($rule, 15, 512) ?>)' data-tooltip-left="Edit rule"
                                        ...
                                        <template x-teleport="body">
                                            <div x-cloak x-show="editModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-40 backdrop-blur-sm transition">
                                                <form :action="'<?php echo e(route('auto-billing.update', '')); ?>/' + currentRule.id" method="POST"
...
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'agent_id','items' => $agents->map(fn($a) => ['id' => $a->id, 'name' => $a->name])->values(),'placeholder' => 'Select Agent'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($rule->agent->id ?? null),'x-bind:selected-id' => 'currentRule.agent_id','selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($rule->agent->name ?? null)]); ?>
...
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'client_id','items' => $clients->map(fn($c) => [
                                                                        ...
                                                                        ])->values(),'placeholder' => 'Select Client'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\SearchableDropdown::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($rule->client->id ?? null),'selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($rule->client->full_name . ' - ' . $rule->client->phone ?? null)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8)): ?>
<?php $attributes = $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8; ?>
...
<?php endif; ?>
                                                            ...
                                                            <div class="flex flex-col sm:flex-row gap-4">
                                                                <div class="flex-1">
                                                                    ...
                                                                    <select name="gateway_id" id="gateway-select-edit"
                                                                        class="border border-gray-300 p-2 rounded-md w-full text-base">
                                                                        <template x-for="gateway in <?php echo e($paymentGateways->toJson()); ?>" :key="gateway.id">
                                                                ...
                                                                <div class="flex-1">
                                                                    ...
                                                                    <select name="method_id" id="method-select-edit"
                                                                        class="border border-gray-300 p-2 rounded-md w-full text-base">
                                                                        <template x-for="method in <?php echo e($paymentMethods->toJson()); ?>" :key="method.id">
                                            ...
                                            <div x-show="showConfirm" x-cloak x-transition.opacity
                                                ...
                                                <div x-transition.scale @click.away="showConfirm = false" class="bg-white rounded-xl shadow-xl px-8 py-8 w-full max-w-sm text-center">
                                                    ...
                                                    <div class="flex justify-center gap-4">
                                                        ...
                                                        <form action="<?php echo e(route('auto-billing.destroy', $rule->id)); ?>" method="POST">
        ...
        <template x-teleport="body">
            <div x-cloak x-show="createModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-40 backdrop-blur-sm transition">
                <form action="<?php echo e(route('auto-billing.store')); ?>" method="POST"
                    class="inline-flex flex-col gap-4 items-center w-full">
                    <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\SearchableDropdown::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('agent_id', $selectedAgentId ?? null))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8)): ?>
<?php $attributes = $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8; ?>
...
<?php endif; ?>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">
                                        Company timezone:
                                        <strong><?php echo e($companyTimezone); ?></strong><br>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const companyTz = <?php echo json_encode(trim($companyTimezone), 15, 512) ?>;
            ...
            const form = document.querySelector('form[action="<?php echo e(route('auto-billing.store')); ?>"]');
            if (form) {
            ...
            const gateways = <?php echo json_encode($paymentGateways, 15, 512) ?>;
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/auto-billing/index.blade.php ENDPATH**/ ?>