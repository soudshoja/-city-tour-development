    ...
    <table class="min-w-full bg-white border border-gray-300 mt-4">
        ...
        <tbody>
            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="py-4 px-6 border-b"><?php echo e($task->description); ?></td>
                    <td class="py-4 px-6 border-b"><?php echo e($task->created_at->format('Y-m-d')); ?></td>
                    <td class="py-4 px-6 border-b"><?php echo e($task->status); ?></td>
                    <td class="py-4 px-6 border-b"><?php echo e($task->client->full_name); ?></td>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/agents/partials/tasks.blade.php ENDPATH**/ ?>