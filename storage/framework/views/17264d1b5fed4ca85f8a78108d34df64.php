    ...
    <div>
        ...
        <div class="my-5 flex items-center rounded bg-success-light p-3.5 text-success dark:bg-success-dark-light">
            <span class="ltr:pr-2 rtl:pl-2"><strong class="ltr:mr-1 rtl:ml-1">Success!
                </strong><?php echo e(session('success')); ?></span>
                    ...
                    <div x-data="{ open: false }" x-cloak class="relative">
                        ...
                        <div x-show="open" @mouseenter="open = true" @mouseleave="open = false"
                            ...
                            <div class="py-1">
                                ...
                                <a onclick="window.location='<?php echo e(route('companies.exportCsv')); ?>'"
                    ...
                    <div x-data="{ open: false }" x-cloak class="relative">
                        ...
                        <div x-show="open" @mouseenter="open = true" @mouseleave="open = false"
                            ...
                            <div class="py-1">
                                ...
                                <a href="<?php echo e(route('download.company')); ?>"
                ...
                <table class="AgentTable CityMobileTable w-full">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-300">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2"><?php echo e($company->name); ?></td>
                            <td class="px-4 py-2"><?php echo e($company->code); ?></td>
                            <td class="px-4 py-2"><?php echo e($company->email); ?></td>
                            <td class="px-4 py-2"><?php echo e($company->phone); ?></td>
                            <td class="px-4 py-2"><?php echo e($company->nationality); ?></td>
                            <td class="px-4 py-2">
                            ...
                            <td class="px-4 py-2 flex gap-2">
                                <a href="<?php echo e(route('companies.show', ['id' => $company->id])); ?>">
                                ...
                                <a href="<?php echo e(route('companies.edit', ['id' => $company->id])); ?>">
...
<?php endif; ?>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const companiesCount = <?php echo json_encode($companiesCount, 15, 512) ?>;
        ...
        document.getElementById('excelFileInput').addEventListener('change', function() {
            ...
            if (file) {
                ...
                fetch("<?php echo e(route('companiesupload.import')); ?>", {
                        method: 'POST',
                        headers: {
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/companies/companiesList.blade.php ENDPATH**/ ?>