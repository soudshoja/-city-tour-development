<script>
    ...
    function toggleTasksDetails(taskId) {
        ...
        let url = "<?php echo route('tasks.show', '__taskId__'); ?>".replace('__taskId__', taskId);
                    ...
                    taskDetailsDiv.innerHTML = `
                                ...
                                <div class="p-4 justify-between flex items-center gap-5">
                                    ...
                                    <p><span class="badge whitespace-nowrap px-2 py-1 rounded text-sm font-medium
                                        ${data.status === 'Paid' ? 'badge-outline-success' : ''}
                                        ${data.status === 'Unpaid' ? 'badge-outline-assigned' : ''}">
...
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/invoice/tasksjs.blade.php ENDPATH**/ ?>