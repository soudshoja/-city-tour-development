...
<script>
    function paymentTab() {
        return {
            ...
            async getSettings() {
                try {
                    const response = await fetch('<?php echo e(route("user-settings.get")); ?>', {
                        method: 'POST',
                        headers: {
            ...
            async updateSetting(key, value) {
                try {
                    const response = await fetch('<?php echo e(route("user-settings.update")); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
</script><?php /**PATH /home/soudshoja/soud-laravel/resources/views/settings/partial/payment.blade.php ENDPATH**/ ?>