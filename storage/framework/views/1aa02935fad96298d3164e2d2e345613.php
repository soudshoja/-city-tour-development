...
<?php endif; ?>
<?php $component->withAttributes(['width' => '60','height' => '60','class' => 'rounded-full shadow-md bg-white dark:bg-gray-700 p-2 hover:shadow-lg transition-all duration-200']); ?>
...
<?php endif; ?>
        ...
        <div class="flex flex-col items-center ">
            <a
                href="<?php echo e(route('invoices.create')); ?>">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("create", App\Models\Invoice::class)): ?>
        <div class="flex flex-col items-center ">
            <a href="<?php echo e(route("bulk-invoices.index")); ?>">
        ...
        <?php if(in_array(auth()->user()->role_id, [\App\Models\Role::ADMIN, \App\Models\Role::COMPANY])): ?>
        <div class="flex flex-col items-center">
            <a href="<?php echo e(route('admin.dotw.audit-logs')); ?>">
                <div class="relative">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex items-center justify-between space-x-4">
                            ...
                            <button type="button" @click="swap(); convertIfReady()" class="rounded-full border p-2 bg-white shadow" title="Swap">
                                <img src="<?php echo e(asset('images/swap-currency.png')); ?>" alt="Swap" class="w-full h-full">
                            </button>
...
</script><?php /**PATH /home/soudshoja/soud-laravel/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>