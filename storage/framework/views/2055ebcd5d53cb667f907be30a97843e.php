        ...
        <div class="">
            ...
            <div class="p-4 rounded-b-lg bg-white dark:bg-gray-600 overflow-auto shadow-sm max-h-160 flex">
                <div class="px-2 grid grid-cols-2 xl:grid-cols-3 gap-2 w-1/2">
                    ...
                    <button data-item-id="<?php echo e($city['Code']); ?>" class="btn p-2 bg-gradient-to-r from-gray-800 to-gray-500 dark:to-blue-600 dark:border-gray-500 rounded-md text-center text-white w-full hover:from-gray-200 hover:to-gray-400 hover:text-black">
    ...
    <script>
        ...
        cityButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                let url = "<?php echo route('suppliers.tbo.hotel-list', ['cityCode' => '__cityCode__']); ?>";
                ...
                fetch(url)
                    ...
                    .then(data => {
                        ...
                        hotelsData.forEach(hotel => {
                            ...
                            // hotelDiv.href = "<?php echo route('suppliers.tbo.hotel-details', ['hotelCode' => '__hotelCode__']); ?>".replace('__hotelCode__', hotel.HotelCode);
                            ...
                            hotelDiv.addEventListener('click', function() {
                                let url = "<?php echo route('suppliers.tbo.hotel-details', ['hotelCode' => '__hotelCode__']); ?>".replace('__hotelCode__', hotel.HotelCode);
                                fetch(url)
                                    .then(response => response.json())
                                    .then(data => {
                                        if (typeof data.error !== 'undefined') throw new Error(data.error);
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/suppliers/tbo/city.blade.php ENDPATH**/ ?>