<div class="flex justify-between items-center gap-5 pt-10 my-3">
    <div class="flex items-center gap-5">
        ...
        <div data-tooltip="Number of refunds"
            ...
            <span class="text-xl font-bold text-white"><?php echo e($totalRefundClients); ?></span>
        </div>
    </div>
</div>
    ...
    <div class="dataTable-wrapper mt-4">
        <div class="dataTable-container h-max">
            <table class="table-hover whitespace-nowrap dataTable-table">
                ...
                <tbody>
                    <?php if($refundClients->isEmpty()): ?>
                    <tr>
                        <td colspan="7" class="text-center p-3 text-sm font-semibold text-gray-600">
                            No data for now.... Create new!</td>
                    </tr>
                    <?php else: ?>
                    <?php $__currentLoopData = $refundClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $refund): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="p-3 text-sm font-semibold text-gray-600">
                        <td>
                            <?php echo e($refund->amount); ?>

                        </td>
                        <td>
                            <?php echo e($refund->client->first_name ?? ''); ?>

                        </td>
                        <td>
                            KWD <?php echo e(number_format($refund->total_nett_refund, 2)); ?>

                        </td>
                        <td>
                            <?php echo e($refund->remarks ?? 'No Remarks'); ?>

                        </td>
                        <td>
                            <?php echo e($refund->created_at); ?>
                        ...
                        <td>
                            <span
                                class="badge whitespace-nowrap px-2 py-1 rounded text-sm font-medium
                                                ...
                                                <?php echo e($refund->status === 'failed' ? 'badge-outline-danger' : ''); ?>">
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('complete', [App\Models\RefundClient::class, $refund])): ?>
                            <a href="<?php echo e(route('refunds.refund-client.complete', $refund->id)); ?>"
                        ...
                        <td class="p-3 text-sm">
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', [App\Models\RefundClient::class, $refund])): ?>
                                ...
                                <div x-cloak x-show="deleteRefundClient" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-75 z-50">
                                    <div class="bg-white rounded-lg p-6 shadow-lg">
                                        ...
                                        <div class="mt-4 flex justify-end space-x-2">
                                            ...
                                            <form action="<?php echo e(route('refunds.refund-client.delete', $refund->id)); ?>" method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/soudshoja/soud-laravel/resources/views/refunds/refund-client.blade.php ENDPATH**/ ?>