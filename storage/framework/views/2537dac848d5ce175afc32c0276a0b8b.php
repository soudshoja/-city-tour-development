...
<?php $component->withAttributes([]); ?>
    <div class="container mx-auto mt-10">
        ...
        <div id="branchForm" class="form">
            <form action="<?php echo e(route('users.create')); ?>" method="POST" class="p-4 border border-gray-300 rounded-lg shadow">
                <?php echo csrf_field(); ?>
                <!-- Hidden Company ID -->
        ...
        <div id="agentForm" class="form hidden">
            <form action="<?php echo e(route('companies.createAgent')); ?>" method="POST" class="p-4 border border-gray-300 rounded-lg shadow">
                <?php echo csrf_field(); ?>
        ...
        <div id="accountantForm" class="form hidden">
            <form action="<?php echo e(route('companies.createAccountant')); ?>" method="POST" class="p-4 border border-gray-300 rounded-lg shadow">
                <?php echo csrf_field(); ?>
        ...
        <div id="clientForm" class="form hidden">
            <form action="<?php echo e(route('companies.createClient')); ?>" method="POST" class="p-4 border border-gray-300 rounded-lg shadow">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/admin/addNew.blade.php ENDPATH**/ ?>