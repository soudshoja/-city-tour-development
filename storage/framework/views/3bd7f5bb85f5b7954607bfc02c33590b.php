...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid grid-cols-3 gap-4 p-8">
        ...
        <div class="col-span-2 bg-white shadow-lg rounded-lg p-6">
            ...
            <form method="POST" action="<?php echo e(route('companies.store')); ?>" class="p-2 bg-gray-200 rounded-lg">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/admin/addnewCompany.blade.php ENDPATH**/ ?>