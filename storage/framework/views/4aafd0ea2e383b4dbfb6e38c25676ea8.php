            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md border border-gray-200 dark:border-gray-700">
                    ...
                    <div class="max-h-[600px] overflow-y-auto overflow-x-auto border border-gray-200 dark:border-gray-600 rounded-lg">
                        <?php if($JournalEntrysPayable->isNotEmpty()): ?>
                            <?php $__currentLoopData = $JournalEntrysPayable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $ledgers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="sticky top-0 bg-red-50 dark:bg-red-900/30 px-4 py-2 border-b border-gray-200 dark:border-gray-600">
                                    <h3 class="text-md font-bold text-red-600 dark:text-red-400"><?php echo e(ucfirst($type)); ?></h3>
                                </div>
                ...
                <div class="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 h-fit">
                    ...
                    <form action="<?php echo e(route('payable-details.payable-store')); ?>" method="POST" class="space-y-6">
                        <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\App\View\Components\SearchableDropdown::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['selectedId' => 'payable','selectedName' => 'Payable']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8)): ?>
<?php $attributes = $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8; ?>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/accounting/payable-create.blade.php ENDPATH**/ ?>