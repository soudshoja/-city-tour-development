...
<?php $component->withAttributes([]); ?>
    ...
    <div class="panel h-full overflow-hidden border-0 p-0">
        ...
        <form method="POST" action="<?php echo e(route('receipt-voucher.store')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
                        ...
                        <div class="w-full lg:w-1/2 lg:max-w-fit mt-5">
                            <div class="flex items-center gap-x-4">
                                ...
                                <input type="text" readonly value="RV-<?php echo e(now()->timestamp); ?>"
                                    class="form-input w-2/3 lg:w-[250px]  bg-gray-200" />
                                <input type="hidden" name="receiptvoucherref" value="RV-<?php echo e(now()->timestamp); ?>" required>
                            ...
                            <div class="mt-4 flex items-center gap-x-4">
                                ...
                                <input required id="docdate" type="date" name="docdate"
                                    class="form-input w-2/3 lg:w-[250px]" value="<?php echo e(old('docdate')); ?>" />
                            </div>
                            ...
                            <div class="mb-6 w-full lg:w-1/2 ltr:lg:mr-6 rtl:lg:ml-6">
                                ...
                                <div class="mt-4 flex items-center gap-x-4">
                                    ...
                                    <input required id="pay_to" type="text" name="pay_to"
                                        ...
                                        placeholder="Search client name..." value="<?php echo e(old('pay_to')); ?>" />
                                    <datalist id="clientList">
                                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($client->full_name); ?>">
                            ...
                            <div class="w-full lg:w-1/2">
                                ...
                                <div class="mt-4 flex items-center gap-x-4">
                                    ...
                                    <input required id="remarks_create" type="text" name="remarks_create"
                                        class="form-input flex-1" placeholder="Enter Remarks" value="<?php echo e(old('remarks_create')); ?>" />
                                </div>
                                ...
                                <div class="mt-4 flex items-center gap-x-4">
                                    ...
                                    <input id="internal_remarks" type="text" name="internal_remarks"
                                        class="form-input flex-1" placeholder="Enter Internal Remarks" value="<?php echo e(old('internal_remarks')); ?>" />
                                </div>
                                ...
                                <div class="mt-4 flex items-center gap-x-4">
                                    ...
                                    <input id="remarks_fl" type="text" name="remarks_fl"
                                        class="form-input flex-1" placeholder="Enter Remarks FL" value="<?php echo e(old('remarks_fl')); ?>" />
                                </div>
                            </div>
                ...
                <div class="w-full sm:w-1/3">
                    ...
                    <datalist id="clientList">
                        ...
                        <option value="<?php echo e($client->name); ?>">
                            [<?php echo e($client->root->name ?? 'N/A'); ?>] [<?php echo e($client->code); ?>] <?php echo e($client->name); ?>
                                    ...
                                    ${
                                        ...
                                        ? `<input required list="invoiceList_${index}" class="form-control form-control-sm"
                                            ...
                                            <datalist id="invoiceList_${index}">
                                                <?php $__currentLoopData = $unpaidInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="[<?php echo e($inv->invoice_number); ?>] <?php echo e($inv->client->full_name ?? ''); ?>" data-id="<?php echo e($inv->id); ?>"></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </datalist>`
                                        ...
                                        ? `<input required list="clientList_${index}" class="form-control form-control-sm"
                                            ...
                                            <datalist id="clientList_${index}">
                                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($client->full_name); ?>" data-id="<?php echo e($client->id); ?>">
                                                        <?php echo e($client->email); ?>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/receipt-voucher/create.blade.php ENDPATH**/ ?>