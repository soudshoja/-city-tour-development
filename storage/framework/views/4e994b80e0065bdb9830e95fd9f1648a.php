...
<body class="bg-gray-100">
    <div class="container mx-auto p-6 bg-white shadow rounded-md">
        ...
        <!-- Invoice Information -->
        <div class="mb-6">
            <p><strong>Invoice Number:</strong> <?php echo e($invoice['number']); ?></p>
            <p><strong>Total Amount:</strong> $<?php echo e(number_format($invoice['amount'], 2)); ?></p>
        </div>
    ...
    <script>
     ...
     <?php /**PATH /home/soudshoja/soud-laravel/resources/views/payment/choose.blade.php ENDPATH**/ ?>