...
<?php $component->withAttributes([]); ?>
    <nav class="flex items-center space-x-2 rtl:space-x-reverse text-sm mb-4 sm:mb-6 overflow-x-auto">
        <a href="<?php echo e(route('dashboard')); ?>" class="text-gray-500 hover:text-gray-700 transition whitespace-nowrap">Dashboard</a>
        ...
        <div id="setting-index" x-data="settingsPage()" x-init="init()" class="flex min-h-[500px] overflow-x-auto">
            ...
            <div class="flex-1 p-6">
                ...
                <!-- <div x-show="activeTab === 'invoice'" x-cloak>
                    <?php echo $__env->make('settings.partial.invoice', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div> -->
                <div x-show="activeTab === 'payment'" x-cloak>
                    <?php echo $__env->make('settings.partial.payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div x-show="activeTab === 'terms'" x-cloak>
                    <?php echo $__env->make('settings.partial.terms_condition', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div x-show="activeTab === 'charges'" x-cloak x-ref="chargesTab">
                    <?php echo $__env->make('settings.partial.charges', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div x-show="activeTab === 'payment-methods'" x-cloak>
                    <?php echo $__env->make('settings.partial.payment_methods', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div x-show="activeTab === 'agent-charges'" x-cloak>
                    <?php echo $__env->make('settings.partial.agent_charges', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function settingsPage() {
            return {
                ...
                saveTab(tab) {
                    this.activeTab = tab;
                    fetch('<?php echo e(route("settings.save-tab")); ?>', {
                        method: 'POST',
                        headers: {
                ...
                async loadTemplates() {
                    ...
                    const url = '<?php echo e(route("terms.templates.index")); ?>' + '?' + params.toString();
                    try {
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/settings/index.blade.php ENDPATH**/ ?>