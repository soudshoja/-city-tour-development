...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['action' => ''.e(route('clients.index')).'','searchParam' => 'search','placeholder' => 'Quick search for clients']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('clients.index')).'','searchParam' => 'search','placeholder' => 'Quick search for clients']); ?>
                ...
                <div class="dataTable-container h-max">
                    <table id="myTable" class="table-hover whitespace-nowrap dataTable-table">
                        ...
                        <tbody>
                            ...
                            <tr data-name="<?php echo e($client->full_name); ?>" data-email="<?php echo e($client->email); ?>"
                                data-phone="<?php echo e($client->phone); ?>" class="taskRow">
                                <td class="p-3 text-sm text-center">
                                    <a href="javascript:void(0);"
                                        class="viewClient inline-flex items-center justify-center mx-auto text-blue-600 dark:text-blue-300"
                                        data-id="<?php echo e($client->id); ?>" data-name="<?php echo e($client->full_name); ?>"
                                        data-email="<?php echo e($client->email); ?>" data-phone="<?php echo e($client->phone); ?>"
                                ...
                                <td class="text-center">
                                    <div class="w-full p-3 text-sm font-semibold text-blue-600 dark:text-gray-300 flex justify-between items-center">
                                        <a href="<?php echo e(route('clients.show', ['id' => $client->id])); ?>">
                                            <p><?php echo e($client->fullname); ?></p>
                                        </a>
                                        <a href="javascript:void(0);"
                                            id="copyNameButton"
                                            class="mx-auto text-green-600 dark:text-green-300 ml-2"
                                            data-name="<?php echo e($client->full_name); ?>"
                                ...
                                <td class="p-3 text-sm font-semibold text-center">
                                    <?php echo e($client->civil_no ?? 'N/A'); ?>
                                ...
                                <td class="p-3 text-sm font-semibold text-center">
                                    <a href="javascript:void(0);"
                                        class="clientCreditLink font-bold <?php echo e(($client->totalCredit ?? 0) >= 0 ? 'text-green-600' : 'text-red-600'); ?>"
                                        data-client-id="<?php echo e($client->id); ?>">
                                        <?php echo e(number_format($client->totalCredit ?? 0, 2)); ?>
                                ...
                                <td
                                    class=" p-3 text-sm font-semibold text-gray-900 dark:text-gray-300 text-center">
                                    <?php echo e($client->phone ? $client->phone : 'N/A'); ?>

                                </td>
                                <td
                                    class=" p-3 text-sm font-semibold text-gray-900 dark:text-gray-300 text-center">
                                    <?php if($client->agents->isEmpty()): ?>
                                    <?php echo e($client->agent->name); ?>

                                    <?php else: ?>
                                    <?php if($client->agents->count() == 1): ?>
                                    <?php echo e($client->agents->first()->name); ?>
                                            ...
                                            <ul class="text-gray-700 dark:text-gray-300 pt-1">
                                                ...
                                                <li>
                                                    <a class="rounded-t bg-white dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 py-2 px-4 block whitespace-no-wrap"
                                                        href="javascript:void(0);"><?php echo e($agent->name); ?></a>
                                                </li>
...
<script>
    ...
    if (resetSearchButton) {
        resetSearchButton.addEventListener("click", function() {
            window.location.href = "<?php echo e(route('clients.index')); ?>"; // Redirect to the clients index route
        });
    }

    let clients = <?php echo json_encode($fullClients, 15, 512) ?>;
    ...
    async function fetchSubClients(parentClientId) {
        const fetchUrl = "<?php echo e(route('clients.sub', ':parentClientId')); ?>".replace(':parentClientId', parentClientId);
    ...
    async function fetchParClients(childClientId) {
        const fetchUrl = "<?php echo e(route('clients.parent', ':childClientId')); ?>".replace(':childClientId', childClientId);
    ...
    async function fetchClientDetails(id) {
        ...
        const fetchUrl = "<?php echo e(route('clients.details', ':id')); ?>".replace(':id', id);
    ...
    async function updateClientGroup() {
        ...
        const updateUrl = "<?php echo e(route('clients.group.update', ':id')); ?>".replace(':id', id);
    ...
    async function removeGroup(parentClientId, childClientId) {
        ...
        const removeUrl = "<?php echo e(route('clients.group.remove')); ?>";
    ...
    document.querySelectorAll('.clientCreditLink').forEach(link => {
        link.addEventListener('click', function() {
            ...
            const ledgerUrlTemplate = "<?php echo e(route('clients.credits', ':clientId')); ?>";
            if (ledgerBtn) {
...
</script><?php /**PATH /home/soudshoja/soud-laravel/resources/views/clients/list.blade.php ENDPATH**/ ?>