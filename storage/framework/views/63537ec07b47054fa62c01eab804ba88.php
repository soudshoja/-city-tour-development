        ...
        <div id="addInvoiceModal" class="fixed z-10 inset-0 flex items-center justify-center backdrop-blur-sm hidden">
            ...
            <div class="bg-white rounded-lg shadow-lg max-w-md w-full relative z-20">
                <div class="rounded-t-lg h-32 bg-cover bg-center"
                    style="background-image: url('<?php echo e(asset('images/CreateInvoicePic.svg')); ?>');">
            ...
            <div class="max-h-96 overflow-y-auto custom-scrollbar">
                <table class="InvoiceTable CityMobileTable w-full">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-300">
                        ...
                        <tr>
                            <td class="px-4 py-2"><?php echo e($invoice->invoice_number); ?></td>
                            <td class="px-4 py-2"><?php echo e($invoice->agent->name); ?></td>
                            <td class="px-4 py-2"><?php echo e($invoice->client->full_name); ?></td>
                            <td class="px-4 py-2"><?php echo e($invoice->amount); ?></td>
                            <td class="px-4 py-2"><?php echo e($invoice->status); ?></td>
                            <td class="px-4 py-2">
                                <a href="javascript:void(0);"
                                    onclick="openInvoiceModal('<?php echo e($invoice->invoice_number); ?>')"
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const totalInvoices = <?php echo json_encode($totalInvoices, 15, 512) ?>;
    ...
    function openInvoiceModal(invoiceNumber) {
        ...
        const companyId = "<?php echo e(auth()->user()->company_id ?? auth()->user()->branch->company_id ?? auth()->user()->agent->branch->company_id); ?>";
...
</script><?php /**PATH /home/soudshoja/soud-laravel/resources/views/payment/companyAgentsInvoices.blade.php ENDPATH**/ ?>