<div class="flex flex-col gap-4" @change="updateVisaDetail($event)">
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="text"
                name="visa_type"
                value="<?php echo e($task->visaDetails->visa_type ?? ''); ?>"
        ...
        <div>
            ...
            <input type="text"
                ...
                value="<?php echo e($task->visaDetails->application_number ?? ''); ?>"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="text"
                ...
                value="<?php echo e($task->visaDetails->issuing_country ?? ''); ?>"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
        </div>
        <div>
            ...
            <input type="date"
                name="expiry_date"
                value="<?php echo e($task->visaDetails->expiry_date ?? ''); ?>"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-4">
        <div>
            ...
            <input type="text"
                ...
                value="<?php echo e($task->visaDetails->number_of_entries ?? ''); ?>"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
        </div>
        <div>
            ...
            <input type="text"
                name="stay_duration"
                value="<?php echo e($task->visaDetails->stay_duration ?? ''); ?>"
                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none">
        </div>
    </div>
</div>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/tasks/partial/visa-details-form.blade.php ENDPATH**/ ?>