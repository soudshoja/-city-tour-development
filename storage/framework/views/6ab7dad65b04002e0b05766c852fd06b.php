<div class="past-booking mb-3" x-data="">
        ...
        <div class="flex justify-between mb-4">
            <div class="flex justify-between items-center w-auto">
                <div class="flex items-center mx-4">
                    ...
                    <input type="date" id="startDate" class="border border-gray-300 dark:border-gray-700 dark:bg-dark p-2 rounded" value="<?php echo e($startDate); ?>">
                </div>
                <div class="flex items-center mx-4">
                    <label for="endDate" class="mr-2">End Date:</label>
                    <input type="date" id="endDate" class="border border-gray-300 dark:border-gray-700 dark:bg-dark p-2 rounded" value="<?php echo e($endDate); ?>">
                </div>
            </div>
        ...
        <div class="px-2 block grid gap-2" id="booking-container">
            ...
            <div class="rounded-md border-black border dark:border-gray-600 shadow-lg p-2 dark:bg-gray-500 group">
                <div class="flex justify-between mb-2">
                    <div>
                        Booking Id: <strong> <?php echo e($booking['BookingId']); ?> </strong>
                    </div>
                    <div class="inline-flex">
                        <div class="bg-gradient-to-r from-gray-800 to-gray-500 dark:to-blue-600 p-2 text-white rounded-md"><?php echo e($booking['AgencyName']); ?></div>
                        <a href="<?php echo e(route('suppliers.tbo.cancel-booking', ['confirmationNo' => $booking['ConfirmationNo']])); ?>" class="p-2 mx-2 bg-red-500 rounded-md">
                    ...
                    <div class="grid grid-cols-1 gap-2">
                        <div class="inline-flex justify-between">
                            <div class="flex sm:flex-col lg:flex-row gap-2">
                                <a href="<?php echo e(route('suppliers.tbo.booking-detail', ['confirmationNumber' => $booking['ConfirmationNo']])); ?>" class="p-2 bg-gray-200 dark:bg-gray-800 rounded-md items-center font-bold group-hover:animate-pulse cursor-pointer">
                                    <?php echo e($booking['ConfirmationNo']); ?>

                                </a>
                                <div class="bg-gradient-to-r from-green-800 to-green-400 items-center p-2 text-white rounded-md font-bold"><?php echo e($booking['BookingStatus']); ?></div>
                            </div>
                            <div>
                                Booking Price : <strong> <?php echo e($booking['BookingPrice']); ?> <?php echo e($booking['Currency']); ?> </strong>
                            </div>
                        </div>
                        <div class="">Agent Markup: <?php echo e($booking['AgentMarkup']); ?> <?php echo e($booking['Currency']); ?></div>
                        <div class="">Trip Name: <?php echo e($booking['TripName']); ?></div>
                        <div class="">Hotel Code: <?php echo e($booking['TBOHotelCode']); ?></div>
                        <div class="">Client Reference Number: <?php echo e($booking['ClientReferenceNumber']); ?></div>
                    </div>
                    <div class="grid w-auto border-gray-400 border w-full md:w-auto p-2 rounded-md">
                        <div class="">
                            <p>Booking Date: </p>
                            <strong>
                                <?php echo e($booking['BookingDate']); ?>
                        ...
                        <div class="">
                            <p>Check In: </p>
                            <strong>
                                <?php echo e($booking['CheckInDate']); ?>
                        ...
                        <div class="">
                            <p>Check Out: </p>
                            <strong>
                                <?php echo e($booking['CheckOutDate']); ?>
    ...
    <script>
        ...
        filterButton.addEventListener('click', () => {
            ...
            let url = "<?php echo route('suppliers.tbo.booking-details-by-date', ['startDate' => '__startDate__', 'endDate' => '__endDate__']); ?>";
...
</div><?php /**PATH /home/soudshoja/soud-laravel/resources/views/suppliers/tbo/past_booking.blade.php ENDPATH**/ ?>