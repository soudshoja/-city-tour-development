    ...
    <div class="flex justify-between items-center gap-5 my-3">
        <div class="flex items-center gap-5">
            ...
            <div data-tooltip="Total users"
                ...
                <span class="text-xl font-bold text-white"><?php echo e($users->total()); ?></span>
            </div>
        </div>
        <div class="flex items-center gap-5">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['action' => route('users.index'),'searchParam' => 'q','placeholder' => 'Quick search for user']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('users.index')),'searchParam' => 'q','placeholder' => 'Quick search for user']); ?>
                        ...
                        <tr class="transition-colors duration-150 cursor-pointer p-3 text-sm font-semibold text-gray-600">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center gap-2 flex-wrap">
                                    <?php $__currentLoopData = $userItem->getRoleNames(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="whitespace-nowrap px-2 py-1 rounded text-xs font-medium border
                                        <?php echo e($role === 'admin' ? 'border-koromiko-300 text-koromiko-500 bg-koromiko-50' : ''); ?>

                                        <?php echo e($role === 'company' ? 'border-blue-500 text-blue-500 bg-blue-50' : ''); ?>

                                        <?php echo e($role === 'branch' ? 'border-amber-700 text-amber-700 bg-amber-50' : ''); ?>

                                        <?php echo e($role === 'agent' ? 'border-purple-500 text-purple-500 bg-purple-50' : ''); ?>

                                        <?php echo e($role === 'accountant' ? 'border-red-500 text-red-500 bg-red-50' : ''); ?>

                                        <?php echo e(!in_array($role, ['admin', 'company', 'branch', 'agent', 'accountant']) ? 'border-gray-500 text-gray-500 bg-gray-50' : ''); ?>">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <a data-tooltip-left="Edit user"
                                        href="<?php echo e(route('users.edit', $userItem->id)); ?>"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pagination','data' => ['data' => $users]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($users)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/users/index.blade.php ENDPATH**/ ?>