...
<?php $component->withAttributes([]); ?>
     <div x-data="todolist">
         <div class="relative flex h-full gap-5 sm:h-[calc(100vh_-_150px)]">
             <div class="panel absolute z-10 hidden h-full w-[240px] max-w-full flex-none space-y-4 p-4 rounded-r-none  xl:relative xl:block xl:h-auto xl:rounded-r-md "
                 ...
                 <div class="flex h-full flex-col pb-16">
                     <div class="pb-5">
                         <div class="flex items-center text-center">
                             ...
                             <div class="absolute  w-full p-4 left-0 ">
                                 <button class="btn btn-primary w-full" type="button" @click="addEditTask()">
                                     <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                         viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                         stroke-linecap="round" stroke-linejoin="round" class="h-5 w-5 shrink-0 mr-2 ">
                         ...
                         <div class="space-y-1">
                             <button type="button"
                                 ...
                                 <div class="flex items-center">
                                     <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                         xmlns="http://www.w3.org/2000/svg" class="h-4.5 w-4.5 shrink-0">
                             ...
                             <button type="button"
                                 ...
                                 <div class="flex items-center">
                                     ...
                                     <div class="ml-3 ">Trash</div>
                                 </div>
                             </button>
                             <div class="h-px w-full border-b border-[#e0e6ed] dark:border-[#1b2e4b]"></div>
                             <div class="px-1 py-3 text-white-dark">Tags</div>
                             <button type="button"
                                 class="flex h-10 w-full items-center rounded-md p-1 font-medium text-success duration-300 hover:bg-white-dark/10 hover:pl-3  dark:hover:bg-[#181F32]"
                                 :class="{ 'pl-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'team' }"
                                 @click="tabChanged('team')">
                                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 shrink-0 rotate-45 fill-success">
                                     <path
                             ...
                             <button type="button"
                                 class="flex h-10 w-full items-center rounded-md p-1 font-medium text-warning duration-300 hover:bg-white-dark/10 hover:pl-3  dark:hover:bg-[#181F32]"
                                 :class="{ 'pl-3  bg-gray-100 dark:bg-[#181F32]': selectedTab === 'low' }"
                                 ...
                                 <div class="ml-3 ">Low</div>
                             </button>

                             <button type="button"
                                 class="flex h-10 w-full items-center rounded-md p-1 font-medium text-primary duration-300 hover:bg-white-dark/10 hover:pl-3  dark:hover:bg-[#181F32]"
                                 :class="{ 'pl-3  bg-gray-100 dark:bg-[#181F32]': selectedTab === 'medium' }"
                                 ...
                                 <div class="ml-3 ">Medium</div>
                             </button>

                             <button type="button"
                                 class="flex h-10 w-full items-center rounded-md p-1 font-medium text-danger duration-300 hover:bg-white-dark/10 hover:pl-3  dark:hover:bg-[#181F32]"
                                 :class="{ 'pl-3  bg-gray-100 dark:bg-[#181F32]': selectedTab === 'high' }"
                                 ...
                                 <div class="ml-3 ">High</div>
                             </button>

                             <button type="button"
                                 class="flex h-10 w-full items-center rounded-md p-1 font-medium text-info duration-300 hover:bg-white-dark/10 hover:pl-3 dark:hover:bg-[#181F32]"
                                 :class="{ 'pl-3 bg-gray-100 dark:bg-[#181F32]': selectedTab === 'update' }"
                 ...
                 <div class="flex h-full flex-col">
                     <div class="flex w-full flex-col gap-4 p-4 sm:flex-row sm:items-center">
                         <div class="flex items-center mr-3 ">
                             <button type="button" class="block hover:text-primary mr-3 xl:hidden"
                             ...
                             <div class="group relative flex-1">
                                 <input type="text" class="peer form-input !pr-10 " placeholder="Search Task..."
                                     x-model="searchTask" @keyup="searchTasks()" />
                         ...
                         <div class="flex flex-1 items-center justify-center sm:flex-auto sm:justify-end">
                             ...
                             <button type="button" :disabled="pager.currentPage == 1"
                                 class="rounded-md bg-[#f4f4f4] p-1 enabled:hover:bg-primary-light disabled:cursor-not-allowed disabled:opacity-60 mr-3 dark:bg-white-dark/20 enabled:dark:hover:bg-white-dark/30"
                             ...
                             <button type="button" :disabled="pager.currentPage == pager.totalPages"
                                 ...
                                 @click="pager.currentPage++,searchTasks(false)">
                                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                     xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 rotate-180">
                                     <path d="M15 5L9 12L15 19" stroke="currentColor" stroke-width="1.5"
                                         stroke-linecap="round" stroke-linejoin="round"></path>
                                 </svg>
                             </button>
                                         ...
                                         <tr :key="task.id" class="group cursor-pointer"
                                             ...
                                             <td>
                                                 <div @click="viewTask(task)">
                                                     <div class="whitespace-nowrap text-base font-semibold group-hover:text-primary"
                                                         :class="{ 'line-through': task.status === 'complete' }"
                                                         x-text="task.title"></div>
                                                     <div class="line-clamp-1 min-w-[300px] overflow-hidden text-white-dark"
                                                         :class="{ 'line-through': task.status === 'complete' }"
                                             ...
                                             <td class="w-1">
                                                 <p class="whitespace-nowrap font-medium text-white-dark"
                                                     :class="{ 'line-through': task.status === 'complete' }"
                                                     x-text="task.date"></p>
                                             </td>
                                             <td class="w-1">
                                                 <div class="flex w-max items-center justify-between">
                                                     <div class="flex-shrink-0 mr-2.5 ">
                                                         ...
                                                         <template x-if="!task.path && task.assignee">
                                                             <div class="grid h-8 w-8 place-content-center rounded-full bg-primary text-sm font-semibold text-white"
                                                                 x-text="task.assignee.charAt(0) + '' + task.assignee.charAt(task.assignee.indexOf(' ') + 1)">
                                                             </div>
                                                         </template>
                                                         <template x-if="!task.path && !task.assignee">
                                                             <div
                                                                 class="rounded-full border border-gray-300 p-2 dark:border-gray-800">
             ...
             <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60 px-4"
                 ...
                 <div class="flex min-h-screen items-center justify-center">
                     <div x-show="addTaskModal" x-transition x-transition.duration.300
                         ...
                         <button type="button" class="absolute top-4 text-white-dark hover:text-dark ltr:right-4 "
                         ...
                         <div class="bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px]  dark:bg-[#121c2c]"
                         ...
                         <div class="p-5">
                             <form @submit.prevent="saveTask">
                                 ...
                                 <div class="mt-8 flex items-center justify-end ltr:text-right ">
                                     <button type="button" class="btn btn-outline-danger"
                                         @click="addTaskModal = false">Cancel</button>
                                     <button type="submit" class="btn btn-primary ltr:ml-4"
             ...
             <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="{'!block':viewTaskModal}">
                 <div class="flex min-h-screen items-center justify-center px-4" @click.self="viewTaskModal = false">
                     <div x-show="viewTaskModal" x-transition x-transition.duration.300
                         ...
                         <div
                             class="flex flex-wrap items-center gap-2 bg-[#fbfbfb] py-3 text-lg font-medium ltr:pl-5 ltr:pr-[50px]  dark:bg-[#121c2c]">
                             <div x-text="selectedTask.title"></div>
                             <div x-show="selectedTask.priority" x-text="selectedTask.priority"
                                 class="badge rounded-3xl capitalize" :class="{
     ...
     document.addEventListener('alpine:init', () => {
         // Define Alpine.js component 'todolist'
         Alpine.data('todolist', () => ({
             ...
             searchTasks(isResetPage = true) {
                 if (isResetPage) this.pager.currentPage = 1;

                 // Filter tasks based on status, tag, and priority
                 let tasks = this.allTasks.filter(d => d.status !== 'trash' || this.selectedTab ===
                     'trash');
                 if (['complete', 'important', 'trash'].includes(this.selectedTab)) {
                     tasks = tasks.filter(d => d.status === this.selectedTab);
                 } else if (['team', 'update'].includes(this.selectedTab)) {
                     tasks = tasks.filter(d => d.tag === this.selectedTab);
                 } else if (['high', 'medium', 'low'].includes(this.selectedTab)) {
                     tasks = tasks.filter(d => d.priority === this.selectedTab);
                 }

                 this.filteredTasks = tasks.filter(d => d.title.toLowerCase().includes(this
             ...
             getPager() {
                 ...
                 this.pager.totalPages = Math.ceil(this.filteredTasks.length / pageSize);
                 this.pager.startIndex = (currentPage - 1) * pageSize;
                 this.pager.endIndex = Math.min(this.pager.startIndex + pageSize - 1, this
                     .filteredTasks.length - 1);
                 this.pagedTasks = this.filteredTasks.slice(this.pager.startIndex, this.pager
                     .endIndex + 1);
             },

             setPriority(task, name) {
                 const item = this.filteredTasks.find(d => d.id === task.id);
                 item.priority = name;
             ...
             viewTask(item) {
                 ...
                 setTimeout(() => (this.viewTaskModal = true));
             },

             addEditTask(task = null) {
                 this.isShowTaskMenu = false;
                 this.params = {
                     ...defaultParams
                 };
             ...
             saveTask() {
                 ...
                 if (this.params.id) {
                     // Update task
                     this.allTasks = this.allTasks.map(d => d.id === this.params.id ? {
                         ...this.params
                     } : d);
                 } else {
                     // Add new task
                     const newId = this.allTasks.length ? Math.max(...this.allTasks.map(d => d
                         .id)) + 1 : 1;
                     this.params.id = newId;
                     this.params.date = new Date().toLocaleDateString();
                     this.params.description = this.quillEditor.root.innerHTML;
                     this.params.descriptionText = this.quillEditor.getText();
                     this.allTasks.unshift(this.params);
                 }
...
<?php endif; ?>
 ...
 <!-- end main content section --><?php /**PATH /home/soudshoja/soud-laravel/resources/views/todolist/index.blade.php ENDPATH**/ ?>