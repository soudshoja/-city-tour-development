...
<?php $component->withAttributes([]); ?>
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        <nav class="flex items-center space-x-2 rtl:space-x-reverse text-sm mb-4 sm:mb-6 overflow-x-auto">
            <a href="<?php echo e(route('branches.index')); ?>" class="text-gray-500 hover:text-gray-700 transition whitespace-nowrap">Branches</a>
            <span class="text-gray-400">&gt;</span>
            <span class="text-blue-600 font-medium truncate max-w-[200px] sm:max-w-none"><?php echo e($branch->name); ?></span>
        </nav>
                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500"><?php echo e($branch->agents->count()); ?> total agents</p>
                                </div>
                            </div>
                            <a href="<?php echo e(route('users.create', ['branch_id' => $branch->id, 'role' => 'agent'])); ?>"
                        ...
                        <div class="max-h-[400px] sm:max-h-[500px] overflow-y-auto">
                            <table class="w-full">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <?php $__empty_1 = true; $__currentLoopData = $branch->agents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50 transition">
                                        <td class="px-4 py-3">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="min-w-0">
                                                    <p class="text-sm font-medium text-gray-900 truncate agent-name"><?php echo e($agent->name); ?></p>
                                                    <p class="text-xs text-gray-500 md:hidden sm:block hidden"><?php echo e($agent->phone_number ?? '—'); ?></p>
                                                </div>
                                            </div>
                                        </td>
            ...
            <div class="w-full lg:w-80 xl:w-96 flex-shrink-0 order-1 lg:order-2">
                <div class="bg-gradient-to-br from-[#4361ee] to-[#160f6b] rounded-lg shadow-sm overflow-hidden">
                    <div class="p-4 sm:p-5 border-b border-white/10">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3 min-w-0">
                                ...
                                <div class="min-w-0">
                                    <h3 class="text-white font-semibold text-base sm:text-lg truncate"><?php echo e($branch->name); ?></h3>
                                    <p class="text-white/70 text-xs sm:text-sm"><?php echo e($branch->company->name ?? 'No Company'); ?></p>
                                </div>
                            </div>
                    ...
                    <div class="p-4 sm:p-5 space-y-3 sm:space-y-4">
                        <div class="flex items-center justify-between">
                            <span class="text-white/90 text-sm">GDS Office ID</span>
                            <span class="text-white text-sm font-medium"><?php echo e($branch->gds_office_id ?? '—'); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-white/90 text-sm">Email</span>
                            <span class="text-white text-sm font-medium truncate ml-4 max-w-[180px]"><?php echo e($branch->email ?? '—'); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span class="text-white/90 text-sm">Phone</span>
                            <span class="text-white text-sm font-medium"><?php echo e($branch->phone ?? '—'); ?></span>
                        </div>
                        <div class="pt-2 border-t border-white/10">
                            <span class="text-white/90 text-sm block mb-1">Address</span>
                            <span class="text-white text-sm leading-relaxed"><?php echo e($branch->address ?? '—'); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/branches/show.blade.php ENDPATH**/ ?>