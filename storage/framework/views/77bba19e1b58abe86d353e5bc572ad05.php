...
<div id="equityDetails" class="rounded-lg shadow-sm bg-white dark:bg-gray-800 mt-1" style="display: none;">
    <ul class="w-full">
        <?php $__currentLoopData = $equities->childAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equityAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo $__env->make('coa.partials.child-account', ['account' => $equityAccount, 'color' => 'purple'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
</script><?php /**PATH /home/soudshoja/soud-laravel/resources/views/coa/partials/equity.blade.php ENDPATH**/ ?>