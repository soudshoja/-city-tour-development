<div x-data="paymentMethodsTab()" x-init="init()">
    ...
    <div x-show="!loading" x-cloak>
        ...
        <form method="POST" action="<?php echo e(route('payment-method.set-group')); ?>" x-ref="paymentMethodForm">
            <?php echo csrf_field(); ?>
            <div class="space-y-6">
    ...
    function paymentMethodsTab() {
        return {
            ...
            async loadPaymentMethods() {
                ...
                let url = '<?php echo e(route("settings.payment-methods")); ?>';
                if (this.companyId) {
...
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/settings/partial/payment_methods.blade.php ENDPATH**/ ?>