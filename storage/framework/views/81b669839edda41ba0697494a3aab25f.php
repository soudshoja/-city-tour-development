    ...
    <div class="mb-6 grid gap-6 xl:grid-cols-3">
        <div class="w-full md:w-96 md:max-w-full mx-auto">
            <div class="p-6 border border-gray-300 sm:rounded-md">
                <form method="POST" action="<?php echo e(route('companiesupload.import')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <label class="block mb-6">
                        <span class="text-gray-700">Upload Company Details</span>
                        <input
                            required
                            name="excel_file"
                            type="file"
...
<?php endif; ?>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/companies/companiesUpload.blade.php ENDPATH**/ ?>