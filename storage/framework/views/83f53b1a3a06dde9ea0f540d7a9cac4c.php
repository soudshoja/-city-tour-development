<fieldset <?php if($isReadOnly): ?> disabled <?php endif; ?>>
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 border border-gray-300 rounded-lg px-6 lg:px-10 py-12 bg-gray-50">
            ...
            <div class="flex flex-col xl:flex-row xl:justify-between xl:items-center mb-8 space-y-6 xl:space-y-0 xl:space-x-6">
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex-1">
                    ...
                    <input readonly type="number" step="0.001"
                           name="tasks[<?php echo e($loopIndex); ?>][original_invoice_price]"
                           value="<?php echo e(number_format($invoiceDetail->task_price, 3, '.', '')); ?>"
                ...
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex-1">
                    ...
                    <input readonly type="number" step="0.001"
                           name="tasks[<?php echo e($loopIndex); ?>][original_task_cost]"
                           value="<?php echo e(number_format($invoiceDetail->supplier_price, 3, '.', '')); ?>"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-50 font-medium text-gray-800">
                </div>
                ...
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex-1">
                    ...
                    <div class="px-3 py-2 bg-green-50 border border-green-200 rounded-lg text-green-700 font-semibold">
                        <?php echo e(number_format($invoiceDetail->markup_price, 3, '.', '')); ?>
            ...
            <div class="flex flex-col xl:flex-row xl:justify-between xl:items-center mb-6 space-y-6 xl:space-y-0 xl:space-x-6">
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex-1">
                    ...
                    <div class="px-3 py-2 bg-blue-50 border border-blue-200 rounded-lg text-blue-700 font-semibold">
                        <?php echo e(number_format($originalTaskTotal, 3, '.', '')); ?>
                ...
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex-1">
                    ...
                    <div class="px-3 py-2 bg-blue-50 border border-blue-200 rounded-lg text-blue-700 font-semibold">
                        <?php echo e(number_format($task->total, 3, '.', '')); ?>
                ...
                <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm flex-1">
                    ...
                    <div class="px-3 py-2 bg-red-50 border border-red-200 rounded-lg text-red-700 font-semibold" id="supplierChargeDisplay_<?php echo e($loopIndex); ?>">
                        <?php echo e(number_format($calculatedRefundCharge, 3, '.', '')); ?>

                    </div>
                    <input type="hidden" name="tasks[<?php echo e($loopIndex); ?>][supplier_charge]" id="supplierChargeInput_<?php echo e($loopIndex); ?>"
                           value="<?php echo e(number_format($calculatedRefundCharge, 3, '.', '')); ?>">
                </div>
            </div>
        </div>
        ...
        <div class="text-right bg-gray-50 rounded-2xl p-6 lg:p-10 min-w-0">
            ...
            <div class="text-2xl text-blue-600 font-bold mb-6" id="originalProfit_<?php echo e($loopIndex); ?>">
                <?php echo e(number_format($invoiceDetail->markup_price, 3, '.', '')); ?>
            ...
            <div class="text-2xl text-red-500 font-bold mb-6" id="supplierCharge_<?php echo e($loopIndex); ?>">
                <?php echo e(number_format($calculatedRefundCharge, 3, '.', '')); ?>
            ...
            <div class="text-2xl text-green-600 font-bold mb-6" id="newAgentMarkup_<?php echo e($loopIndex); ?>">0.00</div>
            <input type="hidden" name="tasks[<?php echo e($loopIndex); ?>][new_task_profit]" id="newAgentMarkupInput_<?php echo e($loopIndex); ?>" value="0.00">

            <hr class="my-6">

            <div class="font-bold text-gray-700 mb-2">Total Profit (Invoice Price)</div>
            <input type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][total_refund_to_client]" id="invoicePriceInput_<?php echo e($loopIndex); ?>"
                value="<?php echo e(old('invoice_price', $isEditing && $refundDetail ? number_format($refundDetail->total_refund_to_client, 3, '.', '')
            ...
            <input type="hidden" name="tasks[<?php echo e($loopIndex); ?>][original_task_profit]" value="<?php echo e($invoiceDetail->markup_price); ?>">
            <input type="hidden" name="tasks[<?php echo e($loopIndex); ?>][total_nett_refund_charge]" value="<?php echo e($calculatedRefundCharge); ?>">
            <input type="hidden" name="tasks[<?php echo e($loopIndex); ?>][refund_fee_to_client]" value="<?php echo e($invoiceDetail->markup_price + $calculatedRefundCharge); ?>">
        </div>
    </div>
</fieldset>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const originalTaskProfit = parseFloat(`<?php echo e($invoiceDetail->markup_price); ?>`);
...
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/refunds/partial/unpaid-invoice-section.blade.php ENDPATH**/ ?>