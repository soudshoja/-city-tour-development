    ...
    <div class="flex justify-between items-center gap-5 my-3 ">
        <div class="flex items-center gap-5 ">
            ...
            <div data-tooltip="Number of clients" class="relative w-12 h-12 flex items-center justify-center DarkBGcolor rounded-full shadow-sm">
                <span class="text-xl font-bold text-white"><?php echo e($clients->total()); ?></span>
            </div>
        </div>
        <div class="flex items-center gap-5">
            ...
            <a href="<?php echo e(route('users.create', ['openForm' => 'clientForm'])); ?>">
                ...
                <div class="dataTable-container h-max">
                    <table class="table-hover whitespace-nowrap dataTable-table">
                        ...
                        <tbody>
                            ...
                            <tr data-name="<?php echo e($client->full_name); ?>" data-email="<?php echo e($client->email); ?>" data-phone="<?php echo e($client->phone); ?>"
                                ...
                                <td><?php echo e($client->civil_no ?? 'N/A'); ?></td>
                                ...
                                <td><?php echo e($client->phone ? $client->phone : 'N/A'); ?></td>
                                <td>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/clients/index.blade.php ENDPATH**/ ?>