<fieldset <?php if($isReadOnly): ?> disabled <?php endif; ?>>
    <div class="border border-gray-300 rounded-lg px-10 py-12 bg-gray-50">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <input readonly type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][original_task_cost]" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50"
                    value="<?php echo e(number_format($invoiceDetail->task_price - $invoiceDetail->markup_price, 3, '.', '')); ?>">
            </div>
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <input readonly type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][original_task_profit]"
                        value="<?php echo e(number_format($invoiceDetail->markup_price, 3, '.', '')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <input readonly type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][original_invoice_price]"
                        value="<?php echo e(number_format($invoiceDetail->task_price, 3, '.', '')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][refund_fee_to_client]" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white"
                    value="<?php echo e(old('tasks.' . $loopIndex . '.refund_fee_to_client', ($isEditing && isset($refundDetail) && $refundDetail)
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <input readonly type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][supplier_charge]" 
                        value="<?php echo e(number_format($originalTaskCost - $task->total, 3, '.', '')); ?>" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <input type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][new_task_profit]" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white"
                        value="<?php echo e(old('tasks.' . $loopIndex . '.new_task_profit', $isEditing && $refundDetail 
            ...
            <div>
                ...
                <input readonly type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][refund_task_cost_price]" 
                       value="<?php echo e(number_format($task->total, 3, '.', '')); ?>" 
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <input readonly type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][new_profit_display]" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-50">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <input type="number" step="0.001" name="tasks[<?php echo e($loopIndex); ?>][total_refund_to_client]" class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white">
                </div>
            </div>
            <input type="hidden" name="tasks[<?php echo e($loopIndex); ?>][total_nett_refund_charge]" value="0" class="total-net-refund-charge">
        </div>
    </div>
</fieldset>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const loopIndex = <?php echo e($loopIndex); ?>;
        ...
        const originalTaskCost = <?php echo e($originalTaskCost ?? 0); ?>;
...
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/refunds/partial/paid-invoice-section.blade.php ENDPATH**/ ?>