...
<?php endif; ?>
                    ...
                    <div class="mb-6 w-full lg:w-1/2 lg:max-w-fit mt-5">
                        <div class="flex items-center gap-x-6">
                            ...
                            <input required readonly id="bankpaymentref"
                                value="<?php echo e(old('bankpaymentref', $bankPayment->reference_number)); ?>" type="text"
                                name="bankpaymentref"
                        ...
                        <div class="flex items-center gap-x-4 mt-4">
                            ...
                            <input value="<?php echo e(old('reference_type', $bankPayment->reference_type)); ?>" type="text"
                                readonly class="form-input w-2/3 lg:w-[250px] bg-gray-100 text-gray-800 border-gray-300"
                                value="<?php echo e($bankPayment->reference_type); ?>" />
                        </div>

                        <?php if($bankPayment->reference_type === 'Refund'): ?>
                            <div class="flex items-center gap-x-4 mt-4">
                                <label class="mb-0 flex-1 ltr:mr-2 rtl:ml-2">
                                    Refund Number
                                </label>
                                <input type="text" readonly
                                    ...
                                    value="<?php echo e(trim(\Illuminate\Support\Str::after($bankPayment->description, '|'))); ?>" />
                            </div>
                        <?php endif; ?>
                            ...
                            <select readonly id="branch_id" name="branch_id"
                                ...
                                <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($branch->id); ?>"
                                        <?php echo e(old('branch_id', $bankPayment->branch_id) == $branch->id ? 'selected' : ''); ?>>
                        ...
                        <div class="mt-4 flex items-center gap-x-6">
                            ...
                            <input readonly id="docdate" type="date" name="docdate"
                                class="form-input w-2/3  bg-gray-100 text-gray-800 border-gray-300"
                                value="<?php echo e(old('docdate', isset($bankPayment->transaction_date) ? \Carbon\Carbon::parse($bankPayment->transaction_date)->format('Y-m-d') : '')); ?>" />
                        ...
                        <div class="w-full lg:w-1/2">
                            ...
                            <div class="mt-4 flex items-center gap-x-4">
                                ...
                                <input readonly id="remarks_create" type="text" name="remarks_create" class="form-input flex-1" placeholder="Enter Remarks"
                                    value="<?php echo e(old('remarks_create', trim(\Illuminate\Support\Str::before($bankPayment->description, '|')))); ?>" />
                            </div>
                            ...
                            <!-- <div class="mt-4 flex items-center gap-x-4">
                                ...
                                <input readonly id="internal_remarks" type="text" name="internal_remarks"
                                    ...
                                    value="<?php echo e(old('internal_remarks', $bankPayment->remarks_internal)); ?>" />
                            </div>
                            ...
                            <div class="mt-4 flex items-center gap-x-4">
                                ...
                                <input readonly id="remarks_fl" type="text" name="remarks_fl"
                                    ...
                                    value="<?php echo e(old('remarks_fl', $bankPayment->remarks_fl)); ?>" />
                            </div> -->
                        </div>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="table table-bordered bank-payment-table mt-10 w-full">
                        ...
                        <tbody id="paymentTable">
                            <?php $__currentLoopData = $JournalEntrys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <?php echo e($transaction->account ? '[' . $transaction->account->root->name . '] [' . $transaction->account->code . '] ' . $transaction->account->name : 'N/A'); ?>

                                        <input readonly type="hidden" name="items[<?php echo e($index); ?>][account_id]" value="<?php echo e(old("items.$index.account_id", $transaction->account_id)); ?>" />
                                        <?php if($transaction->reconciled == 2): ?>
                                            <button type="button" class="btn btn-lightblue btn-sm p-10" onclick="fetchJournalEntries(<?php echo e($transaction->id); ?>)">
                                                View Reconciled Item
                                            </button>

                                            <button type="button" class="mt-1 btn btn-warning text-black btn-sm p-10" onclick="declineReconcileJournalEntries(<?php echo e($transaction->id); ?>)">
                                                Decline & Remove Reconcile
                                            </button>
                                        <?php endif; ?>
                                    </td>
                                    <!-- <td><input readonly type="text" name="items[<?php echo e($index); ?>][description]"
                                            value="<?php echo e(old("items.$index.description", $transaction->description)); ?>" />
                                    </td> -->
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][currency]"
                                            value="<?php echo e(old("items.$index.currency", $transaction->currency)); ?>" />
                                    </td>
                                    <td><input readonly type="text"
                                            name="items[<?php echo e($index); ?>][exchange_rate]"
                                            value="<?php echo e(old("items.$index.exchange_rate", $transaction->exchange_rate)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][amount]"
                                            value="<?php echo e(old("items.$index.amount", $transaction->amount)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][debit]"
                                            value="<?php echo e(old("items.$index.debit", $transaction->debit)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][credit]"
                                            value="<?php echo e(old("items.$index.credit", $transaction->credit)); ?>" />
                                    </td>
                                    <!-- <td><input readonly type="text" name="items[<?php echo e($index); ?>][cheque_no]"
                                            value="<?php echo e(old("items.$index.cheque_no", $transaction->cheque_no)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][cheque_date]"
                                            value="<?php echo e(old("items.$index.cheque_date", $transaction->cheque_date)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][bank_name]"
                                            value="<?php echo e(old("items.$index.bank_name", $transaction->bank_name)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][auth_no]"
                                            value="<?php echo e(old("items.$index.auth_no", $transaction->auth_no)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][branch_name]"
                                            value="<?php echo e(old("items.$index.branch_name", $transaction->branch_name)); ?>" />
                                    </td>
                                    <td><input readonly type="text" name="items[<?php echo e($index); ?>][balance]"
                                            value="<?php echo e(old("items.$index.balance", $transaction->balance)); ?>" />
                                    </td> -->
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                ...
                <div class="mt-6 flex justify-center w-full">
                    <a href="<?php echo e(route('bank-payments.index')); ?>"
...
<?php endif; ?>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/bank-payments/edit.blade.php ENDPATH**/ ?>