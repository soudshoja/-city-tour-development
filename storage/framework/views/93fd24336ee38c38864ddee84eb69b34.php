    ...
    <div class="flex justify-between items-center gap-5 my-3">
        <div class="flex items-center gap-5">
            ...
            <div data-tooltip="Number of roles"
                ...
                <span class="text-xl font-bold text-white"><?php echo e($roles->count()); ?></span>
            </div>
        </div>
        <div class="flex items-center gap-5">
                                ...
                                <tr class="text-sm font-semibold text-gray-600 text-center">
                                        ...
                                        <div class="flex flex-wrap gap-1 items-center justify-center">
                                            ...
                                            <?php if(count($role->permissions) > 3): ?>
                                                <button type="button" class="text-sky-600 hover:text-sky-800 text-xs font-medium ml-1" @click="openModal = true">
                                                    +<?php echo e(count($role->permissions) - 3); ?> more
                                                </button>
                                            <?php elseif(count($role->permissions) == 0): ?>
                                                    ...
                                                    <div class="bg-white rounded-xl shadow-xl w-full max-w-md" 
                                                        ...
                                                        <div class="p-4 border-b flex justify-between items-center">
                                                            <h2 class="text-lg font-semibold text-gray-800">
                                                                <?php echo e($role->name); ?> - Permissions (<?php echo e(count($role->permissions)); ?>)
                                                            </h2>
                                                            <button type="button" 
                                                        ...
                                                        <div class="p-4">
                                                            <input type="text" 
                                                                id="searchInput_<?php echo e($role->id); ?>" 
                                                                ...
                                                                onkeyup="filterPermissions(<?php echo e($role->id); ?>)">
                                                            <div id="permissionsContainer_<?php echo e($role->id); ?>" class="h-64 overflow-y-auto space-y-1">
                                    ...
                                    <td>
                                        <div class="flex items-center justify-center gap-1">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('update', App\Models\Role::class)): ?>
                                            <a href="<?php echo e(route('role.edit', ['roleId' => $role->id])); ?>" 
                                            ...
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete', App\Models\Role::class)): ?>
                                                    ...
                                                    <div x-show="showConfirm" x-cloak x-transition.opacity
                                                        ...
                                                        <div x-transition.scale @click.away="showConfirm = false" class="bg-white rounded-xl shadow-xl px-8 py-8 w-full max-w-sm text-center">
                                                            ...
                                                            <div class="flex justify-center gap-4">
                                                                ...
                                                                <form action="<?php echo e(route('role.destroy', ['roleId' => $role->id])); ?>" method="POST">
                                                                    <?php echo csrf_field(); ?> 
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/role/index.blade.php ENDPATH**/ ?>