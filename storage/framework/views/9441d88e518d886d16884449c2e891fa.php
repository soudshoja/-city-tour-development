...
<?php endif; ?>
                        <div class="pl-2">
                            ...
                            <p><?php echo nl2br(e($company->address)); ?></p>
                        ...
                        <div class="custom-select w-full border rounded-lg mt-4">
                            ...
                            <div
                                class="select-options hidden absolute left-0 top-full w-full rounded-md grid <?php echo e(count($branches) === 1 ? 'grid-cols-1' : 'grid-cols-2'); ?> gap-2 py-3">
                                ...
                                <div class="select-option px-4 py-3 text-center bg-white dark:bg-gray-700 rounded-lg dark:hover:bg-gray-800 border border-gray-300 cursor-pointer"
                                    data-value="<?php echo e($branch->id); ?>">
                    ...
                    <div class="space-y-1 text-gray-500 dark:text-gray-400">
                        ...
                        <div class="flex items-center">
                            ...
                            <input id="invoiceNumber" type="text" name="invoiceNumber" value="<?php echo e($invoiceNumber); ?>" class="w-full form-input" placeholder="Invoice Number" />
                            <input type="hidden" id="invoiceNumber" name="invoiceNumber" value="<?php echo e($invoiceNumber); ?>">
                            <input type="hidden" id="companyId" name="companyId" value="<?php echo e($companyId); ?>">
                        </div>

                        <form id="invoice-date-form" method="POST" action="<?php echo e(route('invoice.updateDate', ['companyId' => $companyId, 'invoiceNumber' => $invoiceNumber])); ?>">
                            <?php echo csrf_field(); ?>
                        ...
                        <div class="mt-4 flex items-center">
                            ...
                            <input id="duedate" type="date" name="duedate" class="w-full form-input"
                                value=<?php echo e($dueDate); ?> disabled />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="w-full">
                        <div class="flex items-center">
                            ...
                            <input id="agentId" type="hidden" name="agentId"
                                value="<?php echo e(is_string($agentId) || is_numeric($agentId) ? $agentId : ''); ?>" />
                        </div>
                        ...
                        <div class="mt-4 flex items-center">
                            ...
                            <input type="hidden" id="receiverName" name="receiverName" value="<?php echo e(request()->input('client_id')); ?>">
                        </div>
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-4 flex items-center">
                            <input id="agentName" type="text" name="agentName" class="form-input flex-1"
                                ...
                                value="<?php echo e(auth()->user()->role_id == \App\Models\Role::AGENT ? auth()->user()->agent->name : ''); ?>"
                                disabled />
                            <input type="hidden" id="agentName" name="agentName" value="<?php echo e(auth()->user()->role_id == \App\Models\Role::AGENT ? auth()->user()->agent->id : ''); ?>">
                        </div>
                        ...
                        <div class="mt-4 flex items-center">
                            <input id="agentEmail" type="email" name="agentEmail" class="form-input flex-1"
                                ...
                                value="<?php echo e(auth()->user()->role_id == \App\Models\Role::AGENT ? auth()->user()->agent->email : ''); ?>"
                                disabled />
                        </div>
                        ...
                        <div class="mt-4 flex items-center">
                            <input id="agentPhone" type="text" name="agentPhone" class="form-input flex-1"
                                ...
                                value="<?php echo e(auth()->user()->role_id == \App\Models\Role::AGENT ? auth()->user()->agent->phone_number : ''); ?>"
                                disabled />
                        </div>
                    </div>
                </div>
                ...
                <!-- choose items -->
                <div class="mt-8">
                    <form id="updateAmountForm" method="POST" action="<?php echo e(route('invoice.updateAmount', ['companyId' => $companyId, 'invoiceNumber' => $invoiceNumber])); ?>">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        ...
                        <?php if($invoice->status === 'paid' && ($invoice->payment_type === 'full' || $invoice->payment_type === 'cash')): ?>
                            ...
                            <div x-data="paymentSection()" x-init="initData()" class="mb-5">
                                ...
                                <div x-show="showModalType" x-cloak
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg p-6 w-[28rem] border border-gray-200 space-y-5">
                                        ...
                                        <form method="POST" action="<?php echo e(route('invoice.update-type')); ?>" class="flex justify-between items-center pt-3 w-full">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div x-show="showModalGateway" x-cloak
                                    ...
                                    <div class="bg-white rounded-lg shadow-lg p-6 w-[32rem] border border-gray-200 space-y-5">
                                        ...
                                        <div class="space-y-3">
                                            ...
                                            <?php $__currentLoopData = $unpaidPartial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $partial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <form method="POST" action="<?php echo e(route('invoice.update-partial-gateway')); ?>" class="border border-gray-200 rounded-md p-3 mb-3">
                                                    <?php echo csrf_field(); ?>
                                                    <input type="hidden" name="invoice_id" value="<?php echo e($invoice->id); ?>">
                                                    <input type="hidden" name="invoice_number" value="<?php echo e($invoice->invoice_number); ?>">
                                                    <input type="hidden" name="invoice_partial_id" value="<?php echo e($partial->id); ?>">

                                                    <div class="mb-2 flex justify-between items-center">
                                                        <strong class="text-gray-800"><?php echo e($invoice->invoice_number); ?></strong>
                                                    ...
                                                    <div class="mt-5 mb-5 flex justify-between">
                                                        ...
                                                        <span class="font-semibold"><?php echo e($invoice->currency); ?> <?php echo e(number_format($partial->amount, 2)); ?></span>
                                                    </div>
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <select 
                                                            name="gateway" 
                                                            id="gateway_<?php echo e($partial->id); ?>" 
                                                            class="border border-gray-300 rounded-md text-sm p-1.5 w-full"
                                                            onchange="toggleMethod(<?php echo e($partial->id); ?>)">
                                                            <?php $__currentLoopData = $paymentGateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($gateway->name); ?>" 
                                                                    <?php if($gateway->name == $partial->payment_gateway): echo 'selected'; endif; ?>>
                                                    ...
                                                    <div class="mb-4" id="method_section_<?php echo e($partial->id); ?>" style="display: none;">
                                                            ...
                                                            <?php $__currentLoopData = $paymentGateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <?php $__currentLoopData = $gateway->methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($method->id); ?>"
                                                                        <?php if($method->id == $partial->payment_method): echo 'selected'; endif; ?>>
                                ...
                                <input type="hidden" id="paymentTypeSaved" name="payment_type_saved"
                                    value="<?php echo e($invoice->payment_type); ?>">
                                ...
                                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-1">
                                    ...
                                    <div x-data="{ clientCreditModal: false, generateInvoiceWithCreditModal: false }">
                                        ...
                                        ?>
                                        <?php if($invoice->amount <= $balanceCredit): ?>
                                            ...
                                            <label class="rounded-full shadow transition-all duration-200 block"
                                                ...
                                                <button type="button" 
                                                    ...
                                                    <span class="font-medium"><?php echo e($selectedClient->first_name); ?>: KWD <?php echo e($balanceCredit); ?></span>
                                                </button>
                                            </label>
                                            ...
                                            <div id="clientCreditModal"
                                                ...
                                                <div class="bg-white rounded-lg p-6 shadow-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                                                    ...
                                                    <p class="text-gray-600 mb-2">Total Credit Balance: <strong><?php echo e($balanceCredit); ?> KWD</strong></p>
                                                    <p class="text-gray-600 mb-4">Invoice Amount: <strong><?php echo e($invoice->amount); ?> KWD</strong></p>
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <div id="availablePaymentsList" class="space-y-2 max-h-60 overflow-y-auto border rounded p-2">
                                                            <?php $__empty_1 = true; $__currentLoopData = $availablePayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $paymentData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                                <div class="flex items-center justify-between p-3 bg-gray-50 rounded hover:bg-gray-100">
                                                                    <label class="flex items-center flex-1 cursor-pointer">
                                                                        <input type="checkbox" 
                                                                            ...
                                                                            data-credit-id="<?php echo e($paymentData['credit_id']); ?>"
                                                                            data-available-balance="<?php echo e($paymentData['available_balance']); ?>"
                                                                            data-voucher="<?php echo e($paymentData['reference_number']); ?>"
                                                                            data-source-type="<?php echo e($paymentData['source_type']); ?>"
                                                                            data-refund-id="<?php echo e($paymentData['refund_id'] ?? ''); ?>"
                                                                            data-is-standalone="<?php echo e(($paymentData['is_standalone'] ?? false) ? 'true' : 'false'); ?>"
                                                                            onchange="updatePaymentSelection()">
                                                                        <div class="flex flex-col">
                                                                            <span class="font-medium text-gray-800"><?php echo e($paymentData['reference_number']); ?></span>

                                                                            <div class="flex items-center gap-2 mt-1">
                                                                                <?php if($paymentData['source_type'] === 'refund'): ?>
                                                                                ...
                                                                                <?php endif; ?>
                                                                                <span class="text-xs text-gray-500"><?php echo e($paymentData['date']->format('d M Y')); ?></span>
                                                                            </div>
                                                                        </div>
                                                                    </label>
                                                                    <div class="flex items-center gap-2">
                                                                        <span class="text-sm text-green-600"><?php echo e(number_format($paymentData['available_balance'], 3)); ?> KWD</span>
                                                                        <input type="number" 
                                                                            class="payment-amount-input w-24 px-2 py-1 border rounded text-sm"
                                                                            data-credit-id="<?php echo e($paymentData['credit_id']); ?>"
                                                                            data-max="<?php echo e($paymentData['available_balance']); ?>"
                                                                            ...
                                                                            step="0.001"
                                                                            min="0"
                                                                            max="<?php echo e($paymentData['available_balance']); ?>"
                                                                            disabled
                                                        ...
                                                        <?php if(count($availablePayments) > 0): ?>
                                                        ...
                                                        <div class="grid grid-cols-2 gap-4">
                                                            <div>
                                                                ...
                                                                <select id="splitGateway" class="w-full p-2 border border-gray-300 rounded">
                                                                    <?php $__currentLoopData = $paymentGateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($gateway->name); ?>" data-charge-id="<?php echo e($gateway->id); ?>"><?php echo e($gateway->name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                            <div id="splitMethodSection">
                                                                ...
                                                                <select id="splitMethod" class="w-full p-2 border border-gray-300 rounded">
                                                                    <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <option value="<?php echo e($method->id); ?>"><?php echo e($method->english_name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="bg-gray-100 rounded p-3 mb-4">
                                                        <div class="flex justify-between mb-1">
                                                            ...
                                                            <span id="creditModalInvoiceAmount"><?php echo e(number_format($invoice->amount, 3)); ?> KWD</span>
                                                        </div>
                                                        <div class="flex justify-between mb-1">
                                                        ...
                                                        <div class="flex justify-between border-t pt-1">
                                                            <span>Remaining:</span>
                                                            <span id="creditModalDifference" class="font-bold"><?php echo e(number_format($invoice->amount, 3)); ?> KWD</span>
                                                        </div>
                                        ...
                                        <?php else: ?>
                                            <?php if($creditUsed && $creditUsed->amount < 0): ?>
                                                <!-- Credit already used - no locking needed, just display -->
                                                <a target="_blank" href="<?php echo e(route('invoice.show', ['companyId' => $companyId, 'invoiceNumber' => $invoice->invoice_number])); ?>">
                                                    <button type="button"
                                                        class="rounded-full flex flex-col items-center justify-center w-full
                                                            px-4 py-2 border border-gray-300 
                                                            bg-green-500 text-white shadow-xl">
                                                        <span>Credit <?php echo e(number_format(abs($creditUsed->amount), 2) ?? 0); ?> KWD has been utilized.</span>
                                                        <span>Current balance of credit for <?php echo e($selectedClient->first_name); ?>: <?php echo e($balanceCredit); ?> KWD</span>
                                                    </button>
                                                </a>
                                            <?php else: ?>
                                                <?php if($balanceCredit > 0 && $invoice->payment_type == ''): ?>
                                            ...
                                            <div x-cloak x-show="generateInvoiceWithCreditModal"
                                                ...
                                                <div class="min-h-40 min-w-40 p-7 bg-white rounded shadow"
                                                    ...
                                                    <header class="text-lg font-semibold mb-4">
                                                        Would you
                                                        like to pay the invoice by using the <?php echo e($selectedClient->first_name); ?>'s
                                                        credit balance
                                                        (<?php echo e($balanceCredit); ?> KWD)?
                                                    </header>

                                                    <main>
                                                        <form action="<?php echo e(route('invoice.client-credit')); ?>" method="POST"
                                                                ...
                                                                <label
                                                                    ...
                                                                    <div class="flex items-center">
                                                                        ...
                                                                        <span class="text-gray-800 text-base">
                                                                            [Yes] Pay the
                                                                            remaining balance
                                                                            (<?php echo e(number_format($balanceCredit - $invoice->amount, 2)); ?>
                                                            ...
                                                            <div x-show="(option === 'generate_yes' || option === 'use_credit') && selectedGateway === 'MyFatoorah'" x-cloak class="mb-4">
                                                                ...
                                                                <select id="payment_method" name="payment_method"
                                                                    ...
                                                                    <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $methods): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($methods->id); ?>"><?php echo e($methods->english_name); ?></option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['xShow' => 'option !== \'\'','xCloak' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['x-show' => 'option !== \'\'','x-cloak' => true]); ?>Submit <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    ...
                                    <label class="rounded-full shadow transition-all duration-200"
                                        ...
                                        <input type="radio" id="payment_type_full" name="payment_type" value="full"
                                            ...
                                            <?php echo e($invoice->payment_type == 'full' ? 'checked' : ''); ?>
                                    ...
                                    <label class="rounded-full shadow transition-all duration-200"
                                        ...
                                        <input type="radio" id="payment_type_partial" name="payment_type" value="partial"
                                            ...
                                            <?php echo e($invoice->payment_type == 'partial' ? 'checked' : ''); ?>
                                    ...
                                    <label class="rounded-full shadow transition-all duration-200"
                                        ...
                                        <input type="radio" id="payment_type_split" name="payment_type" value="split"
                                            ...
                                            <?php echo e($invoice->payment_type == 'split' ? 'checked' : ''); ?>
                                    ...
                                    <label class="rounded-full shadow transition-all duration-200"
                                        ...
                                        <input type="radio" id="payment_type_cash" name="payment_type" value="cash" 
                                            hidden class="peer"
                                            <?php echo e($invoice->payment_type == 'cash' ? 'checked' : ''); ?>
                                ...
                                <!-- Modal -->
                                    <div id="importModal"
                                        ...
                                        <div class="bg-white rounded-lg p-6 w-full max-w-lg shadow-xl overflow-y-auto" style="max-height: 90vh;">
                                                ...
                                                <!-- Form -->
                                                <form id="importForm"
                                                    action="<?php echo e(route('payment.link.import.payment')); ?>"
                                                    method="POST"
                                                    class="space-y-4"
                                                    ...
                                                    <div x-show="source === 'gateway'" x-cloak>
                                                        ...
                                                        <select name="gateway" id="gateway" x-model="gateway"
                                                            ...
                                                            <?php $__currentLoopData = $can_import; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e(strtolower($gateway->name)); ?>"><?php echo e($gateway->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                        </select>
                                                        </div>
...
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'receipt','items' => $receiptVoucher
                                                                    ...
                                                                    ]),'placeholder' => 'Select Receipt Voucher'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('receipt') ?? ($selectedReceiptRef ?? null)),'x-model' => 'receipt']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <?php if($invoice->status !== 'paid'): ?>
                                    <!-- Payment Gateway Section -->
                                    <section id="payment_gateway_section" class="mb-6" x-data="{ paymentType: '<?php echo e($invoice->payment_type ?? ''); ?>' }" x-show="paymentType === '' || paymentType === 'full'" x-cloak>
                                        <?php
                                        ...
                                        <div id="payment_gateway_dropdowns">
                                            <div x-data="{ 
                                                selectedGateway: '<?php echo e($selectedGateway); ?>', 
                                                selectedMethod: '<?php echo e($selectedMethod); ?>', 
                                                paymentType: '<?php echo e($invoice->payment_type ?? ''); ?>',
                                                }">
                                                <div class="mt-4">
                                                    ...
                                                    <select id="payment_gateway_option" name="payment_gateway_option"
                                                        ...
                                                        <?php $__currentLoopData = $paymentGateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($gateway->name); ?>" <?php echo e($selectedGateway === $gateway->name ? 'selected' : ''); ?>>
                                                            <?php echo e($gateway->name); ?>
                                                ...
                                                <div
                                                    ...
                                                    <?php $__currentLoopData = $paymentGateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        ?>
                                                        <?php if($companyMethods->isNotEmpty()): ?>
                                                        <template x-if="selectedGateway.toLowerCase() === '<?php echo e(strtolower($gateway->name)); ?>'">
                                                            <div class="mt-4" x-cloak x-transition>
                                                                <label for="payment-method-<?php echo e(strtolower($gateway->name)); ?>" class="block text-sm font-medium text-gray-700">Payment Method</label>
                                                                <select name="payment_method" id="payment_method_full"
                                                                    ...
                                                                    <?php if($companyMethods->count() > 1): ?>
                                                                    <option value="">Select Payment Method</option>
                                                                    <?php endif; ?>
                                                                    <?php $__currentLoopData = $companyMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($method->id); ?>" <?php echo e($selectedMethod == $method->id ? 'selected' : ''); ?>>
                                                                        <?php echo e($method->english_name); ?>
                                                ...
                                                <input type="hidden" id="invoice_charge" name="invoice_charge" value="<?php echo e($invoice->invoice_charge); ?>">

                                                <!-- Invoice Charge Section (Initially Hidden) -->
                                                <?php if($invoiceCharges->count() > 0): ?>
                                                <div id="invoice_charge_section" class="mt-4" style="display: none;">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" id="invoice_charge_amount_input" name="invoice_charge_amount_input"
                                                            class="form-input" step="0.01" min="0" value="<?php echo e($invoice->invoice_charge); ?>"
                                                            placeholder="Enter charge amount">
                                                        <input type="hidden" id="invoice_charge_amount" name="invoice_charge_amount" value="<?php echo e($invoice->invoice_charge); ?>">
                                                    </div>
                                                </div>
                                                <?php endif; ?>
                                                ...
                                                <div class="mt-4" id="external_url_section" style="display: none;">
                                                    ...
                                                    <input type="url" id="external_url" name="external_url"
                                                        ...
                                                        value="<?php echo e($invoice->external_url ?? ''); ?>">
                                ...
                                <section id="additional-actions" class="mt-6">
                                    <div class="flex flex-wrap gap-4">
                                        ...
                                        <div class="flex items-center gap-2 w-full">
                                            <form id="whatsappForm" action="<?php echo e(route('resayil.share-invoice-link')); ?>"
                                                method="POST" onsubmit="showSpinner()">
                                                <?php echo csrf_field(); ?>
                                                <!-- Assuming you have a $client object or list -->
                                                <input type="hidden" name="client_id" id="clientid"
                                                    value="<?php echo e($client->id ?? ''); ?>">
                                                <input type="hidden" name="invoiceNumber" value="<?php echo e($invoiceNumber); ?>">
                                        ...
                                        <div class="my-2 flex items-center w-full">
                                            <a target="_blank" href="<?php echo e(route('invoice.proforma', ['companyId' => $companyId, 'invoiceNumber' => $invoiceNumber])); ?>"
                                        ...
                                        <a target="_blank" href="<?php echo e(route('invoice.show', ['companyId' => $companyId, 'invoiceNumber' => $invoiceNumber])); ?>"
                                            class="py-3 px-5 w-full inline-flex items-center justify-center text-sm text-white rounded-full gap-2 DarkBGcolor">
                                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <div id="sendEmailModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50 hidden">
                                            <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
                                                ...
                                                <form id="sendEmailForm" class="space-y-4">
                                                    ...
                                                    <div class="space-y-3">
                                                        <p class="text-sm text-gray-600">Select recipients for invoice <strong><?php echo e($invoiceNumber); ?></strong></p>
                                                        <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                                                            ...
                                                            <div class="ml-3">
                                                                ...
                                                                <span class="block text-sm text-gray-500"><?php echo e($selectedAgent->email ?? 'No email available'); ?></span>
                                                            </div>
                                                        </label>
                                                        <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
                                                            ...
                                                            <div class="ml-3">
                                                                ...
                                                                <span class="block text-sm text-gray-500"><?php echo e($selectedClient->email ?? 'No email available'); ?></span>
                                                            </div>
                                                        </label>
                                                        <div class="pt-2">
                                        ...
                                        <div id="partial-payment-container" class="space-y-5">
                                            <div class="grid grid-cols-3 gap-4 mb-5">
                                                ...
                                                <div>
                                                    ...
                                                    <span><?php echo e($balanceCredit); ?> KWD</span>
                                                </div>
                                            </div>
                                ...
                                <div class="bg-white border rounded-lg shadow-lg w-3/4 md:w-1/2 mb-10">
                                    ...
                                    <ul id="agentList"
                                        ...
                                        <li class="cursor-pointer flex items-center justify-between px-4 py-3 hover:bg-gray-100"
                                            onclick="chooseTasksAgent('<?php echo e($agent); ?>')">
    ...
    <script src="<?php echo e(asset('js/invoice-payment-selection.js')); ?>"></script>
    ...
    <script>
        ...
        const charges = <?php echo json_encode($paymentGateways, 15, 512) ?>;
        const invoiceCharges = <?php echo json_encode($invoiceCharges, 15, 512) ?>;
        const clients = <?php echo json_encode($clients, 15, 512) ?>;
        const partialCredit = Number(<?php echo json_encode(\App\Models\Credit::getTotalCreditsByClient($invoice->client_id), 15, 512) ?> || 0);
        let creditRemaining = partialCredit;
        const creditUsed = {};
        const invoiceAmount = parseFloat("<?php echo e($invoice->amount); ?>") || 0;
        let currentPaymentMode = 'full';
        const paymentMethods = Array.isArray(<?php echo json_encode($paymentMethods, 15, 512) ?>) ? <?php echo json_encode($paymentMethods, 15, 512) ?> : [];
        ...
        const isInvoicePaid = "<?php echo e($invoice->status === 'paid'); ?>"
        const hasPaymentType = "<?php echo e(!empty($invoice->payment_type)); ?>";
        ...
        let selectedTasks1 = <?php echo json_encode($selectedTasks, 15, 512) ?>;
        ...
        const invoiceExpireDefault = <?php echo json_encode($invoiceExpireDefault, 15, 512) ?>;
                        ...
                        <td class="border-b px-2 py-2">
                            <div class="min-w-[100px]">
                                <select id="payment_gateway_${i}" name="payment_gateway_${i}" class="w-full border border-gray-300 p-1 rounded text-sm">
                                    ...
                                    <?php $__currentLoopData = $invoiceGateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        function handleCreditPaymentSelectionPartial(rowIndex) {
            const clientId = <?php echo e($invoice->client_id); ?>;
            const amountInput = document.getElementById(`amount_${rowIndex}`);
            const amount = parseFloat(amountInput.value) || 0;
        ...
        window.invoicePartials = <?php echo json_encode($invoice->invoicePartials ?? [], 15, 512) ?>;
        ...
        function renderItems() {
            ...
            let count = 0;
            const isInvoicePaid = "<?php echo e($invoice->status === 'paid' && ($invoice->payment_type === 'full' || $invoice->payment_type === 'cash')); ?>";
        ...
        async function saveSingleTask(taskId) {
            ...
            try {
                const response = await fetch('<?php echo e(route("invoice.add-task")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
        ...
        async function removeTaskFromInvoice(taskId) {
            ...
            if (taskToRemove.saved) {
                ...
                try {
                    const response = await fetch('<?php echo e(route("invoice.remove-task")); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
        ...
        async function updateGateway() {
            ...
            const invoiceUrl = "<?php echo e(route('invoice.update-gateway')); ?>";
        ...
        async function save(type, item) {
            const invoiceUrl = "<?php echo e(route('invoice.partial')); ?>";
            const csrfToken = "<?php echo e(csrf_token()); ?>";
            const invoiceId = document.getElementById('invoiceId').value;
            const invoiceNumber = document.getElementById('invoiceNumber').value;
        ...
        function copyLink() {
            ...
            const companyId = document.getElementById('companyId').value;
            const fetchUrl = "<?php echo e(route('invoice.show', ['companyId' => ':companyId', 'invoiceNumber' => ':invoiceNumber'])); ?>".replace(':companyId', companyId).replace(':invoiceNumber', invoiceNumber);
        ...
        function setupPaymentTypesAndTasks() {
            ...
            let initialTasks = <?php echo json_encode($selectedTasks, 15, 512) ?>;
            ...
            if (form) {
               form.addEventListener('submit', async (e) => {
                ...
                if (source === 'gateway') {
                    ...
                    url = `<?php echo e(route('payment.link.import.invoice')); ?>`;
                    ...
                    url = `<?php echo e(route('receipt-voucher.import')); ?>`;
        ...
        function paymentSection() {
            return {
                ...
                paymentType: '<?php echo e($invoice->payment_type ?? ''); ?>',
                hasInvoicePartials: <?php echo e($invoice->invoicePartials->count() > 0 ? 'true' : 'false'); ?>,
                pendingPaymentType: null,
                paymentGateways: <?php echo \Illuminate\Support\Js::from($paymentGateways)->toHtml() ?>,
                allPaymentMethods: <?php echo \Illuminate\Support\Js::from($paymentMethods)->toHtml() ?>,
                invoicePartials: [],
        ...
        function setupSendEmailModal() {
            ...
            form.addEventListener('submit', async (e) => {
                ...
                const agentEmail = '<?php echo e($selectedAgent->email ?? ""); ?>';
                const clientEmail = '<?php echo e($selectedClient->email ?? ""); ?>';
                ...
                try {
                    ...
                    const invoiceNumber = '<?php echo e($invoiceNumber); ?>';
        ...
        async function applySelectedPayments() {
            ...
            const requestBody = {
                invoice_id: "<?php echo e($invoice->id); ?>",
                payment_allocations: paymentAllocations,
            ...
            try {
                const response = await fetch('<?php echo e(route("invoice.apply-payments")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/invoice/edit.blade.php ENDPATH**/ ?>