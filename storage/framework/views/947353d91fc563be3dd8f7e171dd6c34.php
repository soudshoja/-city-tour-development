        ...
        <div class="max-w-xl mx-auto">
            <div class="bg-white dark:bg-gray-900 p-6 shadow sm:rounded-lg">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                    <?php echo e(__('To change your password, please confirm your current password. A verification code will be sent to your email.')); ?>

                </p>

                <?php if(session('status') === 'code-sent'): ?>
                    <div class="mb-4 text-sm text-green-600 dark:text-green-400">
                        <?php echo e(__('Verification code sent successfully.')); ?>

                    </div>
                <?php endif; ?>

                <form method="POST" action="<?php echo e(route('profile.password.request-update')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'current_password','name' => 'current_password','type' => 'password','class' => 'mt-1 block w-full','required' => true,'autocomplete' => 'current-password','autofocus' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'current_password','name' => 'current_password','type' => 'password','class' => 'mt-1 block w-full','required' => true,'autocomplete' => 'current-password','autofocus' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/profile/password/request-password-update.blade.php ENDPATH**/ ?>