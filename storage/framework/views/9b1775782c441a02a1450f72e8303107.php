<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/refund.css']); ?>
<?php $__env->stopPush(); ?>
...
<?php $component->withAttributes([]); ?>
        ...
        <div class="main-tabs-bar">
            ...
            <button
                ...
                <div class="main-tab-content-wrapper">
                    ...
                    Task
                    <span class="main-tab-badge main-tab-badge-blue"><?php echo e($totalRefunds); ?></span>
                </div>
            </button>
        ...
        <div x-show="activeTab === 'task'" class="main-tab-content">
            <div class="main-section-header">
                <div>
                    ...
                    <p class="main-section-subtitle"><?php echo e($totalRefunds); ?> <?php echo e(Str::plural('task', $totalRefunds)); ?> that require refund</p>
                </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="main-table-th">
                                <a href="<?php echo e(getSortUrl('refund_number')); ?>" class="main-sort-link">
                                    Refund Number
                                    <span class="main-sort-icons">
                                        <svg class="main-sort-icon <?php echo e($currentSort === 'refund_number' && $currentDirection === 'asc' ? 'main-sort-icon-active' : ''); ?>" viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M12 5l8 10H4l8-10z" />
                                        </svg>
                                        <svg class="main-sort-icon main-sort-icon-down <?php echo e($currentSort === 'refund_number' && $currentDirection === 'desc' ? 'main-sort-icon-active' : ''); ?>" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <!-- Client - Sortable -->
                            <th class="main-table-th">
                                <a href="<?php echo e(getSortUrl('client_name')); ?>" class="main-sort-link">
                                    Client
                                    <span class="main-sort-icons">
                                        <svg class="main-sort-icon <?php echo e($currentSort === 'client_name' && $currentDirection === 'asc' ? 'main-sort-icon-active' : ''); ?>" viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M12 5l8 10H4l8-10z" />
                                        </svg>
                                        <svg class="main-sort-icon main-sort-icon-down <?php echo e($currentSort === 'client_name' && $currentDirection === 'desc' ? 'main-sort-icon-active' : ''); ?>" viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M12 19L4 9h16l-8 10z" />
                                        </svg>
                                    </span>
                                </a>
                            ...
                            <th class="main-table-th">
                                <a href="<?php echo e(getSortUrl('created_at')); ?>" class="main-sort-link">
                                    Registered Date
                                    <span class="main-sort-icons">
                                        <svg class="main-sort-icon <?php echo e($currentSort === 'created_at' && $currentDirection === 'asc' ? 'main-sort-icon-active' : ''); ?>" viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M12 5l8 10H4l8-10z" />
                                        </svg>
                                        <svg class="main-sort-icon main-sort-icon-down <?php echo e($currentSort === 'created_at' && $currentDirection === 'desc' ? 'main-sort-icon-active' : ''); ?>" viewBox="0 0 24 24" fill="currentColor">
                                            <path d="M12 19L4 9h16l-8 10z" />
                                        </svg>
                                    </span>
                                </a>
                    ...
                    <tbody>
                        ...
                        <tr class="main-table-row-static">
                            <td class="main-table-td">
                                <a href="<?php echo e(route('refunds.show', [$refund->company_id, $refund->refund_number])); ?>" target="_blank" class="main-table-td-link" data-tooltip="View Refund Statement"><?php echo e($refund->refund_number); ?></a>
                            </td>
                            <td class="main-table-td" style="max-width: 250px; white-space: normal; word-wrap: break-word;">
                                ...
                                ?>
                                <?php echo e(implode(', ', $uniqueClients)); ?>

                            </td>
                            <td class="main-table-td-right"><?php echo e(number_format($refund->total_nett_refund, 3)); ?> KWD</td>
                            <td class="main-table-td-center"><?php echo e($refund->remarks); ?></td>
                            <td class="main-table-td"><?php echo e($refund->created_at); ?></td>
                            <td class="main-table-td-center">
                                <span class="badge whitespace-nowrap px-2 py-1 rounded-full text-sm font-medium
                                    <?php echo e($refund->status === 'completed' ? 'badge-outline-success' : ''); ?>

                                    <?php echo e($refund->status === 'processed' ? 'badge-outline-assigned' : ''); ?>

                                    <?php echo e($refund->status === 'approved' ? 'badge-outline-success' : ''); ?>

                                    <?php echo e($refund->status === 'declined' ? 'badge-outline-danger' : ''); ?>

                                    <?php echo e($refund->status === 'pending' ? 'badge-outline-warning' : ''); ?>

                                    <?php echo e($refund->status === null ? 'badge-outline-danger' : ''); ?>">
                                    <?php echo e($refund->status === null ? 'Not Set' : ucwords($refund->status)); ?>

                                </span>
                            </td>
                            <td class="main-table-td-right">
                                <div class="main-action-icons">
                                    <?php if(!$refund->invoice && $refund->status !== 'completed'): ?>
                                        <button type="button" data-tooltip-left="Mark as Completed" onclick="confirmProcessCompleted(<?php echo e($refund->id); ?>)" class="main-action-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#2563eb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <polyline points="9 11 12 14 22 4"/>
                                                <path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"/>
                                            </svg>
                                        </button>
                                    <?php elseif($refund->invoice): ?>
                                        <a href="<?php echo e(route('invoice.show', ['companyId' => $refund->company_id, 'invoiceNumber' => $refund->invoice->invoice_number])); ?>" data-tooltip-left="View Invoice" class="main-action-icon">
                                    ...
                                    <a data-tooltip-left="Edit refund" href="<?php echo e(route('refunds.edit', [$refund->id])); ?>" class="main-action-icon">
    ...
    <script>
        ...
        async function fetchTasks() {
            ...
            try {
                const response = await fetch('<?php echo e(route("refunds.eligible-tasks")); ?>');
        ...
        function proceedToRefund() {
            ...
            window.location.href = `<?php echo e(route('refunds.create')); ?>?task_ids=${taskIds}`;
        }
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/refunds/index.blade.php ENDPATH**/ ?>