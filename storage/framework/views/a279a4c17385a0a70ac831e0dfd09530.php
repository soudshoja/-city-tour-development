...
<?php $component->withAttributes([]); ?>
    <div class="container mx-auto px-4">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden" x-data="{
            ...
            sendPaymentReceipt: <?php echo json_encode($sendPaymentReceipt, 15, 512) ?>,
            toggleUploadForm() {
            ...
            <div x-show="addClientModal" x-cloak
                ...
                <div class="bg-white rounded-lg p-6 w-full max-w-lg shadow-xl overflow-y-auto"
                    ...
                    <form action="<?php echo e(route('clients.store')); ?>" method="POST" id="client-formTask"
                        class="space-y-4">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if (isset($component)) { $__componentOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $attributes; } ?>
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'agent_id','items' => $agents->map(fn($a) => ['id' => $a->id, 'name' => $a->name]),'placeholder' => 'Select an Agent','label' => 'Agent'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                            ...
                            <input type="text" name="agent_id" id="agent_id"
                                value="<?php echo e(auth()->user()->agent->name); ?>"
            ...
            <div x-show="importFatoorahModal" x-cloak
                ...
                <div class="bg-white rounded-lg p-6 w-full max-w-lg shadow-xl overflow-y-auto" style="max-height: 90vh;">
                    ...
                    <form action="<?php echo e(route('payment.link.import.payment')); ?>" method="POST" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <div x-data="{ gateway: '' }">
                            <div>
            ...
            <!-- Form Body -->
            <form action="<?php echo e(route('payment.link.store')); ?>" method="POST" class="pl-6 pr-6 pt-4 pb-4 space-y-5"
                ...
                <?php if($prefill): ?>
                <input type="hidden" name="payment_gateway" value="<?php echo e($prefill['payment_gateway']); ?>">
                <input type="hidden" name="payment_method" value="<?php echo e($prefill['payment_method']); ?>">
                <input type="hidden" name="amount" value="<?php echo e($prefill['amount']); ?>">
                <input type="hidden" name="client_id" value="<?php echo e($prefill['client_id']); ?>">
                <input type="hidden" name="agent_id" value="<?php echo e($prefill['agent_id']); ?>">
                <input type="hidden" name="notes" value="<?php echo e($prefill['notes']); ?>">
                <?php endif; ?>
                <input type="hidden" name="payment_id" value="<?php echo e(old('payment_id', $prefill['payment_id'] ?? '')); ?>">
                <input type="hidden" name="invoice_id" value="<?php echo e(old('invoice_id', $prefill['invoice_id'] ?? '')); ?>">
                <input type="hidden" name="source" value="<?php echo e(old('source', $prefill['source'] ?? '')); ?>">
                <input type="hidden" name="invoice_reference" value="<?php echo e(old('invoice_reference', $prefill['invoice_reference'] ?? '')); ?>">
                <input type="hidden" name="auth_code" value="<?php echo e(old('auth_code', $prefill['auth_code'] ?? '')); ?>">
                <input type="hidden" name="payment_reference" value="<?php echo e(old('payment_reference', $prefill['payment_reference'] ?? '')); ?>">
                <input type="hidden" name="track_id" value="<?php echo e(old('track_id', $prefill['track_id'] ?? '')); ?>">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <?php if (isset($component)) { $__componentOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $attributes; } ?>
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'client_id','items' => $clients->map(fn($c) => [
                                'id' => $c->id,
                                'name' => $c->full_name . ' - ' . $c->phone
                            ]),'placeholder' => ''.e($clientPlaceholder).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\SearchableDropdown::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'client_id','selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedId),'selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedName),'class' => 'block w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8)): ?>
<?php $attributes = $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8; ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <?php if (isset($component)) { $__componentOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $attributes; } ?>
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'agent_id','items' => $agents->map(fn($c) => ['id' => $c->id, 'name' => $c->name]),'placeholder' => ''.e($agentPlaceholder).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\SearchableDropdown::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'agent_id','selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedId),'selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedName),'class' => 'block w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8)): ?>
<?php $attributes = $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8; ?>
...
<?php endif; ?>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex">
                                <input
                                    ...
                                    value="<?php echo e($chose->paymentMethod->id); ?>"
                                    id="payment_method_<?php echo e($chose->paymentMethod->id); ?>"
                                    <?php echo e(in_array($chose->paymentMethod->id, old('payment_methods', [])) || (strtolower($chose->paymentMethod->charge->name) == 'myfatoorah' && strtolower($chose->paymentMethod->english_name) == 'knet') ? 'checked' : ''); ?>

                                    class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                <label for="payment_method_<?php echo e($chose->paymentMethod->id); ?>" class="ml-2 text-sm text-gray-700">
                ...
                <div x-show="!advancedMode" class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="currency" id="currency"
                            ...
                            <option value="<?php echo e($currency->iso_code); ?>"
                                <?php echo e(old('currency', $currency->country?->name === 'Kuwait' ? $currency->iso_code : '') == $currency->iso_code ? 'selected' : ''); ?>>
                        ...
                        <div x-data="termsConditionManager()" x-init="init()">
                            ...
                            <div class="mb-3">
                                ...
                                <p x-show="filteredTemplates.length === 0 && !loadingTemplates" class="text-xs text-amber-600 mt-2">
                                    ...
                                    <a href="<?php echo e(route('settings.index')); ?>" class="underline hover:text-amber-700">Create one in Settings</a>
                                </p>
                ...
                <div class="flex items-center justify-between pt-4">
                    <a href="<?php echo e(route('payment.link.index')); ?>">
                        <button type="button"
    ...
    <script>
        function termsConditionManager() {
            return {
                ...
                selectedTemplateId: '',
                content: '<?php echo e(old("terms_conditions")); ?>',
                originalContent: '',
                isEdited: false,
                wordCount: 0,
                maxWords: 2000,
                ...
                async loadTemplates() {
                    ...
                    try {
                        const response = await fetch('<?php echo e(route("terms.templates.index")); ?>', {
                            headers: {
        ...
        function paymentItemsManager() {
            return {
                items: [],
                defaultCurrency: '<?php echo e($currencies->firstWhere("country.name", "Kuwait")->iso_code ?? "KWD"); ?>',
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/payment/link/create.blade.php ENDPATH**/ ?>