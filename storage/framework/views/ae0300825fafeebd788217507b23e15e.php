                ...
                <div class="mb-6 flex items-center">
                    <div class="w-full justify-between flex items-center rounded-full bg-black/25 p-2 font-semibold text-white pr-3"
                        ...
                        <div class="flex items-center">
                            ...
                            <img src="<?php echo e($companyLogo); ?>" alt="Company Logo" class="h-10 w-auto pl-4 pr-4">
                    
                            <h3 class="px-2"><?php echo e($user->name); ?></h3>
                        </div>
                        <div>
            ...
            <div class="bg-white p-5 grid grid-cols-6 gap-3" x-data="{
                ...
                <div class="rounded-lg p-4 space-y-2" role="tablist" aria-orientation="vertical">
                    ...
                    <button type="button" role="tab"
                        :aria-selected="tab === '<?php echo e($t['value']); ?>' ? 'true' : 'false'"
                        tabindex="<?php echo e($loop->first ? '0' : '-1'); ?>" @click="switchTab('<?php echo e($t['value']); ?>')"
                        class="flex items-center space-x-3 px-4 py-3 rounded-lg transition-all w-full text-left
                            ...
                            "
                        :class="{ 'text-primary bg-gray-200 font-semibold': tab === '<?php echo e($t['value']); ?>' }">
                        <?php switch($t['icon']):
                        case ('user'): ?>
                        ...
                        <?php break; ?>
                        <?php endswitch; ?>
                        <span class="text-sm"><?php echo e($t['label']); ?></span>
                    </button>
                ...
                <div class="col-span-5">
                    ...
                    <div x-show="tab === 'Security'" x-cloak>
                        <?php echo $__env->make('profile.password.update-password-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div x-show="tab === 'Iata'" x-cloak>
                        <?php echo $__env->make('profile.partials.iata-settings-form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>

                    <div x-show="tab === 'Commission'" x-cloak>
                        <p class="text-gray-700 text-sm"><?php echo $__env->make('profile.partials.commission-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></p>
                    </div>

                    <?php if($hasBonus): ?> 
                        <div x-show="tab === 'Bonus'" x-cloak>
                            <p class="text-gray-700 text-sm"><?php echo $__env->make('profile.partials.bonus-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?></p>
                        </div>
                    <?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/profile/edit.blade.php ENDPATH**/ ?>