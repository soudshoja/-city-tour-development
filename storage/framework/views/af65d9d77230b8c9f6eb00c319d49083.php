                ...
                <div class="overflow-x-auto bg-white shadow rounded-lg">
                    <table id="payablesTable" class="min-w-full table-auto border-collapse">
                        ...
                        <tbody id="payablesBody" class="text-gray-800">
                            <?php $__currentLoopData = $groupedJournalEntrys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $taskName => $ledgers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $ledgers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $JournalEntry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="general-ledger-row hover:bg-gray-50 text-xs">
                                <td class="px-4 py-3 border-b"><?php echo e($JournalEntry['invoice_number']); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($JournalEntry['transaction_date']); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($JournalEntry['description']); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($JournalEntry['branch_name']); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($JournalEntry['agent_name']); ?></td>
                                <td class="px-4 py-3 border-b"><?php echo e($JournalEntry['JournalEntry_name']); ?></td>
                                <td class="px-4 py-3 border-b text-right"><?php echo e($JournalEntry['debit']); ?></td>
                                <td class="px-4 py-3 border-b text-right"><?php echo e($JournalEntry['credit']); ?></td>
                            </tr>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/accounting/index.blade.php ENDPATH**/ ?>