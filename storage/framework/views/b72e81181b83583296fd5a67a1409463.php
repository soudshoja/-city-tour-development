...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex flex-col" :class=""
        x-data="{
            selectedTaskId: <?php echo e($tasks->first()->id); ?>,
            tasks: <?php echo e($tasks->toJson()); ?>,
            ...
            init() {
                ...
                if (mode === 'bulk' && <?php echo e($tasks->count()); ?> > 1) {
            ...
            getInvoiceUrl() {
                return `<?php echo e(route('invoices.create')); ?>?task_ids=` + this.selectedForInvoice.join(',');
            },

            async loadTasks(page = 1) {
                this.loadingTasks = true;
                try {
                    const response = await fetch(`<?php echo e(route('tasks.get-tasks')); ?>?page=${page}&q=${encodeURIComponent(this.taskSearch)}`);
            ...
            addSelectedTasks() {
                ...
                const currentTaskIds = <?php echo e($tasks->pluck('id')->toJson()); ?>;
                const allTaskIds = [...currentTaskIds, ...this.selectedNewTasks];
                const uniqueTaskIds = [...new Set(allTaskIds)];

                window.location.href = `<?php echo e(route('tasks.detail')); ?>?tasks=${uniqueTaskIds.join(',')}`;
            },
        ...
        <div class="lg:hidden flex items-center justify-between mb-4">
            ...
            <button
                ...
                <span class="bg-blue-100 text-blue-700 text-xs font-bold px-2 py-0.5 rounded-full"><?php echo e($tasks->count()); ?></span>
            </button>
        </div>
        ...
        <div class="flex-1 pb-16 xl:pb-0">
            <div class="flex justify-between items-start">
                <ul class="flex space-x-2 rtl:space-x-reverse pb-5 text-sm sm:text-base">
                    <li>
                        <a href="<?php echo e(route('tasks.index')); ?>" class="text-gray-500 hover:text-gray-700 transition whitespace-nowrap">
                            Tasks List
                        </a>
                    </li>
                ...
                <div
                    ...
                    <div class="bg-white shadow-sm border border-gray-200 flex flex-col w-full h-screen">
                        ...
                        <div class="px-4 py-3 flex-shrink-0">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wider">Selected <?php echo e(Str::plural('Task', $tasks->count())); ?> </h3>
                                    <span class="bg-blue-100 text-blue-700 text-xs font-bold px-2 py-1 rounded-full"><?php echo e($tasks->count()); ?></span>
                                </div>
                        ...
                        <div class="flex-1 overflow-y-auto min-h-0 hover-scrollbar">
                            ...
                            <div
                                @click="selectedTaskId = <?php echo e($task->id); ?>; bulkEditMode = false; showSidebar = false"
                                :class="selectedTaskId === <?php echo e($task->id); ?> && !bulkEditMode ? 'bg-blue-50 border-l-4 border-blue-500' : 'bg-white hover:bg-gray-50 border-l-4 border-transparent'"
                                ...
                                <div class="px-4 py-3">
                                    ...
                                    <div class="flex justify-between items-start">
                                        <div class="flex items-start gap-2 flex-1">
                                            ...
                                            <div class="pt-0.5" @click.stop>
                                                <input
                                                    type="checkbox"
                                                    class="w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 <?php echo e($canInvoice ? 'cursor-pointer' : 'cursor-not-allowed opacity-50'); ?>"
                                                    :checked="selectedForInvoice.includes(<?php echo e($task->id); ?>)"
                                                    @change="toggleInvoiceSelection(<?php echo e($task->id); ?>, <?php echo e($canInvoice ? 'true' : 'false'); ?>)"
                                                    <?php echo e($canInvoice ? '' : 'disabled'); ?>>
                                            </div>
                                            <div class="flex-1 min-w-0">
                                                <div class="flex items-center gap-2 flex-wrap">
                                                    <p class="text-sm font-medium text-gray-900"><?php echo e($task->reference); ?></p>
                                                    <?php if($task->invoiceDetail): ?>
                                                        <?php if($task->invoiceDetail->invoice && $task->invoiceDetail->invoice->status == 'paid'): ?>
                                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-red-100 text-red-800" title="Cannot be edited - Invoice is paid">
                                                            ...
                                                            Paid: <?php echo e($task->invoiceDetail->invoice->invoice_number ?? $task->invoiceDetail->invoice_number); ?>
                                                        ...
                                                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-orange-100 text-orange-800" title="Already invoiced - Changes won't affect invoice">
                                                            ...
                                                            Unpaid: <?php echo e($task->invoiceDetail->invoice->invoice_number ?? $task->invoiceDetail->invoice_number); ?>

                                                        </span>
                                                        <?php endif; ?>
                                                    <?php endif; ?>
                                                </div>
                                                <p class="text-xs text-gray-500 mt-1 uppercase"><?php echo e($task->client->name ?? $task->client_name ?? 'No Client'); ?></p>
                                            </div>
                                            ...
                                            <div class="relative flex items-center justify-center group flex-shrink-0">
                                                <span class="relative flex h-2.5 w-2.5">
                                                    <span class="absolute inline-flex h-full w-full rounded-full <?php echo e($glowColor); ?> animate-ping"></span>
                                                    <span class="relative inline-flex rounded-full h-2.5 w-2.5 <?php echo e($dotColor); ?>"></span>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-2 pl-6">
                                        <p class="text-sm font-semibold text-gray-700">
                                            <?php echo e($task->currency ?? 'KWD'); ?> <?php echo e(number_format($task->total, 3)); ?>
                ...
                <div class="flex-1 flex-col xl:flex-row gap-4 min-w-0 items-start">
                    <div class="flex flex-col xl:flex-row gap-4 pb-32 xl:pb-0">
                        ...
                        <div class="flex flex-col min-w-0 w-full h-full">
                            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div x-cloak x-show="selectedTaskId === <?php echo e($task->id); ?>" class="flex flex-col gap-4">
                                ...
                                <div class="bg-gradient-to-r from-slate-800 to-slate-700 rounded-lg shadow-sm p-4 sm:p-6 flex-shrink-0">
                                    <div class="flex items-start justify-between">
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="text-lg sm:text-xl font-semibold text-white truncate"><?php echo e($task->reference); ?></p>
                                            <p class="text-sm text-gray-400 mt-1 truncate"><?php echo e($task->ticket_number); ?></p>
                                        </div>

                                        <button
                                            @click="startSingleEdit({
                                                id: <?php echo e($task->id); ?>,
                                                type: <?php echo \Illuminate\Support\Js::from($task->type)->toHtml() ?>,
                                                reference: <?php echo \Illuminate\Support\Js::from($task->reference)->toHtml() ?>,
                                                status: <?php echo \Illuminate\Support\Js::from($task->status)->toHtml() ?>,
                                                client_id: <?php echo \Illuminate\Support\Js::from($task->client_id)->toHtml() ?>,
                                                client_name: <?php echo \Illuminate\Support\Js::from($task->client ? $task->client->name . ' - ' . $task->client->phone : null)->toHtml() ?>,
                                                agent_id: <?php echo \Illuminate\Support\Js::from($task->agent_id)->toHtml() ?>,
                                                agent_name: <?php echo \Illuminate\Support\Js::from($task->agent->name ?? null)->toHtml() ?>,
                                                supplier_id: <?php echo \Illuminate\Support\Js::from($task->supplier_id)->toHtml() ?>,
                                                payment_method_account_id: <?php echo \Illuminate\Support\Js::from($task->payment_method_account_id)->toHtml() ?>,
                                                supplier_pay_date: <?php echo \Illuminate\Support\Js::from($task->supplier_pay_date ? \Carbon\Carbon::parse($task->supplier_pay_date)->format('Y-m-d') : '')->toHtml() ?>,
                                                price: <?php echo \Illuminate\Support\Js::from(number_format($task->price ?? 0, 3, '.', ''))->toHtml() ?>,
                                                tax: <?php echo \Illuminate\Support\Js::from(number_format($task->tax ?? 0, 3, '.', ''))->toHtml() ?>,
                                                surcharge: <?php echo \Illuminate\Support\Js::from(number_format($task->surcharge ?? 0, 3, '.', ''))->toHtml() ?>,
                                                supplier_surcharge: <?php echo \Illuminate\Support\Js::from(number_format($task->supplier_surcharge ?? 0, 3, '.', ''))->toHtml() ?>,
                                                original_task_id: <?php echo \Illuminate\Support\Js::from($task->original_task_id)->toHtml() ?>,
                                                original_task_name: <?php echo \Illuminate\Support\Js::from($task->original_task_id)->toHtml() ?>,
                                                <?php if($task->type === 'hotel' && $task->hotelDetails): ?>
                                                hotelDetails: {
                                                    hotel_id: <?php echo \Illuminate\Support\Js::from($task->hotelDetails->hotel_id)->toHtml() ?>,
                                                    hotel_name: <?php echo \Illuminate\Support\Js::from($task->hotelDetails->hotel->name ?? 'N/A')->toHtml() ?>,
                                                    room_type: <?php echo \Illuminate\Support\Js::from($task->hotelDetails->room_type)->toHtml() ?>,
                                                    check_in: <?php echo \Illuminate\Support\Js::from($task->hotelDetails->check_in)->toHtml() ?>,
                                                    check_out: <?php echo \Illuminate\Support\Js::from($task->hotelDetails->check_out)->toHtml() ?>,
                                                    room_number: <?php echo \Illuminate\Support\Js::from($task->hotelDetails->room_number)->toHtml() ?>,
                                                    meal_type: <?php echo \Illuminate\Support\Js::from($task->hotelDetails->meal_type)->toHtml() ?>,
                                                },
                                                <?php elseif($task->type === 'insurance' && $task->insuranceDetails): ?>
                                                insuranceDetails: {
                                                    insurance_type: <?php echo \Illuminate\Support\Js::from($task->insuranceDetails->insurance_type)->toHtml() ?>,
                                                    plan_type: <?php echo \Illuminate\Support\Js::from($task->insuranceDetails->plan_type)->toHtml() ?>,
                                                    destination: <?php echo \Illuminate\Support\Js::from($task->insuranceDetails->destination)->toHtml() ?>,
                                                    duration: <?php echo \Illuminate\Support\Js::from($task->insuranceDetails->duration)->toHtml() ?>,
                                                    package: <?php echo \Illuminate\Support\Js::from($task->insuranceDetails->package)->toHtml() ?>,
                                                },
                                                <?php elseif($task->type === 'visa' && $task->visaDetails): ?>
                                                visaDetails: {
                                                    visa_type: <?php echo \Illuminate\Support\Js::from($task->visaDetails->visa_type)->toHtml() ?>,
                                                    application_number: <?php echo \Illuminate\Support\Js::from($task->visaDetails->application_number)->toHtml() ?>,
                                                    issuing_country: <?php echo \Illuminate\Support\Js::from($task->visaDetails->issuing_country)->toHtml() ?>,
                                                    expiry_date: <?php echo \Illuminate\Support\Js::from($task->visaDetails->expiry_date)->toHtml() ?>,
                                                    number_of_entries: <?php echo \Illuminate\Support\Js::from($task->visaDetails->number_of_entries)->toHtml() ?>,
                                                    stay_duration: <?php echo \Illuminate\Support\Js::from($task->visaDetails->stay_duration)->toHtml() ?>,
                                                },
                                                <?php elseif($task->type === 'flight' && $task->flightDetail->isNotEmpty()): ?>
                                                flightDetails: <?php echo \Illuminate\Support\Js::from($task->flightDetail->map(function($flight) {
                                                    return [
                                                        'id' => $flight->id,
                                        ...
                                        <div class="p-4 sm:p-6 flex flex-col flex-1">
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 sm:gap-x-8 gap-y-4 sm:gap-y-5">
                                                <div>
                                                    ...
                                                    <?php if($task->client): ?>
                                                    <p class="text-sm text-gray-900"><?php echo e($task->client->full_name); ?></p>
                                                    <?php else: ?>
                                                    <button
                                                        type="button"
                                                        @click="openManualForm(<?php echo e($task->id); ?>, '<?php echo e($task->client_name ?? ''); ?>', '<?php echo e($task->passenger_name ?? ''); ?>', '<?php echo e($task->agent->name ?? 'Not Set'); ?>', '<?php echo e($task->agent->id ?? 'Null'); ?>', '<?php echo e($task->agent->branch->name ?? 'Not Set'); ?>')"
                                                        class="no-client text-sm font-medium capitalize">
                                                        <?php echo e(ucwords(strtolower($task->client_name)) ?: 'Not Set - Click to Register'); ?>
                                                ...
                                                <div>
                                                    ...
                                                    ?>
                                                    <p class="text-sm text-gray-900"><?php echo e($formattedPhone); ?></p>
                                                    <?php else: ?>
                                                ...
                                                <div>
                                                    ...
                                                    <?php if($task->agent): ?>
                                                    <p class="text-sm text-gray-900 capitalize"><?php echo e($task->agent->name); ?></p>
                                                    <?php else: ?>
                                                ...
                                                <div>
                                                    ...
                                                    <?php if($task->agent?->branch?->name): ?>
                                                    <p class="text-sm text-gray-900 capitalize"><?php echo e($task->agent->branch->name); ?></p>
                                                    <?php else: ?>
                                                    <p class="text-sm text-gray-500 italic">Not Available</p>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-900 capitalize"><?php echo e($task->supplier->name ?? ''); ?></p>
                                                </div>

                                                <div>
                                                    <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Status</p>
                                                    <span class="inline-flex items-center px-3 py-1 text-xs font-medium rounded-full
                                                    <?php if($task->status === 'issued'): ?> bg-green-100 text-green-700
                                                    <?php elseif($task->status === 'confirmed'): ?> bg-blue-100 text-blue-700
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-900"><?php echo e($task->supplier_pay_date ?? ''); ?></p>
                                                </div>

                                                <div>
                                                    <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Created At</p>
                                                    <p class="text-sm text-gray-900"><?php echo e($task->created_at ?? ''); ?></p>
                                                </div>

                                                <?php if($task->payment_method_account_id && $task->paymentMethod): ?>
                                                <div>
                                                    <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Payment Method</p>
                                                    <p class="text-sm text-gray-900"><?php echo e($task->paymentMethod->name); ?></p>
                                                </div>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="mt-auto pt-6 sm:pt-8">
                                                <div class="space-y-3">
                                                    <div class="flex justify-between items-center">
                                                        ...
                                                        <p class="text-sm text-gray-900"><?php echo e($task->currency ?? 'KWD'); ?> <?php echo e(number_format($task->price, 3)); ?></p>
                                                    </div>
                                                    <div class="flex justify-between items-center pl-4">
                                                        <p class="text-sm text-gray-500">Tax:</p>
                                                        <p class="text-sm text-gray-700"><?php echo e($task->currency ?? 'KWD'); ?> <?php echo e(number_format($task->tax, 3)); ?></p>
                                                    </div>
                                                </div>
                                                <div class="mt-4 pt-4 border-t border-gray-200">
                                                    <div class="flex justify-between items-center">
                                                        <p class="text-sm font-semibold text-gray-700">Total:</p>
                                                        <p class="text-sm font-semibold text-gray-900"><?php echo e($task->currency ?? 'KWD'); ?> <?php echo e(number_format($task->total, 3)); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="xl:col-span-3 bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col">
                                        <div class="px-4 sm:px-6 py-4 bg-slate-50 rounded-t-lg flex-shrink-0">
                                            <h2 class="text-sm font-semibold text-gray-700 uppercase tracking-wider">
                                                <?php echo e(ucfirst($task->type)); ?> Details
                                            </h2>
                                        </div>
                                        <div class="flex-1 overflow-auto">
                                            ...
                                            <div class="p-4 sm:p-6">
                                                ...
                                                <div class="block sm:hidden space-y-4">
                                                    <?php $__empty_1 = true; $__currentLoopData = $task->flightDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $flight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <div class="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                                        <div class="flex items-center justify-between mb-3">
                                                            <span class="bg-blue-100 text-blue-700 text-xs font-bold px-2 py-1 rounded-full">
                                                                Flight <?php echo e($loop->iteration); ?>

                                                            </span>
                                                            <?php if($flight->class_type): ?>
                                                            <span class="bg-blue-100 text-blue-700 text-xs font-medium px-2 py-0.5 rounded-full">
                                                                <?php echo e(ucfirst($flight->class_type)); ?>
                                                        ...
                                                        <div class="flex items-center gap-3 mb-3">
                                                            <div class="flex-1">
                                                                ...
                                                                <p class="text-sm font-medium text-gray-900"><?php echo e($flight->airport_from ?? 'N/A'); ?></p>
                                                                <p class="text-xs text-gray-500">
                                                                    <?php echo e($flight->departure_time ? \Carbon\Carbon::parse($flight->departure_time)->format('d M, H:i') : '-'); ?>
                                                            ...
                                                            <div class="flex-1 text-right">
                                                                ...
                                                                <p class="text-sm font-medium text-gray-900"><?php echo e($flight->airport_to ?? 'N/A'); ?></p>
                                                                <p class="text-xs text-gray-500">
                                                                    <?php echo e($flight->arrival_time ? \Carbon\Carbon::parse($flight->arrival_time)->format('d M, H:i') : '-'); ?>
                                                        ...
                                                        <div class="flex flex-wrap gap-3 text-xs text-gray-600 pt-2 border-t border-gray-200">
                                                            <div>
                                                                ...
                                                                <span class="font-medium"><?php echo e($flight->airline_id ?? 'N/A'); ?> <?php echo e($flight->flight_number ?? ''); ?></span>
                                                            </div>
                                                            <?php if($hasDuration && $flight->duration_time): ?>
                                                            <div>
                                                                <span class="text-gray-400">Duration:</span>
                                                                <span class="font-medium"><?php echo e($flight->duration_time); ?></span>
                                                            </div>
                                                            <?php endif; ?>
                                                            <?php if($hasBaggage && $flight->baggage_allowed): ?>
                                                            <div>
                                                                <span class="text-gray-400">Baggage:</span>
                                                                <span class="font-medium"><?php echo e($flight->baggage_allowed); ?></span>
                                                            </div>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="hidden sm:block overflow-x-auto">
                                                    <table class="min-w-full divide-y divide-gray-200">
                                                        ...
                                                        <tbody class="bg-white divide-y divide-gray-200">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    ...
                                                                    <p class="text-xs text-gray-500 mt-1">
                                                                        <?php echo e($flight->departure_time ? \Carbon\Carbon::parse($flight->departure_time)->format('d M Y, H:i') : '-'); ?>
                                                                ...
                                                                <td class="px-4 py-3">
                                                                    <p class="text-sm font-medium text-gray-900"><?php echo e($flight->airport_to ?? 'N/A'); ?></p>
                                                                    <p class="text-xs text-gray-500 mt-1">
                                                                        <?php echo e($flight->arrival_time ? \Carbon\Carbon::parse($flight->arrival_time)->format('d M Y, H:i') : '-'); ?>

                                                                    </p>
                                                                </td>
                                                                <td class="px-4 py-3">
                                                                    <p class="text-sm font-medium text-gray-900"><?php echo e($flight->airline ? $flight->airline->name : "N/A"); ?></p>
                                                                    <p class="text-xs text-gray-500"><?php echo e($flight->flight_number ?? ''); ?></p>
                                                                </td>
                                                                <?php if($hasDuration): ?>
                                                                <td class="px-4 py-3 text-sm text-gray-500"><?php echo e($flight->duration_time ?? '-'); ?></td>
                                                                <?php endif; ?>
                                                                <td class="px-4 py-3">
                                                                    <?php if($flight->class_type): ?>
                                                                ...
                                                                <?php if($hasBaggage): ?>
                                                                <td class="px-4 py-3">
                                                                    <?php if($flight->baggage_allowed): ?>
                                                                    <span class="px-2 py-0.5 text-xs font-medium">
                                                                        <?php echo e($flight->baggage_allowed); ?>
                                                            ...
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                            <tr>
                                                                <td colspan="<?php echo e(4 + ($hasDuration ? 1 : 0) + ($hasBaggage ? 1 : 0)); ?>" class="px-4 py-3 text-sm text-gray-500 text-center italic">
                                                                    No flight details available
                                                                </td>
                                                            </tr>
                                                            <?php endif; ?>
                                            ...
                                            <div class="p-4 sm:p-6">
                                                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                                                    <div class="sm:col-span-3">
                                                        ...
                                                        <p class="text-sm font-medium text-gray-900"><?php echo e($task->hotelDetails->hotel->name ?? 'N/A'); ?></p>
                                                    </div>

                                                    <?php if($task->hotelDetails->hotel): ?>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Address</p>
                                                        <p class="text-sm font-medium text-gray-900"><?php echo e($task->hotelDetails->hotel->address ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">City</p>
                                                        <p class="text-sm font-medium text-gray-900"><?php echo e($task->hotelDetails->hotel->city ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Country</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->hotelDetails->hotel->country ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Phone</p>
                                                        <p class="text-sm font-medium text-gray-900"><?php echo e($task->hotelDetails->hotel->phone ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Zip Code</p>
                                                        <p class="text-sm font-medium text-gray-900"><?php echo e($task->hotelDetails->hotel->zip_code ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Email</p>
                                                        <p class="text-sm font-medium text-gray-900"><?php echo e($task->hotelDetails->hotel->email ?? 'N/A'); ?></p>
                                                    </div>
                                                    <?php endif; ?>

                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Room Type</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->hotelDetails->room_type ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Room Number</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->hotelDetails->room_number ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Meal Type</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->hotelDetails->meal_type ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Check In</p>
                                                        <p class="text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($task->hotelDetails->check_in)->format('D, d M Y')); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Check Out</p>
                                                        <p class="text-sm text-gray-900"><?php echo e(\Carbon\Carbon::parse($task->hotelDetails->check_out)->format('D, d M Y')); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Duration</p>
                                                        <p class="text-sm text-gray-900 font-semibold"><?php echo e(\Carbon\Carbon::parse($task->hotelDetails->check_in)->diffInDays($task->hotelDetails->check_out)); ?> Nights</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-4 sm:p-6">
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-900"><?php echo e($task->visaDetails->visa_type ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Application Number</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->visaDetails->application_number ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Issuing Country</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->visaDetails->issuing_country ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Expiry Date</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->visaDetails->expiry_date ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Number of Entries</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->visaDetails->number_of_entries ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Stay Duration</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->visaDetails->stay_duration ?? 'N/A'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="p-4 sm:p-6">
                                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-gray-900"><?php echo e($task->insuranceDetails->insurance_type ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Plan Type</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->insuranceDetails->plan_type ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Destination</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->insuranceDetails->destination ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div>
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Duration</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->insuranceDetails->duration ?? 'N/A'); ?></p>
                                                    </div>
                                                    <div class="sm:col-span-2">
                                                        <p class="text-xs font-medium text-gray-400 uppercase tracking-wider mb-1">Package</p>
                                                        <p class="text-sm text-gray-900"><?php echo e($task->insuranceDetails->package ?? 'N/A'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php else: ?>
                                            ...
                                            showAdditional: false 
                                                ...
                                                <!-- Cancellation Policy -->
                                                <?php if($task->cancellation_policy): ?>
                                                <div>
                                                    ...
                                                    <div x-cloak x-show="showCancellation"
                                                        ...
                                                        <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                                                            ...
                                                            <div class="space-y-2">
                                                                <?php $__currentLoopData = $decoded; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="flex justify-between items-center py-2 border-b border-red-100 last:border-0">
                                                                    <span class="text-sm font-medium text-gray-700 capitalize">
                                                                        <?php echo e($item['type'] ?? 'Policy'); ?>

                                                                    </span>
                                                                    <span class="text-sm font-semibold text-red-600">
                                                                        <?php if(isset($item['charge'])): ?>
                                                                        <?php echo e(number_format($item['charge'], 3)); ?> KWD
                                                                        <?php elseif(isset($item['percentage'])): ?>
                                                            ...
                                                            <?php else: ?>
                                                            <p class="text-sm text-gray-700 whitespace-pre-line"><?php echo e($task->cancellation_policy); ?></p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <?php if($task->additional_info || $task->venue): ?>
                                                <div>
                                                    ...
                                                    <div x-cloak x-show="showAdditional"
                                                        ...
                                                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2">
                                                            <?php if($task->additional_info): ?>
                                                            <div>
                                                                <p class="text-xs font-medium text-gray-500 uppercase mb-1">Notes</p>
                                                                <p class="text-sm text-gray-700 whitespace-pre-line"><?php echo e($task->additional_info); ?></p>
                                                            </div>
                                                            <?php endif; ?>
                                                            <?php if($task->venue): ?>
                                                            <div>
                                                                <p class="text-xs font-medium text-gray-500 uppercase mb-1">Venue</p>
                                                                <p class="text-sm text-gray-700"><?php echo e($task->venue); ?></p>
                                                            </div>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                            ...
                            <div x-cloak x-show="singleEditMode && editDraft.task_id === <?php echo e($task->id); ?>"
                                class="fixed inset-0 z-50 overflow-y-auto"
                                style="display: none;"
                                @dropdown-select.window="
                                    if (editDraft.task_id === <?php echo e($task->id); ?>) {
                                ...
                                <div class="flex min-h-screen items-center justify-center p-2 sm:p-4">
                                    ...
                                    <div x-show="singleEditMode"
                                        x-data="{ readOnly: <?php echo e($isInvoicedAndPaid ? 'true' : 'false'); ?> }"
                                        class="relative bg-white rounded-lg shadow-xl w-full max-w-7xl overflow-hidden"
                                        @click.stop>

                                        <form action="<?php echo e(route('tasks.update', $task->id)); ?>" method="POST" class="flex flex-col" style="max-height: 90vh;">
                                            <?php echo csrf_field(); ?>
                                                ...
                                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                                    ...
                                                    <fieldset :disabled="readOnly" :class="readOnly ? 'opacity-80' : ''">
                                                        <div class="flex flex-col gap-4 sm:gap-6">
                                                            ...
                                                            <?php if(!in_array(strtolower((string) $task->status), ['issued', 'confirmed'], true)): ?>
                                                            <div class="flex flex-col sm:flex-row gap-4">
                                                                <div class="flex-1 min-w-0">
                                                                    <?php
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ajax-searchable-dropdown','data' => ['name' => 'original_task_id','selectedId' => $task->original_task_id,'selectedName' => $selectedOriginalTask
                                                                            ? $selectedOriginalTask->reference . ' - ' . ($selectedOriginalTask->client->full_name ?? $selectedOriginalTask->client_name)
                                                                            : null,'dataId' => $task->id,'ajaxUrl' => route('tasks.search-original-tasks'),'placeholder' => 'Search and select original task']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'original_task_id','selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->original_task_id),'selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($selectedOriginalTask
                                                                            ? $selectedOriginalTask->reference . ' - ' . ($selectedOriginalTask->client->full_name ?? $selectedOriginalTask->client_name)
                                                                            : null),'dataId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->id),'ajaxUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tasks.search-original-tasks')),'placeholder' => 'Search and select original task']); ?>
...
<?php endif; ?>
                                                            ...
                                                            <div class="flex flex-col sm:flex-row gap-4">
                                                                <div class="flex-1">
                                                                    ...
                                                                    <input type="text"
                                                                        ...
                                                                        value="<?php echo e($task->supplier->name ?? ''); ?>"
                                                                        readonly>
                                                                    <input type="hidden" name="supplier_id" value="<?php echo e($task->supplier->id ?? ''); ?>">
                                                                </div>
                                                                ...
                                                                <div class="flex-1">
                                                                    ...
                                                                    <input type="text"
                                                                        class="border border-gray-300 p-2 rounded-md w-full bg-gray-200"
                                                                        value="<?php echo e(ucfirst($task->type)); ?>"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <!-- Client & Agent -->
                                                            <div class="flex flex-col sm:flex-row gap-4">
                                                                <div class="flex-1 min-w-0 <?php echo e($task->client ?? 'required-input'); ?>">
...
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'client_id','items' => $clients->map(fn($c) => ['id' => $c->id, 'name' => $c->full_name . ' - ' . $c->phone]),'maxResults' => 50,'placeholder' => 'Select Client'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->client_id),'selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->client ? $task->client->full_name . ' - ' . $task->client->phone : null)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                                                ...
                                                                <div class="flex-1 min-w-0 <?php echo e($task->agent ?? 'required-input'); ?>">
                                                                    <label class="block text-sm font-medium text-gray-700">Agent</label>
                                                                    <?php if (isset($component)) { $__componentOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $attributes; } ?>
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'agent_id','items' => $agents->map(fn($a) => ['id' => $a->id, 'name' => $a->name]),'placeholder' => 'Select Agent'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\SearchableDropdown::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->agent_id),'selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($task->agent->name ?? null)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8)): ?>
<?php $attributes = $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8; ?>
...
<?php endif; ?>
                                                            ...
                                                            <div class="flex flex-col sm:flex-row gap-4">
                                                                <div class="flex-1">
                                                                    ...
                                                                    <select name="payment_method_account_id"
                                                                        ...
                                                                        <?php $__currentLoopData = $listOfCreditors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $accounts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <optgroup label="<?php echo e($groupName); ?>">
                                                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div>
                                                                ...
                                                                <textarea rows="3"
                                                                    readonly
                                                                    class="border border-gray-300 p-3 rounded-md bg-gray-200 w-full resize-none text-sm"><?php echo e($task->additional_info); ?> - <?php echo e($task->venue); ?></textarea>
                                                            </div>
                                                        </div>
                                                    </fieldset>
                                                    ...
                                                    <div class="border-l border-gray-200 pl-6">
                                                        <h3 class="text-lg font-semibold text-gray-800 mb-4"><?php echo e(ucfirst($task->type)); ?> Details</h3>

                                                        <?php if($task->type === 'hotel' && $task->hotelDetails): ?>
                                                        <?php echo $__env->make('tasks.partial.hotel-details-form', ['task' => $task, 'hotels' => $hotels], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php elseif($task->type === 'flight' && $task->flightDetail->isNotEmpty()): ?>
                                                        <?php echo $__env->make('tasks.partial.flight-details-form', ['task' => $task], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php elseif($task->type === 'insurance' && $task->insuranceDetails): ?>
                                                        <?php echo $__env->make('tasks.partial.insurance-details-form', ['task' => $task], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php elseif($task->type === 'visa' && $task->visaDetails): ?>
                                                        <?php echo $__env->make('tasks.partial.visa-details-form', ['task' => $task], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div x-cloak x-show="previewOpen" class="grid grid-cols-1 w-full xl:max-w-72 bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden sticky top-4 self-start overflow-y-auto">
                            ...
                            <div class="p-4 border-t bg-slate-50 space-y-2">
                                <form action="<?php echo e(route('tasks.updateMulti')); ?>" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('PUT'); ?>
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                            <div>
                                ...
                                <p class="text-sm text-blue-600 mt-1">
                                    ...
                                    out of
                                    <span class="font-semibold"><?php echo e($tasks->count()); ?></span>
                                    tasks
                                </p>
                            </div>
        ...
        <div x-cloak x-show="bulkEditMode"
            ...
            <div class="flex min-h-screen items-center justify-center p-2 sm:p-4">
                <div x-show="bulkEditMode"
                    ...
                    <form action="<?php echo e(route('tasks.bulk-update')); ?>" method="POST" class="flex flex-col" style="max-height: 90vh;">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="px-4 sm:px-6 py-4 bg-slate-50 border-b border-gray-200 flex items-start justify-between flex-shrink-0">
                            <div class="flex-1 min-w-0 pr-2">
                                ...
                                <p class="text-gray-600 italic text-xs mt-1">Changes will apply to all <?php echo e($tasks->count()); ?> selected tasks</p>
                            </div>
                        ...
                        <div class="p-4 sm:p-6 overflow-y-auto flex-1">
                            <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <input type="hidden" name="task_ids[]" value="<?php echo e($task->id); ?>">
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="space-y-5">
                                <div>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $attributes; } ?>
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'bulk_client_id','items' => $clients->map(fn($c) => ['id' => $c->id, 'name' => $c->full_name . ' - ' . $c->phone]),'placeholder' => 'Select Client'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $attributes; } ?>
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'bulk_agent_id','items' => $agents->map(fn($a) => ['id' => $a->id, 'name' => $a->name]),'placeholder' => 'Select Agent'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <select name="bulk_payment_method_id" class="border border-gray-300 p-2 rounded-md w-full text-sm">
                                        ...
                                        <optgroup label="<?php echo e($groupName); ?>">
                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($method['id']); ?>" <?php echo e($task->payment_method_account_id == $method['id'] ? 'selected' : ''); ?>>
                                                <?php echo e($method['name']); ?>
...
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'dial_code','items' => \App\Models\Country::all()->map(
                                ...
                                ),'placeholder' => ' Search Dial Code'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\App\View\Components\SearchableDropdown::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['showAllOnOpen' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8)): ?>
<?php $attributes = $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8; ?>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <?php if (isset($component)) { $__componentOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald32d6e5ccefff34d2bfa91c7f668faf8 = $attributes; } ?>
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'agent_id','items' => $agents,'placeholder' => 'Search Agent'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?>
    ...
    <script>
        ...
        function processFileWithAI() {
            ...
            fetch("<?php echo e(route('tasks.upload.passport')); ?>", {
                    method: "POST",
                    body: formData,
                    headers: {
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/tasks/detail.blade.php ENDPATH**/ ?>