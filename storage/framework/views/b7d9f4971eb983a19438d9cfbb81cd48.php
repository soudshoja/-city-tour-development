        ...
        <div class="d-flex">
            ...
            <table id="newTestTable" class="w-full border-collapse">
                    ...
                    <tbody>
                        ...
                        <tr class="border-t">
                            <td class="p-2"><?php echo e($version['id']); ?></td>
                            <td class="p-2"><?php echo e($version['version']); ?></td>
                            <td class="p-2"><?php echo e($version['descriptions']); ?></td>
                            <td class="p-2"><?php echo e($version['sha']); ?></td>
                            <td class="p-2"><?php echo e($version['updated_at']); ?></td>
                            <td class="p-2">
                                <a href="#" class="text-blue-500 text-xs" onclick="openModalWithData(event, '<?php echo e($version['id']); ?>', '<?php echo e($version['version']); ?>', '<?php echo e($version['descriptions']); ?>', '<?php echo e($version['sha']); ?>')">
...
>
    ...
    <div x-show="openModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            <form :action="id ? '/version/update/' + id : '<?php echo e(route('version.store')); ?>'" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <div x-show="openUpdateModal" class="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
        <div class="bg-white p-6 rounded-md w-96">
            ...
            <form action="<?php echo e(route('version.current')); ?>" method="POST">
                <?php echo csrf_field(); ?>
    ...
    <script>
     let versions = <?php echo json_encode($versions, 15, 512) ?>;
     ...
     async function fetchAllVersions() {
        ...
        async function updateVersionDisplay(data) {
                try {
                    const response = await fetch("<?php echo e(route('version.getCurrent')); ?>");
        ...
        async function autoAddVersion(version, sha, description) {
                const versionStoreUrl = "<?php echo e(route('version.store')); ?>"; 
        ...
        async function updateMasterVersion(newVersion) {
                const masterUpdateUrl = "<?php echo e(route('version.updateMaster')); ?>"; 
                const csrfToken = "<?php echo e(csrf_token()); ?>";
...
</html><?php /**PATH /home/soudshoja/soud-laravel/resources/views/version/index.blade.php ENDPATH**/ ?>