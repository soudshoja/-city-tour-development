...
<?php $component->withAttributes([]); ?>
    ...
    <div id="prebook-list" class="bg-white rounded-md shadow-md p-2 grid gap-2">
        <?php $__currentLoopData = $tboPreBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prebook): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="p-2 border-b group hover:bg-gray-100 cursor-pointer">
            <a href="<?php echo e(route('suppliers.tbo.prebook.show', ['tboId' => $prebook->id])); ?>" class="inline-flex justify-between w-full">
                <p><?php echo e($prebook->booking_code); ?></p>
                <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="group-hover:fill-blue-500">
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/suppliers/tbo/book/prebook-index.blade.php ENDPATH**/ ?>