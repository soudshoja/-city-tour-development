...
<?php echo app('Illuminate\Foundation\Vite')(['resources/css/task/index.css']); ?>
<?php $__env->stopPush(); ?>
    ...
    <div class="flex justify-between items-center gap-5 my-3 ">
        <div class="flex items-center gap-5 ">
            ...
            <div data-tooltip="number of tasks"
                ...
                <span class="text-xl font-bold text-white"><?php echo e($taskCount); ?></span>
            </div>
        </div>
            ...
            <div x-data="{ addTaskModal: false, manualFormWide: false }" class="flex items-center gap-5">
                ...
                <div x-cloak x-show="addTaskModal" x-init="$watch('addTaskModal', value => {
                    ...
                    <div @click.away="addTaskModal = false; manualFormWide = false" class="bg-white rounded shadow min-w-96"
                        ...
                        <hr>
                        <form id="agent-supplier-task" action="<?php echo e(route('tasks.agent.upload')); ?>"
...
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'supplier_id','items' => $suppliers->map(fn($s) => ['id' => $s->id, 'name' => $s->name]),'placeholder' => 'Select Supplier','label' => 'Select a Supplier'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            ...
                            <div class="flex-1 min-h-0" :class="manualFormWide ? 'overflow-y-auto max-h-[calc(90vh-224px)]' : 'overflow-visible max-h-none'">
                                ...
                                <select id="select-supplier-task" class="hidden">
                                    ...
                                    <option value="<?php echo e($supplier->id); ?>" data-supplier='<?php echo e(json_encode($supplier)); ?>'>
                                        <?php echo e($supplier->name); ?>

                                    </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <template id="template-hotel-dropdown">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ajax-searchable-dropdown','data' => ['name' => 'hotel_id','dataId' => '','ajaxUrl' => ''.e(route('hotel.ajax.search')).'','placeholder' => 'Select Hotel']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'hotel_id','dataId' => '','ajaxUrl' => ''.e(route('hotel.ajax.search')).'','placeholder' => 'Select Hotel']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                ...
                                <template id="template-client-dropdown">
                                    <?php if (isset($component)) { $__componentOriginal155d1ae1bb3c51973152675834ada9b4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal155d1ae1bb3c51973152675834ada9b4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ajax-searchable-dropdown','data' => ['name' => 'client_id','dataId' => '','ajaxUrl' => ''.e(route('clients.ajax.search')).'','placeholder' => 'Select Client']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ajax-searchable-dropdown'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'client_id','dataId' => '','ajaxUrl' => ''.e(route('clients.ajax.search')).'','placeholder' => 'Select Client']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal155d1ae1bb3c51973152675834ada9b4)): ?>
<?php $attributes = $__attributesOriginal155d1ae1bb3c51973152675834ada9b4; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['type' => 'submit','form' => 'agent-supplier-task','class' => 'rounded-full shadow-md px-6 py-2 text-white bg-black hover:bg-gray-800 transition']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','form' => 'agent-supplier-task','class' => 'rounded-full shadow-md px-6 py-2 text-white bg-black hover:bg-gray-800 transition']); ?>
                                Submit
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['action' => route('tasks.index'),'searchParam' => 'q','placeholder' => 'Quick search for tasks']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tasks.index')),'searchParam' => 'q','placeholder' => 'Quick search for tasks']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <label class="flex items-center gap-2 cursor-pointer select-none">
                <input type="checkbox" id="showVoidCheckbox"
                    class="sr-only peer"
                    <?php echo e(request('show_void') == '1' ? 'checked' : ''); ?>

                    onchange="window.location='<?php echo e(request()->fullUrlWithQuery(['show_void' => '1'])); ?>'; if(!this.checked) window.location='<?php echo e(request()->fullUrlWithQuery(['show_void' => null])); ?>';">
            ...
            <div class="relative">
                ...
                <div id="columnDropdownContent"
                    ...
                    <div class="space-y-2">
                        ...
                        <?php if(Auth()->user()->role_id == \App\Models\Role::ADMIN || Auth()->user()->role_id == \App\Models\Role::COMPANY): ?>
                        <div class="flex items-center gap-2">
        ...
        <div class="dataTable-wrapper">
            <div class="w-full flex m-2 ">
                ...
                ?>
                <form method="GET" action="<?php echo e(route('tasks.index')); ?>" class="flex gap-0 w-full">
                    <?php $__currentLoopData = request()->except(['invoiced', 'page', 'view_type']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <button type="submit" name="invoiced" value="0"
                        class="w-full text-center py-1 rounded-l-lg font-bold text-lg transition
                            <?php echo e($invoiced == '0' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-blue-100'); ?>">
                        Un Invoiced
                    </button>
                    <button type="submit" name="invoiced" value="1"
                        class="w-full text-center py-1 rounded-r-lg font-bold text-lg transition
                            <?php echo e($invoiced == '1' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700 hover:bg-blue-100'); ?>">
                        Invoiced
                    </button>
                </form>
            </div>
                ...
                <div class="dataTable-wrapper">
                    <div class="dataTable-container h-max">
                        <div x-data="{
                            ...
                            selectedTasks: [],
                            canEditTasks: false,
                            originalInvoiceRoute: '<?php echo e(route('invoices.create')); ?>',
                            ...
                            submitBulkEdit() {
                                ...
                                fetch('<?php echo e(route('tasks.bulkUpdate')); ?>', {
                                    method: 'POST',
                                    headers: {
                            ...
                            <table class="table-hover whitespace-nowrap dataTable-table">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('viewPrice', 'App\Models\Task')): ?>
                                        ...
                                        <th data-column="supplier-pay-date" class="column-hidden">
                                            <a href="<?php echo e(request()->fullUrlWithQuery([
                                                ...
                                                Issued Date
                                                <?php if(request('sortBy') !== 'supplier_pay_date'): ?>
                                ...
                                <tbody id="myTableBody">
                                    ...
                                    <tr class="taskRow task-row cursor-pointer"
                                        @click="toggleTaskSelection(<?php echo e($task->id); ?>)"
                                        x-show="<?php echo e($key); ?> < shown" x-cloak
                                        :class="selectedTasks.includes(<?php echo e($task->id); ?>) ? 'selected' : ''"
                                        data-agent-id="<?php echo e($task->agent_id); ?>"
                                        data-status="<?php echo e($task->status); ?>"
                                        data-task-id="<?php echo e($task->id); ?>"
                                        data-task-reference="<?php echo e($task->reference); ?>"
                                        data-enabled="<?php echo e($task->enabled ? 'true' : 'false'); ?>"
                                        data-invoice-detail="<?php echo e($task->invoiceDetail ? 'true' : 'false'); ?>"
                                        data-invoice-status="<?php echo e($task->invoiceDetail?->invoice?->status ?? ''); ?>"
                                        data-refund-detail="<?php echo e($task->refundDetail ? 'true' : 'false'); ?>"
                                        data-is-complete="<?php echo e($task->is_complete ? 'true' : 'false'); ?>"
                                        data-has-original-task="<?php echo e($task->originalTask ? 'true' : 'false'); ?>"
                                        data-original-task-invoiced="<?php echo e($task->originalTask && $task->originalTask->invoiceDetail ? 'true' : 'false'); ?>">
                                            ...
                                            <div class="flex items-center justify-center h-full min-h-[40px]">
                                                ...
                                                <div class="relative group cursor-default">
                                                    ...
                                                    <div class="absolute top-1/2 left-full -translate-y-1/2 w-[200px] text-xs bg-black text-white rounded px-3 py-2 z-20 hidden group-hover:block text-left whitespace-normal shadow-lg">
                                                        <?php echo e($tooltipText ?: 'Cannot select this task'); ?>
                                                ...
                                                <div class="flex items-center justify-center h-full mr-2">
                                                    <label class="switch m-0" @click.stop
                                                        data-tooltip="<?php echo e($isInvoicedAndPaid ? 'This task is invoiced and paid — enabling/disabling is not allowed.' : 'Toggle task availability'); ?>">
                                                        <input type="checkbox"
                                                            class="toggle-task-status"
                                                            data-task-id="<?php echo e($task->id); ?>"
                                                            <?php echo e($task->enabled ? 'checked' : ''); ?>

                                                            <?php echo e($isInvoicedAndPaid ? 'disabled' : ''); ?>>
                                                        <span class="slider round <?php echo e($isInvoicedAndPaid ? 'opacity-50 cursor-not-allowed' : ''); ?>"></span>
                                                    </label>
                                                </div>
                                                    ...
                                                    <template x-teleport="body">
                                                        <div x-show="open" @click.away="open = false" x-anchor.bottom-start.offset.5="$refs.button"
                                                            ...
                                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                                                                <?php if($isInvoicedAndPaid == false): ?>
                                                                <li>
                                                                    <a href="<?php echo e(route('tasks.detail', ['tasks' => $task->id])); ?>" target="_blank"
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0);"
                                                                        class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800"
                                                                        @click.prevent="$dispatch('view-task', { id: <?php echo e($task->id); ?> }); open = false;">
                                                                        <svg class="w-4 h-4 mr-2 text-blue-800" fill="currentColor" viewBox="0 0 24 24">
                                                                            <path d="M12 4c-4.182 0-7.028 2.5-8.725 4.704C2.425 9.81 2 10.361 2 12s.425 2.191 1.275 3.296C4.972 17.5 7.818 20 12 20s7.028-2.5 8.725-4.704C21.575 14.191 22 13.64 22 12s-.425-2.19-1.275-3.296C19.028 6.5 16.182 4 12 4zm0 10a2.5 2.5 0 110-5 2.5 2.5 0 010 5z" />
                                                                        </svg>
                                                                        View Task
                                                                ...
                                                                <li>
                                                                    <a href="javascript:void(0);" @click.stop="$store.financialModal.openModal(<?php echo e($task->id); ?>, '<?php echo e($task->price); ?>', '<?php echo e($task->tax); ?>', '<?php echo e($task->surcharge); ?>', '<?php echo e($isInvoicedAndPaid ? 'true' : 'false'); ?>); open = false;"
                                                                        class="flex items-center px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-800">
                                                                ...
                                                                <?php endif; ?>
                                                                <?php echo $__env->make('tasks.partial.confirm-issue', ['task' => $task], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                            </ul>
                                                        </div>
                                                    </template>
                                                </div>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('destroy', App\Models\Task::class)): ?>
                                                <form action="<?php echo e(route('tasks.destroy', $task->id)); ?>" method="POST" class="ml-1">
                                                    <?php echo csrf_field(); ?>
                                        ...
                                        <td data-column="reference" class="p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            <?php echo e($task->reference); ?>

                                        </td>
                                        <td data-column="bill-to" class="p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300 ">
                                            <?php if($task->client): ?>
                                            <p><?php echo e($task->client->full_name); ?></p>
                                            <p><?php echo e($task->client->phone ?? 'No phone'); ?></p>
                                            <?php else: ?>
                                            <p class="<?php echo e($task->client ?? 'no-client relative'); ?>">
                                                <button
                                                    @click.stop="openManualForm(<?php echo e($task->id); ?>, '<?php echo e($task->client_name ?? ''); ?>', '<?php echo e($task->passenger_name ?? ''); ?>' ,'<?php echo e($task->agent->name ?? 'Not Set'); ?>', '<?php echo e($task->agent->id ?? 'Null'); ?>', '<?php echo e($task->agent->branch->name ?? 'Not Set'); ?>')"
                                                    <?php echo e($task->client !== null ? 'disabled' : ''); ?>>
                                                    <?php echo e($task->client->full_name ?? $task->client_name !== '' ? $task->client_name : 'Not Set'); ?>
                                        ...
                                        <td data-column="passenger-name" class="p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            <div class="relative group max-w-[180px] mx-auto">
                                                <div class="truncate cursor-default">
                                                    <?php echo e($task->passenger_name ?? 'Not Set'); ?>
                                                ...
                                                <div class="absolute z-10 hidden group-hover:block bg-gray-500 text-white text-xs rounded py-1 px-2 left-1/2 -translate-x-1/2 mt-1 shadow-lg">
                                                    <?php echo e($task->passenger_name); ?>
                                        ...
                                        <td data-column="agent-name" class="p-3 text-sm text-center font-semibold text-gray-500">
                                            <?php echo e($task->agent->name ?? 'Not Set'); ?>
                                        ...
                                        <td data-column="status" class="text-center">
                                            <span
                                                ...
                                                <?php if($task->status === 'reissued' && $task->originalTask): ?> data-tooltip-left="Reissued from <?php echo e($task->originalTask->flightDetails->ticket_number); ?>" <?php endif; ?>>
                                                <?php echo e($task->status === null ? 'Not Set' : ucwords($task->status)); ?>

                                            </span>
                                        </td>
                                        <td data-column="supplier" class="p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            <?php echo e($task->supplier->name); ?>

                                        </td>
                                        <td data-column="supplier-pay-date" class="p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            <?php echo e($task->supplier_pay_date ? \Carbon\Carbon::parse($task->supplier_pay_date)->format('d-m-Y') : 'Not Set'); ?>
                                        ...
                                        <td data-column="cancellation-deadline" class="column-hidden p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            <?php echo e($task->cancellation_deadline ?  \Carbon\Carbon::parse($task->cancellation_deadline)->format('d-m-Y') : 'Not Set'); ?>
                                        ...
                                        <td data-column="info" class="p-3 text-sm font-semibold text-gray-900 dark:text-gray-300">
                                            ...
                                            <div class="flex justify-between items-center gap-4 text-center text-sm">
                                                <div class="flex flex-col items-center">
                                                    <span class="font-bold text-base">
                                                        <?php echo e($task->flightDetails ? \Carbon\Carbon::parse($task->flightDetails->departure_time)->format('H:i') : 'N/A'); ?>

                                                    </span>
                                                    <span class="text-gray-600 text-sm">
                                                        <?php echo e($task->flightDetails->airport_from ?? 'N/A'); ?>
                                                ...
                                                <div class="flex flex-col items-center">
                                                    <span class="font-bold text-base">
                                                        <?php echo e($task->flightDetails ? \Carbon\Carbon::parse($task->flightDetails->arrival_time)->format('H:i') : 'N/A'); ?>

                                                    </span>
                                                    <span class="text-gray-600 text-sm">
                                                        <?php echo e($task->flightDetails->airport_to ?? 'N/A'); ?>
                                            ...
                                            <div class="flex items-start gap-2 text-sm text-left">
                                                ...
                                                <div class="flex flex-col">
                                                    <div class="relative max-w-[180px]" data-tooltip-left="<?php echo e($task->hotelDetails->hotel->name ?? '-'); ?>">
                                                        <div class="truncate"><?php echo e($task->hotelDetails->hotel->name ?? 'N/A'); ?></div>
                                                    </div>
                                                    <div class="text-sm text-gray-500 whitespace-nowrap">
                                                        <?php echo e($task->hotelDetails->check_in ?? 'N/A'); ?> - <?php echo e($task->hotelDetails->check_out ?? 'N/A'); ?>
                                            ...
                                            <div class="text-sm text-gray-700 whitespace-pre-line break-words leading-tight">
                                                <?php echo e($task->additional_info ?? '-'); ?>
                                        ...
                                        <td data-column="gds-reference" class="column-hidden p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            <?php echo e($task->gds_reference ?? 'Not Available'); ?>
                                        ...
                                        <td data-column="invoice" class="column-hidden p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            ...
                                            <a target="_blank"
                                                href="<?php echo e(route('invoice.show', ['companyId' => $task->company_id, 'invoiceNumber' => $task->invoiceDetail->invoice_number])); ?>">
                                                <span
                                                    data-invoice-number="<?php echo e($task->invoiceDetail->invoice_number); ?>"
                                                    class="badge whitespace-nowrap px-2 py-1 rounded text-sm font-medium badge-outline-success">
                                                    <?php echo e($task->invoiceDetail->invoice_number); ?>
                                        ...
                                        <td data-column="file-name" class="column-hidden flex p-3 text-sm text-center font-semibold text-gray-900 dark:text-gray-300">
                                            ...
                                            <p> <?php echo e(basename($task->file_name) ?? 'No Files'); ?> </p>
                                            <div @click.stop="navigator.clipboard.writeText('<?php echo e(basename($task->file_name)); ?>')" class="ml-2 text-black hover:text-blue-500 transition-colors flex items-center gap-1"
...
<?php endif; ?>
                            ...
                            <div id="floatingActions"
                                ...
                                <div class="flex items-center gap-5 h-full">
                                    <button id="createInvoiceBtn" data-route="<?php echo e(route('invoices.create')); ?>" type="button"
                                    ...
                                    <button id="proceedRefundBtn" data-route="<?php echo e(route('refunds.create')); ?>" type="button"
                                ...
                                <button type="button"
                                    x-show="canEditTasks"
                                    @click="window.open('<?php echo e(route('tasks.detail')); ?>?tasks=' + selectedTasks.join(','), '_blank')"
                    ...
                    <!-- <div id="loadMoreWrapper" class="text-center my-4"
                        x-show="shown < <?php echo e(count($tasks)); ?>" x-cloak>
                ...
                <div id="taskInvoicePlaceholder"
                    ...
                    <div id="invoiceModalContent">
                        ...
                        <div id="invoiceFooter"
                            ...
                            <?php if (isset($component)) { $__componentOriginald411d1792bd6cc877d687758b753742c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald411d1792bd6cc877d687758b753742c = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'font-bold text-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('primary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'font-bold text-lg']); ?>Edit <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginald411d1792bd6cc877d687758b753742c)): ?>
<?php $attributes = $__attributesOriginald411d1792bd6cc877d687758b753742c; ?>
<?php unset($__attributesOriginald411d1792bd6cc877d687758b753742c); ?>
...
<?php endif; ?>
    ...
    <?php echo $__env->make('tasks.partial.view-task-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<script>
    window.allTaskTypes = <?php echo json_encode($allTypes ?? [], 15, 512) ?>;

    window.companySuppliers = <?php echo json_encode($suppliers->pluck('name')->all(), 15, 512) ?>;
    window.SUPPLIERS = <?php echo json_encode($suppliers->map(fn($s) => ['id' => $s->id, 'name' => $s->name, 'has_hotel' => $s->has_hotel])) ?>;
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const defaultColumns = <?php echo json_encode($defaultColumns ?? [], 15, 512) ?>;
        const backendVisible = <?php echo json_encode($visibleColumns ?? [], 15, 512) ?>;
        ...
        function saveColumnPreferences() {
            ...
            fetch("<?php echo e(route('tasks.columns.save')); ?>", {
                    method: 'POST',
        ...
        document.getElementById('select-supplier-task')?.addEventListener('change', function() {
            ...
            if ((supplier?.is_manual == 1 || supplier?.is_manual == '1') && isHotel) {
                ...
                async function convertCurrency(amount, from, to = 'KWD') {
                    ...
                    try {
                        const res = await fetch(`<?php echo e(route('exchange.convert')); ?>`, {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute("content")
        ...
        document.querySelectorAll('.toggle-task-status').forEach(function(checkbox) {
            checkbox.addEventListener('change', function() {
                ...
                const url = "<?php echo e(route('tasks.toggleStatus', ':taskId')); ?>".replace(':taskId',
                    taskId);
        ...
        document.querySelectorAll('.client-select').forEach(select => {
            select.addEventListener('change', function() {
                ...
                const getAgentUrl = "<?php echo e(route('clients.get-agent', ':clientId')); ?>".replace(':clientId',
                    clientId);
    ...
    document.getElementById('filterContainer').addEventListener('click', function(e) {
        if (e.target.classList.contains('remove-filter-btn')) {
            ...
            window.location = `<?php echo e(route('tasks.index')); ?>?${params.toString()}`;
        }
    });
    // Apply filters
    ...
    document.getElementById('clearAllActiveFilters').addEventListener('click', function() {
        ...
        params.delete('status[]');
        window.location = `<?php echo e(route('tasks.index')); ?>`;
    });
    ...
    // Render on page load
    renderActiveFilters();
</script><?php /**PATH /home/soudshoja/soud-laravel/resources/views/tasks/index.blade.php ENDPATH**/ ?>