...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" id="phone" value="<?php echo e(old('phone', $branch->phone)); ?>"
                                class="w-full px-3 py-2.5 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors"
...
<?php $component = App\View\Components\SearchableDropdown::resolve(['name' => 'company_id','items' => $companies->map(fn($c) => ['id' => $c->id, 'name' => $c->name])->values(),'placeholder' => 'Select Company'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['selectedId' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('company_id', $branch->company_id)),'selectedName' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($branch->company->name ?? null)]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" name="gds_office_id" id="gds_office_id" value="<?php echo e(old('gds_office_id', $branch->gds_office_id)); ?>"
                            class="w-full px-3 py-2.5 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors"
                            placeholder="Enter GDS Office ID">
                        <?php $__errorArgs = ['gds_office_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3"
                            ...
                            placeholder="Enter branch address"><?php echo e(old('address', $branch->address)); ?></textarea>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/branches/edit.blade.php ENDPATH**/ ?>