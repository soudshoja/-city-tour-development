...
<?php $component->withAttributes([]); ?>
    <div class="flex justify-between items-center gap-5 my-3 ">
        ...
        <div class="flex items-center gap-5">
            ...
            <a href="<?php echo e(route('bank-payments.create')); ?>">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['action' => route('bank-payments.index'),'searchParam' => 'q','placeholder' => 'Quick search for payment voucher']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('bank-payments.index')),'searchParam' => 'q','placeholder' => 'Quick search for payment voucher']); ?>
                            ...
                            <?php $__currentLoopData = $bankPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankpayment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        <?php echo e($bankpayment->reference_number); ?>

                                    </td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        <?php echo e($bankpayment->reference_type); ?>

                                    </td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        <?php echo e($bankpayment->journalEntries->first()?->name ?? $bankpayment->name); ?>

                                    </td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        <?php echo e(\Carbon\Carbon::parse($bankpayment->transaction_date)->format('Y-m-d')); ?>

                                    </td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        <?php echo e($bankpayment->description); ?>

                                    </td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        <?php echo e($bankpayment->created_at); ?>

                                    </td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        KWD <?php echo e(number_format($bankpayment->amount, 3)); ?>

                                    </td>
                                    <td class="p-3 text-sm font-semibold text-gray-500">
                                        <a data-tooltip-left="View payment voucher" href="<?php echo e(route('bank-payments.edit', $bankpayment->id)); ?>" class="text-blue-500 hover:underline">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pagination','data' => ['data' => $bankPayments]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($bankPayments)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/bank-payments/index.blade.php ENDPATH**/ ?>