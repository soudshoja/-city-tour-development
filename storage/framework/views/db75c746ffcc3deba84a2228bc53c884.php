...
<?php $component->withAttributes([]); ?>
    <div class="flex justify-between items-center gap-5 my-3">
        <div class="flex items-center gap-5">
            <h2 class="text-3xl font-bold">Branches</h2>
            <div data-tooltip="Number of branches"
                class="relative w-12 h-12 flex items-center justify-center DarkBGcolor rounded-full shadow-sm">
                <span class="text-xl font-bold text-white"><?php echo e($branches->total()); ?></span>
            </div>
        </div>
        <div class="flex items-center gap-5">
            ...
            <a href="<?php echo e(route('users.create', ['openForm' => 'branchForm'])); ?>">
                <div data-tooltip-left="Create new branch"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['action' => route('branches.index'),'searchParam' => 'q','placeholder' => 'Quick search for branches']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('branches.index')),'searchParam' => 'q','placeholder' => 'Quick search for branches']); ?>
                        ...
                        <tr class="transition-colors duration-150 p-3 text-sm font-semibold text-gray-600">
                            ...
                            <td class="text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a data-tooltip-left="View branch" href="<?php echo e(route('branches.show', $branch->id)); ?>" class="text-sm font-medium">
                                    ...
                                    <a data-tooltip-left="Edit branch" href="<?php echo e(route('branches.edit', $branch->id)); ?>" class="text-sm font-medium">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.pagination','data' => ['data' => $branches]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($branches)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/branches/list.blade.php ENDPATH**/ ?>