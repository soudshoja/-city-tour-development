 ...
 <body class="overflow-y-auto font-nunito antialiased bg-gray-100">
    ...
    <?php elseif($invoicePartial->status === 'paid'): ?>
        <div
     ...
     <div class="max-w-4xl mx-auto p-8 bg-white shadow-lg rounded-lg">
        ...
        <?php
                 ...
                 <?php $__currentLoopData = $invoiceDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr class="text-sm text-gray-700">
                         <td class="px-4 py-2 border"><?php echo e($detail->task_description ?? 'N/A'); ?>
                             ...
                             <p>
                                 <br>Info: <?php echo e($detail->task->additional_info); ?>

                                 <br>Type: <?php echo e(ucfirst($detail->task->type)); ?>

                                 <br>Venue: <?php echo e($detail->task->venue); ?>

                                 <br>Note: <?php echo e($detail->client_notes ?? 'N/A'); ?>
         ...
         <div class="mb-8 inline-flex gap-2">
             <?php if($invoicePartial->status === 'unpaid' && !in_array($invoice->status, ['paid', 'paid by refund', 'refunded'])): ?>
                 <?php if(auth()->check()): ?>
                 ...
                 <form id="paymentForm"
                    ...
                    <div class="p-2 rounded-lg border border-gray-300 text-gray-700 flex items-center gap-2 text-xs sm:text-sm">
                        This invoice is <?php echo e($invoicePartial->payment_gateway); ?> payment. Please contact your agent for assistance.
                    </div>
                    <?php endif; ?>
         ...
         <div class="flex justify-between items-center">
             ...
             <div class="text-right">
                <div class="flex justify-end mb-4">
                    <button
                        onclick="window.open('<?php echo e(route('invoice.split-arabic', ['invoiceNumber' => $invoicePartial->invoice_number, 'clientId' => $invoicePartial->client_id,'partialId' => $invoicePartial->id])); ?>', '_blank')"
...
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/invoice/split.blade.php ENDPATH**/ ?>