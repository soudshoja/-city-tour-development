<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/system-setting/main.css', 'resources/css/system-setting/hotel.css']); ?>
<?php $__env->stopPush(); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="grid bg-white dark:bg-gray-800 rounded-xl shadow-sm gap-2">
        <div id="system-settings-index" x-data="{ 
            activeTab: '<?php echo e(session('system_settings_active_tab', 'email')); ?>',
            saveTab(tab) {
                this.activeTab = tab;
                fetch('<?php echo e(route('system-settings.save-tab')); ?>', {
                    method: 'POST',
                    headers: {
            ...
            <div class="flex-1 p-6">
                <div x-show="activeTab === 'email'" x-cloak>
                    <?php echo $__env->make('admin.system-settings.partials.email', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div x-show="activeTab === 'whatsapp'" x-cloak>
                    <?php echo $__env->make('admin.system-settings.partials.whatsapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>

                <div x-show="activeTab === 'hotel'">
                    <?php echo $__env->make('admin.system-settings.partials.hotel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/admin/system-settings/index.blade.php ENDPATH**/ ?>