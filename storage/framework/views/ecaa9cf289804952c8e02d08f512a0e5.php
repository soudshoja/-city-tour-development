                    ...
                    <td class="px-4 py-4">
                        <div class="flex items-center justify-end gap-1">
                            ...
                            <form x-show="!template.is_default && template.is_active"
                                :action="'<?php echo e(route('terms.templates.set-default', ['id' => 'TEMPLATE_ID'])); ?>'.replace('TEMPLATE_ID', template.id)"
                            ...
                            <!-- Toggle Active -->
                            <form :action="'<?php echo e(route('terms.templates.toggle-active', ['id' => 'TEMPLATE_ID'])); ?>'.replace('TEMPLATE_ID', template.id)"
                                method="POST" class="inline">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
...
<div x-show="showCreateModal" x-cloak
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col mx-4"
        ...
        <form action="<?php echo e(route('terms.templates.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="col-span-2">
                            ...
                            <input type="text" name="title" required
                                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="language" required
                                class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['language'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <option value="ARB" <?php echo e(old('language') === 'ARB' ? 'selected' : ''); ?>>🇸🇦 Arabic</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="12" required
                            class="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                            placeholder="Enter your terms and conditions here..."><?php echo e(old('content')); ?></textarea>
...
<div x-show="showEditModal" x-cloak
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col mx-4"
        ...
        <form :action="'<?php echo e(route('terms.templates.update', ['id' => 'TEMPLATE_ID'])); ?>'.replace('TEMPLATE_ID', editingTemplate?.id)" method="POST">
            <?php echo csrf_field(); ?>
...
<div x-show="showDeleteModal" x-cloak
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-md mx-4 p-6"
        ...
        <form :action="'<?php echo e(route('terms.templates.destroy', ['id' => 'TEMPLATE_ID'])); ?>'.replace('TEMPLATE_ID', deletingTemplate?.id)" method="POST">
            <?php echo csrf_field(); ?>
...
</div><?php /**PATH /home/soudshoja/soud-laravel/resources/views/settings/partial/terms_condition.blade.php ENDPATH**/ ?>