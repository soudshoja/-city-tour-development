    ...
    <div class="flex justify-between items-center gap-5 my-3 ">
        ...
        <div class="flex items-center gap-5 ">
            ...
            <div data-tooltip="number of Charges"
                ...
                <span class="text-xl font-bold text-white"><?php echo e($totalCharges); ?></span>
            </div>
        </div>
        ...
        <div class="flex items-center gap-5">
            ...
            <select
                onchange="window.location='<?php echo e(route('charges.index')); ?>?company_id='+this.value"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.search','data' => ['action' => ''.e(route('charges.index')).'','searchParam' => 'search','placeholder' => 'Quick search for charges']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['action' => ''.e(route('charges.index')).'','searchParam' => 'search','placeholder' => 'Quick search for charges']); ?>
                        ...
                        <div class="dataTable-container h-max overflow-x-auto">
                            <table id="myTable" class="table-hover whitespace-nowrap dataTable-table w-full relative" x-data="{ open: {} }">
                                ...
                                <tbody>
                                    ...
                                    <tr class="cursor-pointer bg-gray-100 hover:bg-gray-200" @click="open[<?php echo e($charge->id); ?>] = !open[<?php echo e($charge->id); ?>]">
                                        <td class="p-3 font-bold text-gray-800 bg-gray-100" colspan="5">
                                            <div class="flex items-center gap-2">
                                                <span><?php echo e($charge->name); ?></span>
                                                <?php if($charge->is_system_default): ?>
                                        ...
                                        <td class="p-3 bg-gray-100 sticky right-0 z-10">
                                            <div class="relative group inline-block">
                                                <button @click.stop="editCredsModal = <?php echo e($charge->id); ?>" class="text-blue-600 hover:text-blue-800">
                                    ...
                                    <?php if($charge->methods->isNotEmpty()): ?>
                                    <?php $__currentLoopData = $charge->methods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr x-cloak x-show="open[<?php echo e($charge->id); ?>]" x-transition>
                                        <td class="p-3 pl-6 text-sm text-gray-600"><?php echo e($method->english_name); ?></td>
                                        <td class="p-3 text-sm text-gray-600"><?php echo e($method->paid_by); ?></td>
                                        <td class="p-3 text-sm text-gray-600"><?php echo e(number_format($method->self_charge ?? 0, 2)); ?></td>
                                        <td class="p-3 text-sm text-gray-600"><?php echo e($method->charge_type); ?></td>
                                        <td class="p-3 text-sm">
                                            <?php if($charge->is_active && $method->is_active): ?>
                                        ...
                                        <td class="p-3 text-sm text-gray-600 sticky right-0 bg-white z-10">
                                            <div class="relative group inline-block">
                                                <button @click.stop="editChildModal = <?php echo e($method->id); ?>" class="text-blue-600 hover:text-blue-800">
                                    ...
                                    <div x-cloak x-show="editChildModal === <?php echo e($method->id); ?>" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-30 backdrop-blur-sm">
                                        <div class="bg-white rounded-xl w-full max-w-lg shadow-xl max-h-[85vh] flex flex-col" @click.away="editChildModal = null">
                                            ...
                                            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                                                <div>
                                                    ...
                                                    <p class="text-sm text-gray-500"><?php echo e($charge->name); ?> - <?php echo e($method->english_name); ?></p>
                                                </div>
                                            ...
                                            <div class="overflow-y-auto flex-1 px-6 py-4">
                                                <form id="editMethodForm_<?php echo e($method->id); ?>" action="<?php echo e(route('payment-method.update', $method->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="space-y-3">
                                                            <div class="grid grid-cols-2 gap-3">
                                                                <div>
                                                                    ...
                                                                    <input type="text" value="<?php echo e($method->arabic_name); ?>" class="w-full border border-gray-200 bg-gray-50 px-3 py-2 rounded-lg text-sm text-gray-600" readonly />
                                                                </div>
                                                                <div>
                                                                    <label class="block text-xs font-medium text-gray-500 mb-1">English Name</label>
                                                                    <input type="text" value="<?php echo e($method->english_name); ?>" class="w-full border border-gray-200 bg-gray-50 px-3 py-2 rounded-lg text-sm text-gray-600" readonly />
                                                                </div>
                                                            </div>
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-500 mb-1">Currency</label>
                                                                <input type="text" value="<?php echo e($method->currency); ?>" class="w-full border border-gray-200 bg-gray-50 px-3 py-2 rounded-lg text-sm text-gray-600" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <div class="grid grid-cols-2 gap-3">
                                                            <div>
                                                                ...
                                                                <input type="text" name="self_charge" value="<?php echo e($method->self_charge); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                            </div>
                                                            <div>
                                                                <label class="block text-xs font-medium text-gray-500 mb-1">API Service Charge</label>
                                                                <input type="text" name="service_charge" value="<?php echo e($method->service_charge); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                            </div>
                                                        </div>
                                                        <div class="grid grid-cols-2 gap-3 mt-3">
                                                            <div>
                                                                ...
                                                                <select name="paid_by" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                                    <option value="Company" <?php if(old('paid_by', $method->paid_by) === 'Company'): echo 'selected'; endif; ?>>Company</option>
                                                                    <option value="Client" <?php if(old('paid_by', $method->paid_by) === 'Client'): echo 'selected'; endif; ?>>Client</option>
                                                                </select>
                                                            </div>
                                                            <div>
                                                                ...
                                                                <select name="charge_type" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                                    <option value="Flat Rate" <?php if(old('charge_type', $method->charge_type) === 'Flat Rate'): echo 'selected'; endif; ?>>Flat Rate</option>
                                                                    <option value="Percent" <?php if(old('charge_type', $method->charge_type) === 'Percent'): echo 'selected'; endif; ?>>Percent</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-6">
                                                        ...
                                                        <input type="text" name="description" value="<?php echo e($method->description); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter description" />
                                                    </div>
                                                        ...
                                                        <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                                            ...
                                                            <div class="flex items-center justify-between py-2">
                                                                ...
                                                                <label class="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo e($method->is_active ? 'checked' : ''); ?>>
                                                            ...
                                                            <div class="flex items-center justify-between py-2 border-t border-gray-200">
                                                                ...
                                                                <label class="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" name="can_charge_invoice" value="1" class="sr-only peer" <?php echo e($charge->can_charge_invoice ? 'checked' : ''); ?>>
                                                                    <div class="w-10 h-5 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="flex items-center justify-between py-2 border-t border-gray-200">
                                                                ...
                                                                <label class="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" name="is_auto_paid" value="1" class="sr-only peer" <?php echo e($charge->is_auto_paid ? 'checked' : ''); ?>>
                                                                    <div class="w-10 h-5 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="flex items-center justify-between py-2 border-t border-gray-200">
                                                                ...
                                                                <label class="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" name="has_url" value="1" class="sr-only peer" <?php echo e($charge->has_url ? 'checked' : ''); ?>>
                                                                    <div class="w-10 h-5 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="flex items-center justify-between py-2 border-t border-gray-200">
                                                                ...
                                                                <label class="relative inline-flex items-center cursor-pointer">
                                                                    <input type="checkbox" name="can_generate_link" value="1" class="sr-only peer" <?php echo e($charge->can_generate_link ? 'checked' : ''); ?>>
                                                                    <div class="w-10 h-5 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
                                                ...
                                                <button type="submit" form="editMethodForm_<?php echo e($method->id); ?>" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
                                                    Save Changes
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <tr x-cloak x-show="open[<?php echo e($charge->id); ?>]" x-transition>
                                        <td class="p-3 pl-6 text-sm text-gray-600"><?php echo e($charge->name); ?></td>
                                        <td class="p-3 text-sm text-gray-600"><?php echo e($charge->paid_by); ?></td>
                                        <td class="p-3 text-sm text-gray-600"><?php echo e(number_format($charge->self_charge ?? 0, 2)); ?></td>
                                        <td class="p-3 text-sm text-gray-600"><?php echo e($charge->charge_type); ?></td>
                                        <td class="p-3 text-sm">
                                            <?php if($charge->is_active): ?>
                                            <span class="inline-flex px-2 py-1 text-xs font-medium bg-green-100 text-green-800 rounded-full">Active</span>
                                            <?php else: ?>
                                        ...
                                        <td class="p-3 text-sm sticky right-0 bg-white z-10">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div class="relative group inline-block">
                                                    <button
                                                        @click.stop="editParentModal = <?php echo e($charge->id); ?>"
                                                ...
                                                <!-- Delete Button -->
                                                <?php if($charge->can_be_deleted): ?>
                                                <div class="relative group inline-block">
                                                    <form method="POST" action="<?php echo e(route('charges.destroy', $charge->id)); ?>" onsubmit="return confirm('Are you sure?')">
                                                        <?php echo csrf_field(); ?>
                                    ...
                                    <div x-cloak x-show="editParentModal === <?php echo e($charge->id); ?>" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-30 backdrop-blur-sm">
                                        <div class="bg-white rounded-lg w-full max-w-lg shadow max-h-[80vh] flex flex-col" @click.away="editParentModal = null">
                                            <div class="flex items-center justify-between px-5 pt-6 pb-4">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <?php if($charge->is_system_default && !auth()->user()->hasRole('admin')): ?>
                                            ...
                                            <div class="overflow-y-auto px-8 pb-8 [scrollbar-gutter:stable]">
                                                <!-- Parent Method Edit Modal -->
                                                <div x-cloak x-show="editParentModal === <?php echo e($charge->id); ?>" x-transition class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-30 backdrop-blur-sm">
                                                    <div class="bg-white rounded-xl w-full max-w-lg shadow-xl max-h-[85vh] flex flex-col" @click.away="editParentModal = null">
                                                        ...
                                                        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
                                                            <div>
                                                                ...
                                                                <p class="text-sm text-gray-500"><?php echo e($charge->name); ?></p>
                                                            </div>
                                                        ...
                                                        <!-- Body -->
                                                        <div class="overflow-y-auto flex-1 px-6 py-4">
                                                            <form id="editChargeForm_<?php echo e($charge->id); ?>" action="<?php echo e(route('charges.update', $charge->id)); ?>" method="POST">
                                                                <?php echo method_field('PUT'); ?>
                                                                <?php echo csrf_field(); ?>
                                                                ...
                                                                <div class="mb-6">
                                                                    ...
                                                                    <div class="space-y-3">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <input type="text" name="name" value="<?php echo e($charge->name); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                                                                        </div>
                                                                        <?php else: ?>
                                                                        <div>
                                                                            <label class="block text-xs font-medium text-gray-500 mb-1">Name</label>
                                                                            <input type="text" value="<?php echo e($charge->name); ?>" class="w-full border border-gray-200 bg-gray-50 px-3 py-2 rounded-lg text-sm text-gray-600" readonly />
                                                                        ...
                                                                        <div>
                                                                            <label class="block text-xs font-medium text-gray-500 mb-1">Description</label>
                                                                            <input type="text" name="description" value="<?php echo e($charge->description); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Enter description" />
                                                                        </div>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="mb-6">
                                                                    ...
                                                                    <div class="space-y-3">
                                                                        <div class="grid grid-cols-2 gap-3">
                                                                            <div>
                                                                                <label class="block text-xs font-medium text-gray-500 mb-1">Self Charge</label>
                                                                                <input type="number" name="self_charge" value="<?php echo e($charge->self_charge); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Optional">
                                                                            </div>
                                                                            <div>
                                                                                <label class="block text-xs font-medium text-gray-500 mb-1">API Service Charge</label>
                                                                                <input type="text" name="amount" value="<?php echo e($charge->amount); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                                            </div>
                                                                        </div>
                                                                        <div>
                                                                            <label class="block text-xs font-medium text-gray-500 mb-1">Extra Charge (KWD)</label>
                                                                            <input type="number" name="extra_charge" value="<?php echo e($charge->extra_charge); ?>" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500" />
                                                                        </div>
                                                                        <div class="grid grid-cols-2 gap-3">
                                                                            <div>
                                                                                <label class="block text-xs font-medium text-gray-500 mb-1">Paid By</label>
                                                                                <select name="paid_by" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                                                    <option value="Company" <?php echo e($charge->paid_by === 'Company' ? 'selected' : ''); ?>>Company</option>
                                                                                    <option value="Client" <?php echo e($charge->paid_by === 'Client' ? 'selected' : ''); ?>>Client</option>
                                                                                </select>
                                                                            </div>
                                                                            <div>
                                                                                <label class="block text-xs font-medium text-gray-500 mb-1">Charge Type</label>
                                                                                <select name="charge_type" class="w-full border border-gray-300 px-3 py-2 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                                                                    <option value="Flat Rate" <?php echo e($charge->charge_type === 'Flat Rate' ? 'selected' : ''); ?>>Flat Rate</option>
                                                                                    <option value="Percent" <?php echo e($charge->charge_type === 'Percent' ? 'selected' : ''); ?>>Percent</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="mb-2">
                                                                    ...
                                                                    <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                                                                        ...
                                                                        <div class="flex items-center justify-between py-2">
                                                                            ...
                                                                            <label class="relative inline-flex items-center cursor-pointer">
                                                                                <input type="checkbox" name="is_active" value="1" class="sr-only peer" <?php echo e($charge->is_active ? 'checked' : ''); ?>>
                                                                                <div class="w-10 h-5 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
                                                                            </label>
                                                                        </div>
                                                        ...
                                                        <div class="flex items-center justify-end gap-3 px-6 py-4 border-t border-gray-200 bg-gray-50 rounded-b-xl">
                                                            ...
                                                            <button type="submit" form="editChargeForm_<?php echo e($charge->id); ?>" class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-colors">
                                                                Save Changes
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div x-cloak x-show="editCredsModal === <?php echo e($charge->id); ?>" class="fixed inset-0 z-50 flex items-center justify-center bg-gray-800 bg-opacity-30 backdrop-blur-sm">
                                        <div class="bg-white rounded-lg w-full max-w-lg shadow max-h-[80vh] flex flex-col" @click.away="editCredsModal = null">
                                            ...
                                            <div class="overflow-y-auto px-8 pb-8 [scrollbar-gutter:stable]">
                                                <form action="<?php echo e(route('charges.credentials.update', $charge->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('PUT'); ?>

                                                    <div class="mb-4">
                                                        <label class="block text-sm font-medium">Gateway</label>
                                                        <input type="text" class="w-full border px-3 py-2 rounded-full bg-gray-200" value="<?php echo e($charge->name); ?>" readonly>
                                                    </div>

                                                    <?php if($charge->is_system_default): ?>
                                                    <div class="mb-4">
                                                        <label class="block text-sm font-medium">API Key</label>
                                                        <textarea name="api_key" id="api_key_<?php echo e($charge->id); ?>" class="w-full border px-3 py-2 rounded-md resize-y min-h-[6rem]"
                                                            placeholder="Provide new key to replace existing"><?php echo e(old('api_key', $charge->api_key)); ?></textarea>
                                                    </div>
                                                    <?php endif; ?>

                                                    <div class="mb-6">
                                                        <div class="flex items-center">
                                                            <input type="checkbox" name="is_active" value="1" id="is_active_<?php echo e($charge->id); ?>"
                                                                <?php if(old('is_active', (bool)$charge->is_active)): echo 'checked'; endif; ?>
                                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                    ...
                                                    <?php if(auth()->user()->hasRole('admin') || !$charge->is_system_default): ?>

                                                    <div class="mb-6 flex gap-4">

                                                        <div class="w-1/2">
                                                            <div class="flex items-center">
                                                                <input type="checkbox" name="can_generate_link" value="1" id="can_generate_link_<?php echo e($charge->id); ?>"
                                                                    <?php if(old('can_generate_link', (bool)$charge->can_generate_link)): echo 'checked'; endif; ?>
                                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                    ...
                                                    <div class="mb-4 flex gap-4">
                                                        <div class="w-1/3">
                                                            <div class="flex items-center">
                                                                <input type="checkbox" name="is_auto_paid" value="1" id="is_auto_paid_<?php echo e($charge->id); ?>"
                                                                    <?php if(old('is_auto_paid', (bool)$charge->is_auto_paid)): echo 'checked'; endif; ?>
                                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                        ...
                                                        <div class="w-1/3">
                                                            <div class="flex items-center">
                                                                <input type="checkbox" name="has_url" value="1" id="has_url_<?php echo e($charge->id); ?>"
                                                                    <?php if(old('has_url', (bool)$charge->has_url)): echo 'checked'; endif; ?>
                                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                        ...
                                                        <div class="w-1/3">
                                                            <div class="flex items-center">
                                                                <input type="checkbox" name="can_charge_invoice" value="1" id="can_charge_invoice_<?php echo e($charge->id); ?>"
                                                                    <?php if(old('can_charge_invoice', (bool)$charge->can_charge_invoice)): echo 'checked'; endif; ?>
                                                                class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/charges/index.blade.php ENDPATH**/ ?>