...
<?php endif; ?>
                            ...
                            <div>
                                <h3 class="font-semibold text-lg"><?php echo e($selectedCompany->name); ?></h3>
                                <p><?php echo nl2br(e($selectedCompany->address)); ?></p>
                                <p><?php echo e($selectedCompany->email); ?></p>
                                <p><?php echo e($selectedCompany->phone); ?></p>
                            </div>
                        </div>
                         <?php else: ?>
                        <div class="custom-select w-full border rounded-lg mt-4">
                            ...
                            <div
                                class="select-options hidden absolute left-0 top-full w-full rounded-md shadow-lg grid <?php echo e(count($branches) === 1 ? 'grid-cols-1' : 'grid-cols-2'); ?> gap-2 py-3">
                                ...
                                <div class="select-option px-4 py-3 text-center bg-white dark:bg-gray-700 BoxShadow rounded-lg dark:hover:bg-gray-800 border border-gray-300 cursor-pointer"
                                    data-value="<?php echo e($company->id); ?>">
                    ...
                    <div class="space-y-1 text-gray-900 dark:text-gray-400 mt-2">
                        <div class="flex items-center w-full">
                            ...
                            <input id="invoiceNumber" type="text" name="invoiceNumber" value="<?php echo e($invoiceNumber); ?>"
                        ...
                        <div class="mt-4 flex items-center">
                            ...
                            <input id="invoiceDate" type="date" name="invoiceDate" class="w-full form-input" value="<?php echo e($todayDate); ?>" />
                        </div>
                        <div class="mt-4 flex items-center">
                            <label for="dueDate" class="w-full text-sm font-semibold">Due Date</label>
                            <input id="dueDate" type="date" name="dueDate" class="w-full form-input" value="<?php echo e($invoiceExpireDefault); ?>" />
                        </div>
                    ...
                    <div class="w-full">
                        ...
                        <div class="mt-4 flex items-center">
                            <input id="agentPhone" type="text" name="agentPhone" class="form-input flex-1"
                                ...
                                value="<?php echo e(auth()->user()->role_id == \App\Models\Role::AGENT ? auth()->user()->agent->phone : ''); ?>"
                                disabled />
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="mb-4 flex gap-4">
                                            <div class="w-1/2">
                                                ...
                                                <select name="dial_code" id="dial_code"
                                                    ...
                                                    <option value="<?php echo e($country->dialing_code); ?>" <?php echo e($country->dialing_code == '+965' ? 'selected' : ''); ?>>
    ...
    <script>
        let selectedInvoiceTasks = <?php echo json_encode($selectedTasks, 15, 512) ?>;
        let branches = <?php echo json_encode($branches, 15, 512) ?>;
        let clients = <?php echo json_encode($clients, 15, 512) ?>;
        let agents = <?php echo json_encode($agents, 15, 512) ?>;
        let items = [];
        let tasks = [];
        let allTasks = [];
        let filteredTasks = [];
        ...
        async function generateInvoice() {
            ...
            try {
                ...
                location.href = "<?php echo e(route('invoice.edit', ['companyId' => ':companyId', 'invoiceNumber' => ':invoiceNumber'])); ?>".replace(':companyId', companyId).replace(
        ...
        document.addEventListener("DOMContentLoaded", function() {
            const _tasks = <?php echo json_encode($tasks, 15, 512) ?>;
    ...
    <script>
        document.getElementById('select-supplier-task')?.addEventListener('change', function() {
            ...
            let tboTaskUrl = "<?php echo route('tasks.get-tbo', ['companyId' => '__companyId__']); ?>".replace('__companyId__', companyIdData);
...
<?php endif; ?><?php /**PATH /home/soudshoja/soud-laravel/resources/views/invoice/create.blade.php ENDPATH**/ ?>