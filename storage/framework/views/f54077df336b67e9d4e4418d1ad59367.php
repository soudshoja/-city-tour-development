...
<?php endif; ?>
        ...
        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md overflow-hidden sm:rounded-lg">
            ...
            <p class="mb-4 text-sm text-gray-600 dark:text-gray-400 text-center">
                <?php echo e(__('No problem. Just let us know your email address and we will email you a password reset link.')); ?>
...
<?php endif; ?>
<?php /**PATH /home/soudshoja/soud-laravel/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>