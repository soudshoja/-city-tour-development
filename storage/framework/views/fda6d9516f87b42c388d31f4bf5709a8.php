                        ...
                        <div class="mb-6">
                            <select id="country-select" name="country_id"
                                ...
                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $country): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($country->id); ?>" data-dial-code="<?php echo e($country->dialing_code); ?>">
                ...
                <div class="grid grid-cols-2 gap-5 col-span-1">
                    ...
                    <div class="w-full space-y-4">
                        ...
                        <div data-form="companyForm"
                            ...
                            <img src="<?php echo e(asset('images/registeruser.jpg')); ?>" alt="Company" class="w-10 h-10">
                        </div>
                        <?php endif; ?>
                        ...
                        <div data-form="branchForm"
                            ...
                            <img src="<?php echo e(asset('images/BranchPic.png')); ?>" alt="Branch" class="w-10 h-10">
                        </div>
                        <?php endif; ?>
                        ...
                        <div data-form="agentForm"
                            ...
                            <img src="<?php echo e(asset('images/AgentPic.png')); ?>" alt="Agent" class="w-10 h-10">
                        </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="w-full space-y-4">
                        ...
                        <div data-form="accountantForm"
                            ...
                            <img src="<?php echo e(asset('images/AccountantPic.png')); ?>" alt="Accountant" class="w-10 h-10">
                        </div>
                        <?php endif; ?>
                        ...
                        <div data-form="clientForm"
                            ...
                            <img src="<?php echo e(asset('images/ClientPic.png')); ?>" alt="Client" class="w-10 h-10">
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="col-span-1 md:col-span-2">
                    ...
                    <div id="initialDiv" class="panel BoxShadow h-full p-5 shadow bg-white dark:bg-gray-700">
                        <div class="justify-between items-center flex flex-col md:flex-row">
                            ...
                            <img src="<?php echo e(asset('images/AddnewPic.png')); ?>" alt="Add New" class="mt-4 md:mt-0">
                        </div>
                    </div>
                    <!-- ./div to show the forms -->
                    <div id="formDiv"
                        ...
                        <div class="my-5">
                            ...
                            <div id="companyForm" class="form hidden flex w-full h-auto">
                                <div class="w-full h-auto">
                                    ...
                                    <form method="POST" action="<?php echo e(route('companies.store')); ?>" class="w-full">
                                        <?php echo csrf_field(); ?>
                            ...
                            <div id="branchForm" class="form hidden flex w-full h-auto">
                                <div class="w-full h-auto">
                                    <div class="flex items-center mb-5">
                                        <div class="rounded-full p-2 border-2 border-gray-300 dark:border-gray-600">
                                            <img src="<?php echo e(asset('images/BranchPic.png')); ?>" alt="Branch"
                                                class="w-10 h-10">
                                        </div>
                                        <h2 class="font-bold text-xl pl-4 text-gray-800 dark:text-white">Adding New Branch</h2>
                                    </div>

                                    <form action="<?php echo e(route('companies.createBranch')); ?>" method="POST"
                                        class="w-full">
                                        <?php echo csrf_field(); ?>
                                                ...
                                                <div class="relative">
                                                    <select name="dial_code" id="dial_code"
                                                        ...
                                                        <option value="<?php echo e($country->dialing_code); ?>">
                                                            <?php echo e($country->dialing_code); ?> (<?php echo e($country->name); ?>)
                                                        </option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div id="agentForm" class="form hidden flex w-full h-auto">
                                <div class="w-full h-auto">
                                    <div class="flex items-center mb-5">
                                        <div class="rounded-full p-2 border-2 border-gray-300 dark:border-gray-600">
                                            <img src="<?php echo e(asset('images/AgentPic.png')); ?>" alt="Agent"
                                                class="w-10 h-10">
                                        </div>
                            ...
                            <div id="accountantForm" class="form hidden flex w-full h-auto">
                                <div class="w-full h-auto">
                                    <div class="flex items-center mb-5">
                                        <div class="rounded-full p-2 border-2 border-gray-300 dark:border-gray-600">
                                            <img src="<?php echo e(asset('images/AccountantPic.png')); ?>" alt="Accountant"
                                                class="w-10 h-10">
                                        </div>
                                        <h2 class="font-bold text-xl pl-4 text-gray-800 dark:text-white">Adding New Accountant</h2>
                                    </div>
                                    <form action="<?php echo e(route('companies.createAccountant')); ?>" method="POST"
                            ...
                            <div id="clientForm" class="form hidden flex w-full h-auto">
                                <div class="w-full h-auto">
                                    <div class="flex items-center mb-5">
                                        <div class="rounded-full p-2 border-2 border-gray-300 dark:border-gray-600">
                                            <img src="<?php echo e(asset('images/ClientPic.png')); ?>" alt="Client"
                                                class="w-10 h-10">
                                        </div>
                                    ...
                                    <form action="<?php echo e(route('clients.store')); ?>" method="POST"
                                        ...
                                        <div class="mb-4 flex items-center relative">
                                            ...
                                            <select
                                                ...
                                                <option class="" value="<?php echo e($agent->id); ?>">
...
</script><?php /**PATH /home/soudshoja/soud-laravel/resources/views/users/create.blade.php ENDPATH**/ ?>