...
class AdminUsersControllerCoaTransactionTest extends TestCase
{
    ...
    private function makeAdmin(): User
    {
        ...
        // ours' Gate-based guard, AdminUsersController::store()/newCompany() require
        // the 'create company' permission, not just role_id === ADMIN. This test
        // class sets skipPermissionSeeder = true, so the permission rows are
        // created here directly rather than via PermissionSeeder.
